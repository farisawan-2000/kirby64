...
/* 174B84 801D10A4 3C048005 */  lui        $a0, %hi(D_8004A7C4)
/* 174B88 801D10A8 8C84A7C4 */  lw         $a0, %lo(D_8004A7C4)($a0)
/* 174B8C 801D10AC 3C05800E */  lui        $a1, %hi(gEntitiesAngleYArray)
/* 174B90 801D10B0 24A541D0 */  addiu      $a1, $a1, %lo(gEntitiesAngleYArray)
/* 174B94 801D10B4 8C830000 */  lw         $v1, 0x0($a0)
/* 174B98 801D10B8 3C01801E */  lui        $at, %hi(D_801DB068_ovl8)
...
/* 174BA8 801D10C8 C4400000 */  lwc1       $f0, 0x0($v0)
...
.L801D10E8_ovl8:
/* 174BC8 801D10E8 E4440000 */  swc1       $f4, 0x0($v0)
/* 174BCC 801D10EC 8C830000 */  lw         $v1, 0x0($a0)
/* 174BD0 801D10F0 00031880 */  sll        $v1, $v1, 2
/* 174BD4 801D10F4 00A31021 */  addu       $v0, $a1, $v1
/* 174BD8 801D10F8 C4400000 */  lwc1       $f0, 0x0($v0)
...
.L801D1120_ovl8:
/* 174C00 801D1120 E4460000 */  swc1       $f6, 0x0($v0)
/* 174C04 801D1124 8C830000 */  lw         $v1, 0x0($a0)
/* 174C08 801D1128 00031880 */  sll        $v1, $v1, 2
/* 174C0C 801D112C 00A31021 */  addu       $v0, $a1, $v1
/* 174C10 801D1130 C4400000 */  lwc1       $f0, 0x0($v0)
