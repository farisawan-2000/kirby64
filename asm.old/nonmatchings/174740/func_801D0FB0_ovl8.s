...
/* 174AA0 801D0FC0 3C038005 */  lui        $v1, %hi(D_8004A7C4)
/* 174AA4 801D0FC4 8C63A7C4 */  lw         $v1, %lo(D_8004A7C4)($v1)
/* 174AA8 801D0FC8 3C01800E */  lui        $at, %hi(D_800E2090)
/* 174AAC 801D0FCC 3C0E800E */  lui        $t6, %hi(gEntitiesNextPosXArray)
/* 174AB0 801D0FD0 8C620000 */  lw         $v0, 0x0($v1)
/* 174AB4 801D0FD4 25CE25D0 */  addiu      $t6, $t6, %lo(gEntitiesNextPosXArray)
/* 174AB8 801D0FD8 3C0F800E */  lui        $t7, %hi(gEntitiesNextPosYArray)
...
/* 174AD8 801D0FF8 C4AA0000 */  lwc1       $f10, 0x0($a1)
/* 174ADC 801D0FFC 46062200 */  add.s      $f8, $f4, $f6
/* 174AE0 801D1000 3C01800E */  lui        $at, %hi(D_800E2250)
/* 174AE4 801D1004 25EF2790 */  addiu      $t7, $t7, %lo(gEntitiesNextPosYArray)
/* 174AE8 801D1008 3C18800E */  lui        $t8, %hi(gEntitiesNextPosZArray)
/* 174AEC 801D100C 46085400 */  add.s      $f16, $f10, $f8
/* 174AF0 801D1010 27182950 */  addiu      $t8, $t8, %lo(gEntitiesNextPosZArray)
/* 174AF4 801D1014 8FA40018 */  lw         $a0, 0x18($sp)
/* 174AF8 801D1018 E4B00000 */  swc1       $f16, 0x0($a1)
/* 174AFC 801D101C 8C620000 */  lw         $v0, 0x0($v1)
...
/* 174B1C 801D103C C4CA0000 */  lwc1       $f10, 0x0($a2)
...
/* 174B2C 801D104C E4C80000 */  swc1       $f8, 0x0($a2)
/* 174B30 801D1050 8C620000 */  lw         $v0, 0x0($v1)
...
/* 174B50 801D1070 C4EA0000 */  lwc1       $f10, 0x0($a3)
...
/* 174B60 801D1080 E4E60000 */   swc1      $f6, 0x0($a3)
