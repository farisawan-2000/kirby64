...
/* 1756A0 801D1BC0 3C038005 */  lui        $v1, %hi(D_8004A7C4)
/* 1756A4 801D1BC4 8C63A7C4 */  lw         $v1, %lo(D_8004A7C4)($v1)
/* 1756A8 801D1BC8 3C01801E */  lui        $at, %hi(D_801DB078_ovl8)
glabel func_801D1BCC_ovl9
/* 1756AC 801D1BCC C422B078 */  lwc1       $f2, %lo(D_801DB078_ovl8)($at)
/* 1756B0 801D1BD0 8C650000 */  lw         $a1, 0x0($v1)
/* 1756B4 801D1BD4 3C01800E */  lui        $at, %hi(D_800E6A10)
/* 1756B8 801D1BD8 3C04800E */  lui        $a0, %hi(gEntitiesAngleYArray)
...
/* 1756C8 801D1BE8 3C01801E */  lui        $at, %hi(D_801DB07C_ovl8)
...
.L801D1C38_ovl8:
/* 175718 801D1C38 E4520000 */  swc1       $f18, 0x0($v0)
/* 17571C 801D1C3C 8C790000 */  lw         $t9, 0x0($v1)
/* 175720 801D1C40 00194080 */  sll        $t0, $t9, 2
/* 175724 801D1C44 00881021 */  addu       $v0, $a0, $t0
/* 175728 801D1C48 C4400000 */  lwc1       $f0, 0x0($v0)
...
.L801D1C70_ovl8:
/* 175750 801D1C70 E4440000 */  swc1       $f4, 0x0($v0)
/* 175754 801D1C74 8C690000 */  lw         $t1, 0x0($v1)
/* 175758 801D1C78 00095080 */  sll        $t2, $t1, 2
/* 17575C 801D1C7C 008A1021 */  addu       $v0, $a0, $t2
/* 175760 801D1C80 C4400000 */  lwc1       $f0, 0x0($v0)
