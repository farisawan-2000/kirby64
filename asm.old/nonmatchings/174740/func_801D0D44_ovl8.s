...
/* 17482C 801D0D4C 0C074318 */  jal        func_801D0C60_ovl9
/* 174830 801D0D50 00000000 */   nop
/* 174834 801D0D54 3C048005 */  lui        $a0, %hi(D_8004A7C4)
/* 174838 801D0D58 8C84A7C4 */  lw         $a0, %lo(D_8004A7C4)($a0)
/* 17483C 801D0D5C 3C05800E */  lui        $a1, %hi(gEntitiesAngleYArray)
/* 174840 801D0D60 24A541D0 */  addiu      $a1, $a1, %lo(gEntitiesAngleYArray)
/* 174844 801D0D64 8C830000 */  lw         $v1, 0x0($a0)
/* 174848 801D0D68 3C01801E */  lui        $at, %hi(D_801DB060_ovl8)
...
/* 174858 801D0D78 C4400000 */  lwc1       $f0, 0x0($v0)
...
.L801D0D98_ovl8:
/* 174878 801D0D98 E4440000 */  swc1       $f4, 0x0($v0)
/* 17487C 801D0D9C 8C830000 */  lw         $v1, 0x0($a0)
/* 174880 801D0DA0 00031880 */  sll        $v1, $v1, 2
/* 174884 801D0DA4 00A31021 */  addu       $v0, $a1, $v1
/* 174888 801D0DA8 C4400000 */  lwc1       $f0, 0x0($v0)
.L801D0DAC_ovl9:
...
/* 1748A4 801D0DC4 4502000C */  bc1fl      func_801D0DF8_ovl9
/* 1748A8 801D0DC8 00230821 */   addu      $at, $at, $v1
/* 1748AC 801D0DCC 46020180 */  add.s      $f6, $f0, $f2
.L801D0DD0_ovl8:
/* 1748B0 801D0DD0 E4460000 */  swc1       $f6, 0x0($v0)
/* 1748B4 801D0DD4 8C830000 */  lw         $v1, 0x0($a0)
/* 1748B8 801D0DD8 00031880 */  sll        $v1, $v1, 2
/* 1748BC 801D0DDC 00A31021 */  addu       $v0, $a1, $v1
/* 1748C0 801D0DE0 C4400000 */  lwc1       $f0, 0x0($v0)
...
/* 1748DC 801D0DFC 8C830000 */  lw         $v1, 0x0($a0)
