...
/* 174C40 801D1160 3C058005 */  lui        $a1, %hi(D_8004A7C4)
...
.L801D11BC_ovl9:
/* 174C9C 801D11BC 8CAA0000 */  lw         $t2, 0x0($a1)
.L801D11C0_ovl9:
...
/* 174CB4 801D11D4 3C058005 */  lui        $a1, %hi(D_8004A7C4)
/* 174CB8 801D11D8 8CA5A7C4 */  lw         $a1, %lo(D_8004A7C4)($a1)
/* 174CBC 801D11DC 3C04800E */  lui        $a0, %hi(gEntitiesAngleYArray)
/* 174CC0 801D11E0 248441D0 */  addiu      $a0, $a0, %lo(gEntitiesAngleYArray)
/* 174CC4 801D11E4 8CA30000 */  lw         $v1, 0x0($a1)
/* 174CC8 801D11E8 3C01801E */  lui        $at, %hi(D_801DB06C_ovl8)
...
/* 174CD8 801D11F8 C4400000 */  lwc1       $f0, 0x0($v0)
...
.L801D1218_ovl8:
/* 174CF8 801D1218 E4440000 */  swc1       $f4, 0x0($v0)
/* 174CFC 801D121C 8CA30000 */  lw         $v1, 0x0($a1)
/* 174D00 801D1220 00031880 */  sll        $v1, $v1, 2
/* 174D04 801D1224 00831021 */  addu       $v0, $a0, $v1
/* 174D08 801D1228 C4400000 */  lwc1       $f0, 0x0($v0)
...
.L801D1250_ovl8:
/* 174D30 801D1250 E4460000 */  swc1       $f6, 0x0($v0)
/* 174D34 801D1254 8CA30000 */  lw         $v1, 0x0($a1)
/* 174D38 801D1258 00031880 */  sll        $v1, $v1, 2
/* 174D3C 801D125C 00831021 */  addu       $v0, $a0, $v1
/* 174D40 801D1260 C4400000 */  lwc1       $f0, 0x0($v0)
