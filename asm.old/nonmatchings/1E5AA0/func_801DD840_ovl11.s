...
/* 1E810C 801DD84C 14A00028 */  bnez       $a1, func_801DD8F0_ovl17
/* 1E8110 801DD850 AFA40028 */   sw        $a0, 0x28($sp)
/* 1E8114 801DD854 4600610D */  trunc.w.s  $f4, $f12
/* 1E8118 801DD858 24010001 */  addiu      $at, $zero, 0x1
.L801DD85C_ovl13:
/* 1E811C 801DD85C 27A4001C */  addiu      $a0, $sp, 0x1C
.L801DD860_ovl12:
/* 1E8120 801DD860 3C188005 */  lui        $t8, %hi(D_8004A7C4)
/* 1E8124 801DD864 440F2000 */  mfc1       $t7, $f4
/* 1E8128 801DD868 00000000 */  nop
/* 1E812C 801DD86C 15E10020 */  bne        $t7, $at, func_801DD8F0_ovl17
/* 1E8130 801DD870 3C014270 */   lui       $at, (0x42700000 >> 16)
.L801DD874_ovl17:
...
/* 1E814C 801DD88C 8F190000 */  lw         $t9, 0x0($t8)
/* 1E8150 801DD890 3C06800E */  lui        $a2, %hi(gEntitiesAngleYArray)
/* 1E8154 801DD894 24050002 */  addiu      $a1, $zero, 0x2
...
/* 1E8168 801DD8A8 2404001F */  addiu      $a0, $zero, 0x1F
/* 1E816C 801DD8AC 00002825 */  or         $a1, $zero, $zero
/* 1E8170 801DD8B0 0C06B364 */  jal        func_801ACD90_ovl7
/* 1E8174 801DD8B4 27A6001C */   addiu     $a2, $sp, 0x1C
/* 1E8178 801DD8B8 1040000B */  beqz       $v0, .L801DD8E8_ovl11
glabel func_801DD8BC_ovl9
/* 1E817C 801DD8BC 3C098005 */   lui       $t1, %hi(D_8004A7C4)
.L801DD8C0_ovl15:
/* 1E8180 801DD8C0 8D29A7C4 */  lw         $t1, %lo(D_8004A7C4)($t1)
/* 1E8184 801DD8C4 3C03800E */  lui        $v1, %hi(gEntitiesAngleYArray)
/* 1E8188 801DD8C8 246341D0 */  addiu      $v1, $v1, %lo(gEntitiesAngleYArray)
/* 1E818C 801DD8CC 8D2A0000 */  lw         $t2, 0x0($t1)
.L801DD8D0_ovl14:
...
/* 1E81A0 801DD8E0 C5880000 */  lwc1       $f8, 0x0($t4)
/* 1E81A4 801DD8E4 E5C80000 */  swc1       $f8, 0x0($t6)
.L801DD8E8_ovl11:
/* 1E81A8 801DD8E8 0C029D9E */  jal        play_sound
/* 1E81AC 801DD8EC 24040179 */   addiu     $a0, $zero, 0x179
