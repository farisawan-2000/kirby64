...
/* 1E89B8 801DE0F8 3C028005 */  lui        $v0, %hi(D_8004A7C4)
...
/* 1E89CC 801DE10C 8C4F0000 */  lw         $t7, 0x0($v0)
.L801DE110_ovl10:
/* 1E89D0 801DE110 3C01800F */  lui        $at, %hi(D_800E9C60)
/* 1E89D4 801DE114 240E0001 */  addiu      $t6, $zero, 0x1
...
/* 1E89E4 801DE124 8C590000 */  lw         $t9, 0x0($v0)
/* 1E89E8 801DE128 3C01800F */  lui        $at, %hi(D_800E9E20)
/* 1E89EC 801DE12C 3C05800F */  lui        $a1, %hi(D_800E9560)
.L801DE130_ovl13:
...
/* 1E89FC 801DE13C 8C4A0000 */  lw         $t2, 0x0($v0)
/* 1E8A00 801DE140 24A59560 */  addiu      $a1, $a1, %lo(D_800E9560)
/* 1E8A04 801DE144 2409FFFF */  addiu      $t1, $zero, -0x1
glabel func_801DE148_ovl13
/* 1E8A08 801DE148 000A5880 */  sll        $t3, $t2, 2
.L801DE14C_ovl12:
/* 1E8A0C 801DE14C 00AB6021 */  addu       $t4, $a1, $t3
/* 1E8A10 801DE150 AD890000 */  sw         $t1, 0x0($t4)
/* 1E8A14 801DE154 8C430000 */  lw         $v1, 0x0($v0)
/* 1E8A18 801DE158 3C01800F */  lui        $at, %hi(D_800E93A0)
/* 1E8A1C 801DE15C 240E001E */  addiu      $t6, $zero, 0x1E
.L801DE160_ovl12:
/* 1E8A20 801DE160 00031880 */  sll        $v1, $v1, 2
/* 1E8A24 801DE164 00A36821 */  addu       $t5, $a1, $v1
/* 1E8A28 801DE168 8DAF0000 */  lw         $t7, 0x0($t5)
glabel func_801DE16C_ovl12
/* 1E8A2C 801DE16C 00230821 */  addu       $at, $at, $v1
/* 1E8A30 801DE170 3C040001 */  lui        $a0, (0x1040F >> 16)
/* 1E8A34 801DE174 AC2F93A0 */  sw         $t7, %lo(D_800E93A0)($at)
/* 1E8A38 801DE178 8C580000 */  lw         $t8, 0x0($v0)
/* 1E8A3C 801DE17C 3C01800F */  lui        $at, %hi(D_800E9720)
/* 1E8A40 801DE180 3484040F */  ori        $a0, $a0, (0x1040F & 0xFFFF)
.L801DE184_ovl17:
...
/* 1E8A50 801DE190 8C480000 */  lw         $t0, 0x0($v0)
...
/* 1E8A68 801DE1A8 3C040001 */  lui        $a0, (0x1040E >> 16)
/* 1E8A6C 801DE1AC 3484040E */  ori        $a0, $a0, (0x1040E & 0xFFFF)
/* 1E8A70 801DE1B0 0C02AA19 */  jal        func_800AA864
.L801DE1B4_ovl17:
/* 1E8A74 801DE1B4 24050002 */   addiu     $a1, $zero, 0x2
/* 1E8A78 801DE1B8 3C098005 */  lui        $t1, %hi(D_8004A7C4)
/* 1E8A7C 801DE1BC 8D29A7C4 */  lw         $t1, %lo(D_8004A7C4)($t1)
/* 1E8A80 801DE1C0 3C01800F */  lui        $at, %hi(D_800E9E20)
.L801DE1C4_ovl17:
/* 1E8A84 801DE1C4 240B0001 */  addiu      $t3, $zero, 0x1
/* 1E8A88 801DE1C8 8D2C0000 */  lw         $t4, 0x0($t1)
