...
/* 1E71B8 801DC8F8 3C028005 */  lui        $v0, %hi(D_8004A7C4)
.L801DC8FC_ovl17:
...
.L801DC90C_ovl17:
/* 1E71CC 801DC90C 8C4F0000 */  lw         $t7, 0x0($v0)
/* 1E71D0 801DC910 3C0E801E */  lui        $t6, %hi(func_801DCA48_ovl11)
...
/* 1E71E0 801DC920 25CECA48 */  addiu      $t6, $t6, %lo(func_801DCA48_ovl11)
/* 1E71E4 801DC924 AC2EF150 */  sw         $t6, %lo(D_800DF150)($at)
.L801DC928_ovl12:
/* 1E71E8 801DC928 8C590000 */  lw         $t9, 0x0($v0)
/* 1E71EC 801DC92C 3C01800F */  lui        $at, %hi(D_800E9FE0)
glabel func_801DC930_ovl12
/* 1E71F0 801DC930 24090003 */  addiu      $t1, $zero, 0x3
...
/* 1E7200 801DC940 8C4A0000 */  lw         $t2, 0x0($v0)
.L801DC944_ovl14:
/* 1E7204 801DC944 3C01800F */  lui        $at, %hi(D_800EA360)
/* 1E7208 801DC948 3C05800D */  lui        $a1, %hi(D_800D70D8)
...
/* 1E7218 801DC958 8C4C0000 */  lw         $t4, 0x0($v0)
.L801DC95C_ovl16:
/* 1E721C 801DC95C 3C01800F */  lui        $at, %hi(D_800EA520)
/* 1E7220 801DC960 24A570D8 */  addiu      $a1, $a1, %lo(D_800D70D8)
.L801DC964_ovl16:
...
/* 1E7230 801DC970 8C4F0000 */  lw         $t7, 0x0($v0)
/* 1E7234 801DC974 3C01800F */  lui        $at, %hi(D_800E9720)
.L801DC978_ovl10:
/* 1E7238 801DC978 3C06800F */  lui        $a2, %hi(D_800E9560)
.L801DC97C_ovl10:
...
/* 1E7248 801DC988 3C0140C0 */  lui        $at, (0x40C00000 >> 16)
glabel func_801DC98C_ovl17
/* 1E724C 801DC98C 44812000 */  mtc1       $at, $f4
glabel func_801DC990_ovl16
/* 1E7250 801DC990 3C01801E */  lui        $at, %hi(.L801E0C20_ovl11)
/* 1E7254 801DC994 24C69560 */  addiu      $a2, $a2, %lo(D_800E9560)
/* 1E7258 801DC998 E4A40000 */  swc1       $f4, 0x0($a1)
.L801DC99C_ovl15:
/* 1E725C 801DC99C 8C580000 */  lw         $t8, 0x0($v0)
/* 1E7260 801DC9A0 C4260C20 */  lwc1       $f6, %lo(.L801E0C20_ovl11)($at)
...
.L801DC9B4_ovl10:
/* 1E7274 801DC9B4 8C480000 */  lw         $t0, 0x0($v0)
.L801DC9B8_ovl10:
/* 1E7278 801DC9B8 3C01800E */  lui        $at, %hi(gEntityVtableIndexArray)
/* 1E727C 801DC9BC 2409FFFF */  addiu      $t1, $zero, -0x1
...
/* 1E72CC 801DCA0C 3C198005 */  lui        $t9, %hi(D_8004A7C4)
/* 1E72D0 801DCA10 8F39A7C4 */  lw         $t9, %lo(D_8004A7C4)($t9)
.L801DCA14_ovl17:
/* 1E72D4 801DCA14 3C04800E */  lui        $a0, %hi(gEntityVtableIndexArray)
/* 1E72D8 801DCA18 3C06801E */  lui        $a2, %hi(.L801E0B4C_ovl12)
/* 1E72DC 801DCA1C 8F280000 */  lw         $t0, 0x0($t9)
glabel func_801DCA20_ovl10
/* 1E72E0 801DCA20 24C60B4C */  addiu      $a2, $a2, %lo(.L801E0B4C_ovl12)
.L801DCA24_ovl15:
/* 1E72E4 801DCA24 24050009 */  addiu      $a1, $zero, 0x9
