...
/* 1E7FF0 801DD730 3C028005 */  lui        $v0, %hi(D_8004A7C4)
...
/* 1E8004 801DD744 8C4E0000 */  lw         $t6, 0x0($v0)
.L801DD748_ovl9:
/* 1E8008 801DD748 3C01800F */  lui        $at, %hi(D_800E9E20)
glabel func_801DD74C_ovl15
/* 1E800C 801DD74C 24080006 */  addiu      $t0, $zero, 0x6
.L801DD750_ovl10:
...
/* 1E801C 801DD75C 8C580000 */  lw         $t8, 0x0($v0)
glabel func_801DD760_ovl10
/* 1E8020 801DD760 3C01800F */  lui        $at, %hi(D_800E9FE0)
/* 1E8024 801DD764 3C040001 */  lui        $a0, (0x103EE >> 16)
...
/* 1E8034 801DD774 8C490000 */  lw         $t1, 0x0($v0)
/* 1E8038 801DD778 3C01800E */  lui        $at, %hi(D_800DDFD0)
/* 1E803C 801DD77C 348403EE */  ori        $a0, $a0, (0x103EE & 0xFFFF)
...
/* 1E8050 801DD790 3C040001 */  lui        $a0, (0x103ED >> 16)
/* 1E8054 801DD794 348403ED */  ori        $a0, $a0, (0x103ED & 0xFFFF)
/* 1E8058 801DD798 0C02AA19 */  jal        func_800AA864
/* 1E805C 801DD79C 24050001 */   addiu     $a1, $zero, 0x1
/* 1E8060 801DD7A0 3C0C8005 */  lui        $t4, %hi(D_8004A7C4)
/* 1E8064 801DD7A4 8D8CA7C4 */  lw         $t4, %lo(D_8004A7C4)($t4)
/* 1E8068 801DD7A8 3C01800F */  lui        $at, %hi(D_800E9E20)
.L801DD7AC_ovl12:
/* 1E806C 801DD7AC 240B0001 */  addiu      $t3, $zero, 0x1
/* 1E8070 801DD7B0 8D8D0000 */  lw         $t5, 0x0($t4)
