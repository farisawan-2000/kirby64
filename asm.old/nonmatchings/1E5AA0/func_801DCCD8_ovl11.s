...
/* 1E7598 801DCCD8 3C028005 */  lui        $v0, %hi(D_8004A7C4)
.L801DCCDC_ovl17:
...
.L801DCCEC_ovl15:
/* 1E75AC 801DCCEC 8C4E0000 */  lw         $t6, 0x0($v0)
.L801DCCF0_ovl15:
/* 1E75B0 801DCCF0 3C01800F */  lui        $at, %hi(D_800E9E20)
.L801DCCF4_ovl17:
/* 1E75B4 801DCCF4 24180001 */  addiu      $t8, $zero, 0x1
...
/* 1E75C4 801DCD04 8C590000 */  lw         $t9, 0x0($v0)
/* 1E75C8 801DCD08 3C01800F */  lui        $at, %hi(D_800E9FE0)
/* 1E75CC 801DCD0C 24090002 */  addiu      $t1, $zero, 0x2
.L801DCD10_ovl12:
...
.L801DCD1C_ovl17:
/* 1E75DC 801DCD1C 8C4A0000 */  lw         $t2, 0x0($v0)
/* 1E75E0 801DCD20 3C01800E */  lui        $at, %hi(D_800DDFD0)
/* 1E75E4 801DCD24 24040174 */  addiu      $a0, $zero, 0x174
...
/* 1E75F8 801DCD38 3C040001 */  lui        $a0, (0x103FE >> 16)
.L801DCD3C_ovl15:
/* 1E75FC 801DCD3C 0C02A7A9 */  jal        func_800A9EA4
.L801DCD40_ovl9:
/* 1E7600 801DCD40 348403FE */   ori       $a0, $a0, (0x103FE & 0xFFFF)
/* 1E7604 801DCD44 3C040001 */  lui        $a0, (0x103FD >> 16)
/* 1E7608 801DCD48 0C02A7A9 */  jal        func_800A9EA4
.L801DCD4C_ovl16:
/* 1E760C 801DCD4C 348403FD */   ori       $a0, $a0, (0x103FD & 0xFFFF)
.L801DCD50_ovl12:
/* 1E7610 801DCD50 3C0D8005 */  lui        $t5, %hi(D_8004A7C4)
/* 1E7614 801DCD54 8DADA7C4 */  lw         $t5, %lo(D_8004A7C4)($t5)
/* 1E7618 801DCD58 3C01800F */  lui        $at, %hi(D_800E9E20)
/* 1E761C 801DCD5C 240C0001 */  addiu      $t4, $zero, 0x1
/* 1E7620 801DCD60 8DAE0000 */  lw         $t6, 0x0($t5)
.L801DCD64_ovl16:
