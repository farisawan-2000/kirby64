...
/* 1E7830 801DCF70 3C068005 */  lui        $a2, %hi(D_8004A7C4)
...
.L801DCF84_ovl14:
/* 1E7844 801DCF84 8CC20000 */  lw         $v0, 0x0($a2)
/* 1E7848 801DCF88 3C05800F */  lui        $a1, %hi(D_800E9E20)
.L801DCF8C_ovl17:
/* 1E784C 801DCF8C 24A59E20 */  addiu      $a1, $a1, %lo(D_800E9E20)
/* 1E7850 801DCF90 00021080 */  sll        $v0, $v0, 2
/* 1E7854 801DCF94 00A27021 */  addu       $t6, $a1, $v0
.L801DCF98_ovl9:
/* 1E7858 801DCF98 8DC30000 */  lw         $v1, 0x0($t6)
/* 1E785C 801DCF9C 24070004 */  addiu      $a3, $zero, 0x4
.L801DCFA0_ovl14:
...
/* 1E7890 801DCFD0 8CD80000 */  lw         $t8, 0x0($a2)
glabel func_801DCFD4_ovl17
/* 1E7894 801DCFD4 3C05801E */  lui        $a1, %hi(func_801DC258_ovl12)
/* 1E7898 801DCFD8 24A5C258 */  addiu      $a1, $a1, %lo(func_801DC258_ovl12)
...
.L801DCFE8_ovl9:
/* 1E78A8 801DCFE8 8C84E510 */   lw        $a0, %lo(gEntityGObjProcessArray)($a0)
...
/* 1E78BC 801DCFFC 8C680000 */  lw         $t0, 0x0($v1)
/* 1E78C0 801DD000 2509FFFF */  addiu      $t1, $t0, -0x1
/* 1E78C4 801DD004 AC690000 */  sw         $t1, 0x0($v1)
/* 1E78C8 801DD008 8CC20000 */  lw         $v0, 0x0($a2)
/* 1E78CC 801DD00C 00021080 */  sll        $v0, $v0, 2
/* 1E78D0 801DD010 00825021 */  addu       $t2, $a0, $v0
.L801DD014_ovl9:
/* 1E78D4 801DD014 8D4B0000 */  lw         $t3, 0x0($t2)
glabel func_801DD018_ovl14
/* 1E78D8 801DD018 00A26021 */  addu       $t4, $a1, $v0
/* 1E78DC 801DD01C 55600022 */  bnel       $t3, $zero, .L801DD0A8_ovl11
/* 1E78E0 801DD020 8FBF0014 */   lw        $ra, 0x14($sp)
/* 1E78E4 801DD024 8D8D0000 */  lw         $t5, 0x0($t4)
...
.L801DD038_ovl9:
/* 1E78F8 801DD038 3C01801E */  lui        $at, %hi(D_801E0C24_ovl11)
glabel func_801DD03C_ovl15
/* 1E78FC 801DD03C 46803220 */  cvt.s.w    $f8, $f6
glabel func_801DD040_ovl17
/* 1E7900 801DD040 C4300C24 */  lwc1       $f16, %lo(D_801E0C24_ovl11)($at)
...
/* 1E7920 801DD060 3C068005 */  lui        $a2, %hi(D_8004A7C4)
/* 1E7924 801DD064 8CC6A7C4 */  lw         $a2, %lo(D_8004A7C4)($a2)
/* 1E7928 801DD068 3C18800F */  lui        $t8, %hi(D_800E9E20)
/* 1E792C 801DD06C 27189E20 */  addiu      $t8, $t8, %lo(D_800E9E20)
/* 1E7930 801DD070 8CCE0000 */  lw         $t6, 0x0($a2)
/* 1E7934 801DD074 3C04800F */  lui        $a0, %hi(D_800E9C60)
.L801DD078_ovl9:
/* 1E7938 801DD078 24849C60 */  addiu      $a0, $a0, %lo(D_800E9C60)
.L801DD07C_ovl13:
/* 1E793C 801DD07C 000E7880 */  sll        $t7, $t6, 2
/* 1E7940 801DD080 01F81021 */  addu       $v0, $t7, $t8
.L801DD084_ovl9:
/* 1E7944 801DD084 8C590000 */  lw         $t9, 0x0($v0)
/* 1E7948 801DD088 2409000A */  addiu      $t1, $zero, 0xA
/* 1E794C 801DD08C 27280001 */  addiu      $t0, $t9, 0x1
/* 1E7950 801DD090 AC480000 */  sw         $t0, 0x0($v0)
/* 1E7954 801DD094 8CCA0000 */  lw         $t2, 0x0($a2)
/* 1E7958 801DD098 000A5880 */  sll        $t3, $t2, 2
glabel func_801DD09C_ovl17
/* 1E795C 801DD09C 008B6021 */  addu       $t4, $a0, $t3
.L801DD0A0_ovl9:
/* 1E7960 801DD0A0 AD890000 */  sw         $t1, 0x0($t4)
.L801DD0A4_ovl11:
