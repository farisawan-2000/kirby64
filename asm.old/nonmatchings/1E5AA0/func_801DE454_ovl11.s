...
/* 1E8D14 801DE454 3C0E8005 */  lui        $t6, %hi(D_8004A7C4)
...
/* 1E8D28 801DE468 8DC20000 */  lw         $v0, 0x0($t6)
/* 1E8D2C 801DE46C 3C03800E */  lui        $v1, %hi(D_800E1B50)
/* 1E8D30 801DE470 3C18800F */  lui        $t8, %hi(D_800E9720)
.L801DE474_ovl10:
...
/* 1E8D40 801DE480 27189720 */  addiu      $t8, $t8, %lo(D_800E9720)
glabel func_801DE484_ovl14
/* 1E8D44 801DE484 906F003C */  lbu        $t7, 0x3C($v1)
/* 1E8D48 801DE488 00581821 */  addu       $v1, $v0, $t8
/* 1E8D4C 801DE48C 55E0002B */  bnel       $t7, $zero, .L801DE53C_ovl14
/* 1E8D50 801DE490 8FBF0014 */   lw        $ra, 0x14($sp)
/* 1E8D54 801DE494 8C640000 */  lw         $a0, 0x0($v1)
/* 1E8D58 801DE498 2419003C */  addiu      $t9, $zero, 0x3C
/* 1E8D5C 801DE49C 14800025 */  bnez       $a0, .L801DE534_ovl11
/* 1E8D60 801DE4A0 248FFFFF */   addiu     $t7, $a0, -0x1
.L801DE4A4_ovl16:
/* 1E8D64 801DE4A4 0C077896 */  jal        func_801DE258_ovl11
/* 1E8D68 801DE4A8 AC790000 */   sw        $t9, 0x0($v1)
.L801DE4AC_ovl15:
/* 1E8D6C 801DE4AC 3C038005 */  lui        $v1, %hi(D_8004A7C4)
...
/* 1E8D7C 801DE4BC 8C680000 */  lw         $t0, 0x0($v1)
/* 1E8D80 801DE4C0 3C0A800F */  lui        $t2, %hi(D_800E9560)
/* 1E8D84 801DE4C4 240B0004 */  addiu      $t3, $zero, 0x4
.L801DE4C8_ovl10:
...
.L801DE4D4_ovl16:
/* 1E8D94 801DE4D4 8C620000 */  lw         $v0, 0x0($v1)
/* 1E8D98 801DE4D8 3C01800E */  lui        $at, %hi(gEntityVtableIndexArray)
.L801DE4DC_ovl9:
/* 1E8D9C 801DE4DC 240C0002 */  addiu      $t4, $zero, 0x2
...
.L801DE510_ovl11:
/* 1E8DD0 801DE510 8C6D0000 */  lw         $t5, 0x0($v1)
/* 1E8DD4 801DE514 3C05801E */  lui        $a1, %hi(func_801DDEC0_ovl11)
/* 1E8DD8 801DE518 24A5DEC0 */  addiu      $a1, $a1, %lo(func_801DDEC0_ovl11)
...
/* 1E8DEC 801DE52C 10000003 */  b          .L801DE53C_ovl14
.L801DE530_ovl14:
/* 1E8DF0 801DE530 8FBF0014 */   lw        $ra, 0x14($sp)
.L801DE534_ovl11:
/* 1E8DF4 801DE534 AC6F0000 */  sw         $t7, 0x0($v1)
