...
/* 1E9190 801DE8D0 3C078005 */  lui        $a3, %hi(D_8004A7C4)
/* 1E9194 801DE8D4 24E7A7C4 */  addiu      $a3, $a3, %lo(D_8004A7C4)
/* 1E9198 801DE8D8 8CE20000 */  lw         $v0, 0x0($a3)
...
/* 1E91A8 801DE8E8 8C430000 */  lw         $v1, 0x0($v0)
.L801DE8EC_ovl10:
...
/* 1E91C8 801DE908 11C0002B */  beqz       $t6, .L801DE9B8_ovl12
/* 1E91CC 801DE90C 3C05800F */   lui       $a1, %hi(D_800E9FE0)
/* 1E91D0 801DE910 24A59FE0 */  addiu      $a1, $a1, %lo(D_800E9FE0)
.L801DE914_ovl14:
/* 1E91D4 801DE914 00A32021 */  addu       $a0, $a1, $v1
/* 1E91D8 801DE918 8C8F0000 */  lw         $t7, 0x0($a0)
/* 1E91DC 801DE91C 3C01800E */  lui        $at, %hi(gEntityVtableIndexArray)
/* 1E91E0 801DE920 24090001 */  addiu      $t1, $zero, 0x1
/* 1E91E4 801DE924 25F8FFFF */  addiu      $t8, $t7, -0x1
/* 1E91E8 801DE928 AC980000 */  sw         $t8, 0x0($a0)
/* 1E91EC 801DE92C 8C430000 */  lw         $v1, 0x0($v0)
/* 1E91F0 801DE930 240F0002 */  addiu      $t7, $zero, 0x2
/* 1E91F4 801DE934 3C04800E */  lui        $a0, %hi(gEntityGObjProcessArray)
/* 1E91F8 801DE938 00031880 */  sll        $v1, $v1, 2
/* 1E91FC 801DE93C 00A3C821 */  addu       $t9, $a1, $v1
/* 1E9200 801DE940 8F280000 */  lw         $t0, 0x0($t9)
...
/* 1E9214 801DE954 8CE20000 */  lw         $v0, 0x0($a3)
/* 1E9218 801DE958 3C01800E */  lui        $at, %hi(gEntityVtableIndexArray)
/* 1E921C 801DE95C 240A0001 */  addiu      $t2, $zero, 0x1
/* 1E9220 801DE960 8C4B0000 */  lw         $t3, 0x0($v0)
/* 1E9224 801DE964 3C04800E */  lui        $a0, %hi(gEntityGObjProcessArray)
/* 1E9228 801DE968 3C05801E */  lui        $a1, %hi(func_801DDEC0_ovl11)
...
.L801DE978_ovl13:
/* 1E9238 801DE978 8C4D0000 */  lw         $t5, 0x0($v0)
/* 1E923C 801DE97C 24A5DEC0 */  addiu      $a1, $a1, %lo(func_801DDEC0_ovl11)
...
.L801DE99C_ovl15:
/* 1E925C 801DE99C 8C580000 */  lw         $t8, 0x0($v0)
/* 1E9260 801DE9A0 3C05801E */  lui        $a1, %hi(func_801DDEC0_ovl11)
.L801DE9A4_ovl12:
/* 1E9264 801DE9A4 24A5DEC0 */  addiu      $a1, $a1, %lo(func_801DDEC0_ovl11)
