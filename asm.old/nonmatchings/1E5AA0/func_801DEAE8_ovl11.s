...
/* 1E93A8 801DEAE8 3C068005 */  lui        $a2, %hi(D_8004A7C4)
/* 1E93AC 801DEAEC 24C6A7C4 */  addiu      $a2, $a2, %lo(D_8004A7C4)
.L801DEAF0_ovl14:
/* 1E93B0 801DEAF0 8CCE0000 */  lw         $t6, 0x0($a2)
...
/* 1E93C0 801DEB00 8DC20000 */  lw         $v0, 0x0($t6)
.L801DEB04_ovl9:
...
/* 1E93E4 801DEB24 24180001 */   addiu     $t8, $zero, 0x1
/* 1E93E8 801DEB28 A078003C */  sb         $t8, 0x3C($v1)
/* 1E93EC 801DEB2C 8CC20000 */  lw         $v0, 0x0($a2)
.L801DEB30_ovl14:
/* 1E93F0 801DEB30 3C01800E */  lui        $at, %hi(gEntityVtableIndexArray)
/* 1E93F4 801DEB34 24190001 */  addiu      $t9, $zero, 0x1
/* 1E93F8 801DEB38 8C480000 */  lw         $t0, 0x0($v0)
/* 1E93FC 801DEB3C 3C04800E */  lui        $a0, %hi(gEntityGObjProcessArray)
/* 1E9400 801DEB40 3C05801E */  lui        $a1, %hi(func_801DDEC0_ovl11)
.L801DEB44_ovl10:
...
/* 1E9410 801DEB50 8C4A0000 */  lw         $t2, 0x0($v0)
/* 1E9414 801DEB54 24A5DEC0 */  addiu      $a1, $a1, %lo(func_801DDEC0_ovl11)
