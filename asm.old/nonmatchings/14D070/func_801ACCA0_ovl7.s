...
/* 152D28 801ACCB8 00403025 */   or        $a2, $v0, $zero
/* 152D2C 801ACCBC 1000001E */  b          .L801ACD38_ovl7
/* 152D30 801ACCC0 00001025 */   or        $v0, $zero, $zero
.L801ACCC4_ovl7:
/* 152D34 801ACCC4 3C0F800E */  lui        $t7, %hi(gEntitiesNextPosYArray)
/* 152D38 801ACCC8 25EF2790 */  addiu      $t7, $t7, %lo(gEntitiesNextPosYArray)
/* 152D3C 801ACCCC 00067080 */  sll        $t6, $a2, 2
/* 152D40 801ACCD0 01CF1021 */  addu       $v0, $t6, $t7
/* 152D44 801ACCD4 C4440000 */  lwc1       $f4, 0x0($v0)
/* 152D48 801ACCD8 C7A6002C */  lwc1       $f6, 0x2C($sp)
/* 152D4C 801ACCDC 3C188005 */  lui        $t8, %hi(D_8004A7C4)
...
/* 152D5C 801ACCEC 00C02025 */  or         $a0, $a2, $zero
/* 152D60 801ACCF0 E4480000 */  swc1       $f8, 0x0($v0)
/* 152D64 801ACCF4 8F18A7C4 */  lw         $t8, %lo(D_8004A7C4)($t8)
/* 152D68 801ACCF8 8F190000 */  lw         $t9, 0x0($t8)
...
/* 152DA0 801ACD30 00001025 */   or        $v0, $zero, $zero
.L801ACD34_ovl7:
/* 152DA4 801ACD34 00C01025 */  or         $v0, $a2, $zero
.L801ACD38_ovl7:
