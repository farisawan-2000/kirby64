...
/* 151078 801AB008 3C028005 */  lui        $v0, %hi(D_8004A7C4)
/* 15107C 801AB00C 8C42A7C4 */  lw         $v0, %lo(D_8004A7C4)($v0)
/* 151080 801AB010 3C05800E */  lui        $a1, %hi(D_800E4C50)
/* 151084 801AB014 3C01801D */  lui        $at, %hi(D_801CE12C_ovl7)
/* 151088 801AB018 8C4E0000 */  lw         $t6, 0x0($v0)
/* 15108C 801AB01C C422E12C */  lwc1       $f2, %lo(D_801CE12C_ovl7)($at)
/* 151090 801AB020 24A54C50 */  addiu      $a1, $a1, %lo(D_800E4C50)
/* 151094 801AB024 000E7880 */  sll        $t7, $t6, 2
/* 151098 801AB028 00AF2021 */  addu       $a0, $a1, $t7
/* 15109C 801AB02C 3C01801D */  lui        $at, %hi(D_801CE130_ovl7)
/* 1510A0 801AB030 C426E130 */  lwc1       $f6, %lo(D_801CE130_ovl7)($at)
/* 1510A4 801AB034 C4840000 */  lwc1       $f4, 0x0($a0)
/* 1510A8 801AB038 3C18800E */  lui        $t8, %hi(gEntitiesAngleZArray)
/* 1510AC 801AB03C 27184390 */  addiu      $t8, $t8, %lo(gEntitiesAngleZArray)
/* 1510B0 801AB040 46062200 */  add.s      $f8, $f4, $f6
/* 1510B4 801AB044 E4880000 */  swc1       $f8, 0x0($a0)
/* 1510B8 801AB048 8C430000 */  lw         $v1, 0x0($v0)
/* 1510BC 801AB04C 00031880 */  sll        $v1, $v1, 2
/* 1510C0 801AB050 00A32021 */  addu       $a0, $a1, $v1
/* 1510C4 801AB054 C4800000 */  lwc1       $f0, 0x0($a0)
...
/* 1510E0 801AB070 E48A0000 */  swc1       $f10, 0x0($a0)
/* 1510E4 801AB074 8C430000 */  lw         $v1, 0x0($v0)
...
/* 151100 801AB090 8C430000 */  lw         $v1, 0x0($v0)
/* 151104 801AB094 3C01801D */  lui        $at, %hi(D_801CE134_ovl7)
/* 151108 801AB098 C430E134 */  lwc1       $f16, %lo(D_801CE134_ovl7)($at)
/* 15110C 801AB09C 00031880 */  sll        $v1, $v1, 2
/* 151110 801AB0A0 00782021 */  addu       $a0, $v1, $t8
/* 151114 801AB0A4 C4820000 */  lwc1       $f2, 0x0($a0)
/* 151118 801AB0A8 3C01801D */  lui        $at, %hi(D_801CE138_ovl7)
...
/* 15112C 801AB0BC C432E138 */  lwc1       $f18, %lo(D_801CE138_ovl7)($at)
/* 151130 801AB0C0 3C01801D */  lui        $at, %hi(D_801CE13C_ovl7)
...
/* 151144 801AB0D4 C424E13C */  lwc1       $f4, %lo(D_801CE13C_ovl7)($at)
...
/* 151154 801AB0E4 8C430000 */  lw         $v1, 0x0($v0)
/* 151158 801AB0E8 3C19800E */  lui        $t9, %hi(gEntitiesAngleZArray)
/* 15115C 801AB0EC 27394390 */  addiu      $t9, $t9, %lo(gEntitiesAngleZArray)
/* 151160 801AB0F0 00031880 */  sll        $v1, $v1, 2
/* 151164 801AB0F4 00792021 */  addu       $a0, $v1, $t9
/* 151168 801AB0F8 10000018 */  b          .L801AB15C_ovl7
/* 15116C 801AB0FC C4820000 */   lwc1      $f2, 0x0($a0)
.L801AB100_ovl7:
/* 151170 801AB100 3C01801D */  lui        $at, %hi(D_801CE140_ovl7)
/* 151174 801AB104 C426E140 */  lwc1       $f6, %lo(D_801CE140_ovl7)($at)
/* 151178 801AB108 3C01801D */  lui        $at, %hi(D_801CE144_ovl7)
...
/* 15118C 801AB11C C428E144 */  lwc1       $f8, %lo(D_801CE144_ovl7)($at)
/* 151190 801AB120 3C01801D */  lui        $at, %hi(D_801CE148_ovl7)
...
/* 1511A4 801AB134 C42AE148 */  lwc1       $f10, %lo(D_801CE148_ovl7)($at)
...
/* 1511B4 801AB144 8C430000 */  lw         $v1, 0x0($v0)
/* 1511B8 801AB148 3C08800E */  lui        $t0, %hi(gEntitiesAngleZArray)
/* 1511BC 801AB14C 25084390 */  addiu      $t0, $t0, %lo(gEntitiesAngleZArray)
/* 1511C0 801AB150 00031880 */  sll        $v1, $v1, 2
/* 1511C4 801AB154 00682021 */  addu       $a0, $v1, $t0
/* 1511C8 801AB158 C4820000 */  lwc1       $f2, 0x0($a0)
.L801AB15C_ovl7:
...
/* 1511E0 801AB170 E4920000 */   swc1      $f18, 0x0($a0)
