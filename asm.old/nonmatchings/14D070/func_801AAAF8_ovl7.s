...
/* 150B68 801AAAF8 3C0E8005 */  lui        $t6, %hi(D_8004A7C4)
...
/* 150B7C 801AAB0C 8DC60000 */  lw         $a2, 0x0($t6)
/* 150B80 801AAB10 3C0F800E */  lui        $t7, %hi(D_800E7730)
/* 150B84 801AAB14 24010006 */  addiu      $at, $zero, 0x6
...
.L801AAB50_ovl7:
/* 150BC0 801AAB50 3C198005 */   lui       $t9, %hi(D_8004A7C4)
...
/* 150BD0 801AAB60 8F220000 */  lw         $v0, 0x0($t9)
/* 150BD4 801AAB64 24010012 */  addiu      $at, $zero, 0x12
...
/* 150C0C 801AAB9C 3C05801B */  lui        $a1, %hi(func_801AC33C_ovl7)
/* 150C10 801AABA0 24A5C33C */  addiu      $a1, $a1, %lo(func_801AC33C_ovl7)
...
/* 150C28 801AABB8 3C05801B */  lui        $a1, %hi(func_801AC11C_ovl7)
/* 150C2C 801AABBC 24A5C11C */  addiu      $a1, $a1, %lo(func_801AC11C_ovl7)
/* 150C30 801AABC0 0C02C7B2 */  jal        assign_new_process_entry
/* 150C34 801AABC4 8C84E510 */   lw        $a0, %lo(gEntityGObjProcessArray)($a0)
...
/* 150C48 801AABD8 3C038005 */  lui        $v1, %hi(D_8004A7C4)
/* 150C4C 801AABDC 8C63A7C4 */  lw         $v1, %lo(D_8004A7C4)($v1)
/* 150C50 801AABE0 3C09800F */  lui        $t1, %hi(D_800E8AE0)
/* 150C54 801AABE4 3C014160 */  lui        $at, (0x41600000 >> 16)
/* 150C58 801AABE8 8C620000 */  lw         $v0, 0x0($v1)
...
/* 150C9C 801AAC2C 8C6B0000 */  lw         $t3, 0x0($v1)
...
/* 150CB0 801AAC40 8C6D0000 */  lw         $t5, 0x0($v1)
/* 150CB4 801AAC44 3C01800E */  lui        $at, %hi(D_800E6850)
/* 150CB8 801AAC48 000D7080 */  sll        $t6, $t5, 2
/* 150CBC 801AAC4C 002E0821 */  addu       $at, $at, $t6
/* 150CC0 801AAC50 10000014 */  b          .L801AACA4_ovl7
/* 150CC4 801AAC54 E4206850 */   swc1      $f0, %lo(D_800E6850)($at)
...
/* 150CEC 801AAC7C 8C6F0000 */  lw         $t7, 0x0($v1)
...
/* 150D00 801AAC90 8C790000 */  lw         $t9, 0x0($v1)
...
.L801AACA4_ovl7:
/* 150D14 801AACA4 8C660000 */  lw         $a2, 0x0($v1)
...
/* 150D28 801AACB8 24010006 */  addiu      $at, $zero, 0x6
...
/* 150D3C 801AACCC 28610008 */  slti       $at, $v1, 0x8
...
/* 150D4C 801AACDC 3C04801D */   lui       $a0, %hi(D_801CB0F8_ovl7)
/* 150D50 801AACE0 0C068E4E */  jal        func_801A3938
/* 150D54 801AACE4 2484B0F8 */   addiu     $a0, $a0, %lo(D_801CB0F8_ovl7)
/* 150D58 801AACE8 3C04801A */  lui        $a0, %hi(func_801A3864_ovl7)
/* 150D5C 801AACEC 0C068DB3 */  jal        func_801A36CC
/* 150D60 801AACF0 24843864 */   addiu     $a0, $a0, %lo(func_801A3864_ovl7)
/* 150D64 801AACF4 0C06835D */  jal        func_801A0D74_ovl7
/* 150D68 801AACF8 8FA40018 */   lw        $a0, 0x18($sp)
/* 150D6C 801AACFC 3C0A8005 */  lui        $t2, %hi(D_8004A7C4)
/* 150D70 801AAD00 8D4AA7C4 */  lw         $t2, %lo(D_8004A7C4)($t2)
/* 150D74 801AAD04 3C03800E */  lui        $v1, %hi(D_800E77A0)
/* 150D78 801AAD08 3C04801D */  lui        $a0, %hi(D_801CA7DC_ovl7)
/* 150D7C 801AAD0C 8D460000 */  lw         $a2, 0x0($t2)
/* 150D80 801AAD10 2484A7DC */  addiu      $a0, $a0, %lo(D_801CA7DC_ovl7)
...
/* 150D90 801AAD20 28610008 */  slti       $at, $v1, 0x8
...
/* 150DF4 801AAD84 28610008 */   slti      $at, $v1, 0x8
...
/* 150E0C 801AAD9C 3C04801D */   lui       $a0, %hi(D_801CB008_ovl7)
/* 150E10 801AADA0 0C068E4E */  jal        func_801A3938
/* 150E14 801AADA4 2484B008 */   addiu     $a0, $a0, %lo(D_801CB008_ovl7)
/* 150E18 801AADA8 3C04801A */  lui        $a0, %hi(func_801A3864_ovl7)
/* 150E1C 801AADAC 0C068DB3 */  jal        func_801A36CC
/* 150E20 801AADB0 24843864 */   addiu     $a0, $a0, %lo(func_801A3864_ovl7)
.L801AADB4_ovl7:
/* 150E24 801AADB4 3C0D8005 */  lui        $t5, %hi(D_8004A7C4)
/* 150E28 801AADB8 8DADA7C4 */  lw         $t5, %lo(D_8004A7C4)($t5)
/* 150E2C 801AADBC 3C04801D */  lui        $a0, %hi(D_801D0A58_ovl7)
/* 150E30 801AADC0 24840A58 */  addiu      $a0, $a0, %lo(D_801D0A58_ovl7)
/* 150E34 801AADC4 0C0445EF */  jal        func_801117BC
/* 150E38 801AADC8 8DA50000 */   lw        $a1, 0x0($t5)
/* 150E3C 801AADCC 0C044713 */  jal        func_80111C4C
/* 150E40 801AADD0 00402025 */   or        $a0, $v0, $zero
...
/* 150E58 801AADE8 3C04801D */   lui       $a0, %hi(D_801CB008_ovl7)
/* 150E5C 801AADEC 0C068E4E */  jal        func_801A3938
/* 150E60 801AADF0 2484B008 */   addiu     $a0, $a0, %lo(D_801CB008_ovl7)
/* 150E64 801AADF4 3C04801A */  lui        $a0, %hi(func_801A3864_ovl7)
/* 150E68 801AADF8 0C068DB3 */  jal        func_801A36CC
/* 150E6C 801AADFC 24843864 */   addiu     $a0, $a0, %lo(func_801A3864_ovl7)
.L801AAE00_ovl7:
/* 150E70 801AAE00 3C0E8005 */  lui        $t6, %hi(D_8004A7C4)
/* 150E74 801AAE04 8DCEA7C4 */  lw         $t6, %lo(D_8004A7C4)($t6)
/* 150E78 801AAE08 3C04801D */  lui        $a0, %hi(D_801CA6F4_ovl7)
/* 150E7C 801AAE0C 2484A6F4 */  addiu      $a0, $a0, %lo(D_801CA6F4_ovl7)
/* 150E80 801AAE10 0C0445EF */  jal        func_801117BC
/* 150E84 801AAE14 8DC50000 */   lw        $a1, 0x0($t6)
/* 150E88 801AAE18 0C044713 */  jal        func_80111C4C
/* 150E8C 801AAE1C 00402025 */   or        $a0, $v0, $zero
.L801AAE20_ovl7:
/* 150E90 801AAE20 3C0F8005 */  lui        $t7, %hi(D_8004A7C4)
/* 150E94 801AAE24 8DEFA7C4 */  lw         $t7, %lo(D_8004A7C4)($t7)
/* 150E98 801AAE28 3C08800F */  lui        $t0, %hi(D_800E8920)
/* 150E9C 801AAE2C 25088920 */  addiu      $t0, $t0, %lo(D_800E8920)
/* 150EA0 801AAE30 8DF80000 */  lw         $t8, 0x0($t7)
/* 150EA4 801AAE34 24010001 */  addiu      $at, $zero, 0x1
/* 150EA8 801AAE38 0018C880 */  sll        $t9, $t8, 2
/* 150EAC 801AAE3C 03281021 */  addu       $v0, $t9, $t0
/* 150EB0 801AAE40 8C490000 */  lw         $t1, 0x0($v0)
/* 150EB4 801AAE44 55210003 */  bnel       $t1, $at, .L801AAE54_ovl7
/* 150EB8 801AAE48 8FBF0014 */   lw        $ra, 0x14($sp)
/* 150EBC 801AAE4C AC400000 */  sw         $zero, 0x0($v0)
.L801AAE50_ovl7:
