...
/* 150244 801AA1D4 3C0E8005 */  lui        $t6, %hi(D_8004A7C4)
...
/* 150258 801AA1E8 8DC20000 */  lw         $v0, 0x0($t6)
/* 15025C 801AA1EC 3C07800E */  lui        $a3, %hi(D_800E1B50)
/* 150260 801AA1F0 3C09801B */  lui        $t1, %hi(func_801AA33C_ovl7)
...
/* 15027C 801AA20C 2529A33C */  addiu      $t1, $t1, %lo(func_801AA33C_ovl7)
/* 150280 801AA210 8DE3000C */  lw         $v1, 0xC($t7)
/* 150284 801AA214 8C780004 */  lw         $t8, 0x4($v1)
/* 150288 801AA218 AFB80024 */  sw         $t8, 0x24($sp)
/* 15028C 801AA21C 8C790004 */  lw         $t9, 0x4($v1)
...
/* 1502A8 801AA238 3C0A8005 */  lui        $t2, %hi(D_8004A7C4)
...
/* 1502B8 801AA248 8D4B0000 */  lw         $t3, 0x0($t2)
...
/* 1502D8 801AA268 00402025 */   or        $a0, $v0, $zero
.L801AA26C_ovl7:
/* 1502DC 801AA26C 0C0288C0 */  jal        func_800A2300
/* 1502E0 801AA270 8FA40030 */   lw        $a0, 0x30($sp)
/* 1502E4 801AA274 3C03801D */  lui        $v1, %hi(D_801D0AA0_ovl7)
/* 1502E8 801AA278 3C04801D */  lui        $a0, %hi(D_801D0A9C_ovl7)
/* 1502EC 801AA27C 24840A9C */  addiu      $a0, $a0, %lo(D_801D0A9C_ovl7)
/* 1502F0 801AA280 24630AA0 */  addiu      $v1, $v1, %lo(D_801D0AA0_ovl7)
/* 1502F4 801AA284 AC600000 */  sw         $zero, 0x0($v1)
/* 1502F8 801AA288 AC800000 */  sw         $zero, 0x0($a0)
/* 1502FC 801AA28C 3C01801D */  lui        $at, %hi(D_801D0A98_ovl7)
/* 150300 801AA290 8FB8002C */  lw         $t8, 0x2C($sp)
/* 150304 801AA294 AC200A98 */  sw         $zero, %lo(D_801D0A98_ovl7)($at)
/* 150308 801AA298 3C01801D */  lui        $at, %hi(D_801D0AA8_ovl7)
/* 15030C 801AA29C 8FA50024 */  lw         $a1, 0x24($sp)
/* 150310 801AA2A0 8FA6001C */  lw         $a2, 0x1C($sp)
/* 150314 801AA2A4 AC200AA8 */  sw         $zero, %lo(D_801D0AA8_ovl7)($at)
/* 150318 801AA2A8 3C028005 */  lui        $v0, %hi(D_8004A7C4)
/* 15031C 801AA2AC AF000034 */  sw         $zero, 0x34($t8)
/* 150320 801AA2B0 8C42A7C4 */  lw         $v0, %lo(D_8004A7C4)($v0)
/* 150324 801AA2B4 3C018013 */  lui        $at, %hi(D_8012E860 + 0x18)
/* 150328 801AA2B8 A020E878 */  sb         $zero, %lo(D_8012E860 + 0x18)($at)
/* 15032C 801AA2BC 8C590000 */  lw         $t9, 0x0($v0)
...
/* 150344 801AA2D4 8C490000 */  lw         $t1, 0x0($v0)
...
/* 15035C 801AA2EC 8C4B0000 */  lw         $t3, 0x0($v0)
