...
/* 241BA0 80221490 3C028005 */  lui        $v0, %hi(D_8004A7C4)
/* 241BA4 80221494 8C42A7C4 */  lw         $v0, %lo(D_8004A7C4)($v0)
glabel func_80221498_ovl18
/* 241BA8 80221498 3C07800F */  lui        $a3, %hi(D_800EC2E0)
/* 241BAC 8022149C 24E7C2E0 */  addiu      $a3, $a3, %lo(D_800EC2E0)
/* 241BB0 802214A0 8C430000 */  lw         $v1, 0x0($v0)
/* 241BB4 802214A4 3C018023 */  lui        $at, %hi(D_8022F0F8_ovl19)
/* 241BB8 802214A8 3C048023 */  lui        $a0, %hi(D_8022F104_ovl19)
/* 241BBC 802214AC 00031880 */  sll        $v1, $v1, 2
/* 241BC0 802214B0 00E37021 */  addu       $t6, $a3, $v1
/* 241BC4 802214B4 8DCF0000 */  lw         $t7, 0x0($t6)
/* 241BC8 802214B8 3C050001 */  lui        $a1, (0x1869F >> 16)
/* 241BCC 802214BC 34A5869F */  ori        $a1, $a1, (0x1869F & 0xFFFF)
/* 241BD0 802214C0 000FC080 */  sll        $t8, $t7, 2
/* 241BD4 802214C4 00380821 */  addu       $at, $at, $t8
/* 241BD8 802214C8 C424F0F8 */  lwc1       $f4, %lo(D_8022F0F8_ovl19)($at)
...
/* 241BE8 802214D8 8C590000 */  lw         $t9, 0x0($v0)
/* 241BEC 802214DC 3C0142DC */  lui        $at, (0x42DC0000 >> 16)
...
/* 241C04 802214F4 8C490000 */  lw         $t1, 0x0($v0)
/* 241C08 802214F8 3C01C2C8 */  lui        $at, (0xC2C80000 >> 16)
...
/* 241C20 80221510 8C4B0000 */  lw         $t3, 0x0($v0)
/* 241C24 80221514 3C18800D */  lui        $t8, %hi(D_800D6ED0 + 0x48)
/* 241C28 80221518 24060010 */  addiu      $a2, $zero, 0x10
/* 241C2C 8022151C 000B6080 */  sll        $t4, $t3, 2
/* 241C30 80221520 00EC6821 */  addu       $t5, $a3, $t4
/* 241C34 80221524 8DAE0000 */  lw         $t6, 0x0($t5)
/* 241C38 80221528 000E7880 */  sll        $t7, $t6, 2
/* 241C3C 8022152C 030FC021 */  addu       $t8, $t8, $t7
/* 241C40 80221530 8F186F18 */  lw         $t8, %lo(D_800D6ED0 + 0x48)($t8)
/* 241C44 80221534 0018C8C0 */  sll        $t9, $t8, 3
/* 241C48 80221538 00992021 */  addu       $a0, $a0, $t9
/* 241C4C 8022153C 0C02A619 */  jal        func_800A9864
/* 241C50 80221540 8C84F104 */   lw        $a0, %lo(D_8022F104_ovl19)($a0)
/* 241C54 80221544 3C088005 */  lui        $t0, %hi(D_8004A7C4)
/* 241C58 80221548 8D08A7C4 */  lw         $t0, %lo(D_8004A7C4)($t0)
/* 241C5C 8022154C 3C0B800F */  lui        $t3, %hi(D_800EC2E0)
/* 241C60 80221550 3C0D800D */  lui        $t5, %hi(D_800D6ED0 + 0x48)
/* 241C64 80221554 8D090000 */  lw         $t1, 0x0($t0)
/* 241C68 80221558 3C048023 */  lui        $a0, %hi(D_8022F108_ovl19)
