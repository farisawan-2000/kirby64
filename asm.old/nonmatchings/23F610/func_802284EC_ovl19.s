...
/* 248C18 80228508 3C028005 */  lui        $v0, %hi(D_8004A7C4)
/* 248C1C 8022850C 8C42A7C4 */  lw         $v0, %lo(D_8004A7C4)($v0)
/* 248C20 80228510 44802000 */  mtc1       $zero, $f4
/* 248C24 80228514 3C05800E */  lui        $a1, %hi(D_800E6850)
/* 248C28 80228518 8C4F0000 */  lw         $t7, 0x0($v0)
/* 248C2C 8022851C 24A56850 */  addiu      $a1, $a1, %lo(D_800E6850)
/* 248C30 80228520 3C01800E */  lui        $at, %hi(D_800E6690)
/* 248C34 80228524 000FC080 */  sll        $t8, $t7, 2
/* 248C38 80228528 00B8C821 */  addu       $t9, $a1, $t8
/* 248C3C 8022852C E7240000 */  swc1       $f4, 0x0($t9)
/* 248C40 80228530 8C430000 */  lw         $v1, 0x0($v0)
/* 248C44 80228534 3C068013 */  lui        $a2, %hi(gKirbyState)
/* 248C48 80228538 24C6E7C0 */  addiu      $a2, $a2, %lo(gKirbyState)
/* 248C4C 8022853C 00031880 */  sll        $v1, $v1, 2
/* 248C50 80228540 00A34021 */  addu       $t0, $a1, $v1
/* 248C54 80228544 C5000000 */  lwc1       $f0, 0x0($t0)
/* 248C58 80228548 00230821 */  addu       $at, $at, $v1
/* 248C5C 8022854C 240B0001 */  addiu      $t3, $zero, 0x1
/* 248C60 80228550 E4206690 */  swc1       $f0, %lo(D_800E6690)($at)
/* 248C64 80228554 8C490000 */  lw         $t1, 0x0($v0)
/* 248C68 80228558 3C01800E */  lui        $at, %hi(D_800E64D0)
/* 248C6C 8022855C 240C004E */  addiu      $t4, $zero, 0x4E
...
/* 248C88 80228578 94440002 */   lhu       $a0, 0x2($v0)
.L8022857C_ovl19:
