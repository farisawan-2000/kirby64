...
/* 24056C 8021FE5C 3C028005 */  lui        $v0, %hi(D_8004A7C4)
...
.L8021FE70_ovl18:
/* 240580 8021FE70 8C430000 */  lw         $v1, 0x0($v0)
/* 240584 8021FE74 3C0E800F */  lui        $t6, %hi(D_800E98E0)
/* 240588 8021FE78 3C068013 */  lui        $a2, %hi(gKirbyState)
...
/* 240598 8021FE88 24C6E7C0 */  addiu      $a2, $a2, %lo(gKirbyState)
/* 24059C 8021FE8C 55C0003D */  bnel       $t6, $zero, .L8021FF84_ovl19
/* 2405A0 8021FE90 8FBF0014 */   lw        $ra, 0x14($sp)
/* 2405A4 8021FE94 8CCF016C */  lw         $t7, 0x16C($a2)
/* 2405A8 8021FE98 3C04800E */  lui        $a0, %hi(gEntitiesNextPosYArray)
/* 2405AC 8021FE9C 24842790 */  addiu      $a0, $a0, %lo(gEntitiesNextPosYArray)
/* 2405B0 8021FEA0 11E00037 */  beqz       $t7, func_8021FF80_ovl19
/* 2405B4 8021FEA4 0083C021 */   addu      $t8, $a0, $v1
/* 2405B8 8021FEA8 3C0141A0 */  lui        $at, (0x41A00000 >> 16)
/* 2405BC 8021FEAC 44814000 */  mtc1       $at, $f8
/* 2405C0 8021FEB0 C7060000 */  lwc1       $f6, 0x0($t8)
/* 2405C4 8021FEB4 C4840000 */  lwc1       $f4, 0x0($a0)
/* 2405C8 8021FEB8 3C03800E */  lui        $v1, %hi(gEntitiesNextPosXArray)
glabel func_8021FEBC_ovl18
/* 2405CC 8021FEBC 46083281 */  sub.s      $f10, $f6, $f8
/* 2405D0 8021FEC0 3C07800E */  lui        $a3, %hi(gEntitiesNextPosZArray)
/* 2405D4 8021FEC4 24E72950 */  addiu      $a3, $a3, %lo(gEntitiesNextPosZArray)
/* 2405D8 8021FEC8 246325D0 */  addiu      $v1, $v1, %lo(gEntitiesNextPosXArray)
...
/* 2405F0 8021FEE0 C4700000 */  lwc1       $f16, 0x0($v1)
/* 2405F4 8021FEE4 C4F20000 */  lwc1       $f18, 0x0($a3)
...
/* 240604 8021FEF4 8C590000 */  lw         $t9, 0x0($v0)
...
/* 240660 8021FF50 3C18800F */  lui        $t8, %hi(D_800E98E0)
/* 240664 8021FF54 271898E0 */  addiu      $t8, $t8, %lo(D_800E98E0)
/* 240668 8021FF58 8DAE0000 */  lw         $t6, 0x0($t5)
/* 24066C 8021FF5C 24030001 */  addiu      $v1, $zero, 0x1
/* 240670 8021FF60 A0C30017 */  sb         $v1, 0x17($a2)
/* 240674 8021FF64 000E7880 */  sll        $t7, $t6, 2
/* 240678 8021FF68 01F81021 */  addu       $v0, $t7, $t8
/* 24067C 8021FF6C 8C590000 */  lw         $t9, 0x0($v0)
/* 240680 8021FF70 A0C0000C */  sb         $zero, 0xC($a2)
/* 240684 8021FF74 A4C30068 */  sh         $v1, 0x68($a2)
/* 240688 8021FF78 27280001 */  addiu      $t0, $t9, 0x1
/* 24068C 8021FF7C AC480000 */  sw         $t0, 0x0($v0)
glabel func_8021FF80_ovl19
