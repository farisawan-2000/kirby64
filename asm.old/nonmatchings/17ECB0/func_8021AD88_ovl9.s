...
/* 1C8DE0 8021AD90 0C06738A */  jal        func_8019CE28_ovl7
...
/* 1C8DF0 8021ADA0 3C028005 */  lui        $v0, %hi(D_8004A7C4)
/* 1C8DF4 8021ADA4 8C42A7C4 */  lw         $v0, %lo(D_8004A7C4)($v0)
/* 1C8DF8 8021ADA8 44802000 */  mtc1       $zero, $f4
/* 1C8DFC 8021ADAC 3C06800E */  lui        $a2, %hi(D_800E3910)
/* 1C8E00 8021ADB0 8C4E0000 */  lw         $t6, 0x0($v0)
/* 1C8E04 8021ADB4 24C63910 */  addiu      $a2, $a2, %lo(D_800E3910)
/* 1C8E08 8021ADB8 3C01800E */  lui        $at, %hi(D_800E3750)
/* 1C8E0C 8021ADBC 000E7880 */  sll        $t7, $t6, 2
/* 1C8E10 8021ADC0 00CFC021 */  addu       $t8, $a2, $t7
/* 1C8E14 8021ADC4 E7040000 */  swc1       $f4, 0x0($t8)
/* 1C8E18 8021ADC8 8C430000 */  lw         $v1, 0x0($v0)
/* 1C8E1C 8021ADCC 3C07800E */  lui        $a3, %hi(D_800E3E50)
/* 1C8E20 8021ADD0 24E73E50 */  addiu      $a3, $a3, %lo(D_800E3E50)
/* 1C8E24 8021ADD4 00031880 */  sll        $v1, $v1, 2
/* 1C8E28 8021ADD8 00C3C821 */  addu       $t9, $a2, $v1
/* 1C8E2C 8021ADDC C7200000 */  lwc1       $f0, 0x0($t9)
...
/* 1C8E3C 8021ADEC 8C480000 */  lw         $t0, 0x0($v0)
/* 1C8E40 8021ADF0 3C01800E */  lui        $at, %hi(D_800E3590)
/* 1C8E44 8021ADF4 3C058022 */  lui        $a1, %hi(func_8021ABB4_ovl9)
...
/* 1C8E54 8021AE04 8C4A0000 */  lw         $t2, 0x0($v0)
/* 1C8E58 8021AE08 3C01800E */  lui        $at, %hi(D_800E33D0)
/* 1C8E5C 8021AE0C 24A5ABB4 */  addiu      $a1, $a1, %lo(func_8021ABB4_ovl9)
...
/* 1C8E6C 8021AE1C 8C4C0000 */  lw         $t4, 0x0($v0)
...
/* 1C8E80 8021AE30 8C4E0000 */  lw         $t6, 0x0($v0)
/* 1C8E84 8021AE34 3C01800E */  lui        $at, %hi(D_800E3050)
/* 1C8E88 8021AE38 240C0001 */  addiu      $t4, $zero, 0x1
...
/* 1C8E98 8021AE48 8C580000 */  lw         $t8, 0x0($v0)
/* 1C8E9C 8021AE4C 3C018022 */  lui        $at, %hi(D_8021DEE0_ovl9)
...
/* 1C8EE0 8021AE90 8C4D0000 */  lw         $t5, 0x0($v0)
...
/* 1C8EF4 8021AEA4 8C4F0000 */  lw         $t7, 0x0($v0)
...
/* 1C8F14 8021AEC4 3C0A800F */  lui        $t2, %hi(D_800E9720)
/* 1C8F18 8021AEC8 254A9720 */  addiu      $t2, $t2, %lo(D_800E9720)
/* 1C8F1C 8021AECC 8F280000 */  lw         $t0, 0x0($t9)
/* 1C8F20 8021AED0 00084880 */  sll        $t1, $t0, 2
/* 1C8F24 8021AED4 012A1021 */  addu       $v0, $t1, $t2
/* 1C8F28 8021AED8 8C430000 */  lw         $v1, 0x0($v0)
/* 1C8F2C 8021AEDC 10600003 */  beqz       $v1, .L8021AEEC_ovl9
/* 1C8F30 8021AEE0 246BFFFF */   addiu     $t3, $v1, -0x1
/* 1C8F34 8021AEE4 1000004C */  b          .L8021B018_ovl9
/* 1C8F38 8021AEE8 AC4B0000 */   sw        $t3, 0x0($v0)
.L8021AEEC_ovl9:
/* 1C8F3C 8021AEEC 3C0142F0 */  lui        $at, (0x42F00000 >> 16)
/* 1C8F40 8021AEF0 44816000 */  mtc1       $at, $f12
/* 1C8F44 8021AEF4 0C0669FA */  jal        func_8019A7E8_ovl7
/* 1C8F48 8021AEF8 00000000 */   nop
/* 1C8F4C 8021AEFC 10400046 */  beqz       $v0, .L8021B018_ovl9
/* 1C8F50 8021AF00 3C028005 */   lui       $v0, %hi(D_8004A7C4)
/* 1C8F54 8021AF04 8C42A7C4 */  lw         $v0, %lo(D_8004A7C4)($v0)
/* 1C8F58 8021AF08 44804000 */  mtc1       $zero, $f8
/* 1C8F5C 8021AF0C 3C06800E */  lui        $a2, %hi(D_800E3910)
/* 1C8F60 8021AF10 8C4D0000 */  lw         $t5, 0x0($v0)
/* 1C8F64 8021AF14 24C63910 */  addiu      $a2, $a2, %lo(D_800E3910)
/* 1C8F68 8021AF18 3C01800E */  lui        $at, %hi(D_800E3750)
/* 1C8F6C 8021AF1C 000D6080 */  sll        $t4, $t5, 2
/* 1C8F70 8021AF20 00CC7021 */  addu       $t6, $a2, $t4
/* 1C8F74 8021AF24 E5C80000 */  swc1       $f8, 0x0($t6)
/* 1C8F78 8021AF28 8C430000 */  lw         $v1, 0x0($v0)
/* 1C8F7C 8021AF2C 3C07800E */  lui        $a3, %hi(D_800E3E50)
/* 1C8F80 8021AF30 24E73E50 */  addiu      $a3, $a3, %lo(D_800E3E50)
/* 1C8F84 8021AF34 00031880 */  sll        $v1, $v1, 2
/* 1C8F88 8021AF38 00C37821 */  addu       $t7, $a2, $v1
/* 1C8F8C 8021AF3C C5E00000 */  lwc1       $f0, 0x0($t7)
...
/* 1C8F9C 8021AF4C 8C580000 */  lw         $t8, 0x0($v0)
/* 1C8FA0 8021AF50 3C01800E */  lui        $at, %hi(D_800E3590)
/* 1C8FA4 8021AF54 3C058022 */  lui        $a1, %hi(func_8021ABB4_ovl9)
...
/* 1C8FB4 8021AF64 8C480000 */  lw         $t0, 0x0($v0)
/* 1C8FB8 8021AF68 3C01800E */  lui        $at, %hi(D_800E33D0)
/* 1C8FBC 8021AF6C 24A5ABB4 */  addiu      $a1, $a1, %lo(func_8021ABB4_ovl9)
...
/* 1C8FCC 8021AF7C 8C4A0000 */  lw         $t2, 0x0($v0)
...
/* 1C8FE0 8021AF90 8C4D0000 */  lw         $t5, 0x0($v0)
/* 1C8FE4 8021AF94 3C01800E */  lui        $at, %hi(D_800E3050)
/* 1C8FE8 8021AF98 240A0002 */  addiu      $t2, $zero, 0x2
...
/* 1C8FF8 8021AFA8 8C4E0000 */  lw         $t6, 0x0($v0)
/* 1C8FFC 8021AFAC 3C018022 */  lui        $at, %hi(D_8021DEE4_ovl9)
...
/* 1C9040 8021AFF0 8C4B0000 */  lw         $t3, 0x0($v0)
...
/* 1C9054 8021B004 8C4C0000 */  lw         $t4, 0x0($v0)
