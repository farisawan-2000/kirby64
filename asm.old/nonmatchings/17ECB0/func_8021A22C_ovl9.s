...
/* 1C828C 8021A23C 3C10800E */  lui        $s0, %hi(gEntityVtableIndexArray)
/* 1C8290 8021A240 3C118005 */  lui        $s1, %hi(D_8004A7C4)
/* 1C8294 8021A244 3C128022 */  lui        $s2, %hi(D_8021CE04_ovl9)
/* 1C8298 8021A248 AFBF0024 */  sw         $ra, 0x24($sp)
/* 1C829C 8021A24C AFA40028 */  sw         $a0, 0x28($sp)
/* 1C82A0 8021A250 2652CE04 */  addiu      $s2, $s2, %lo(D_8021CE04_ovl9)
/* 1C82A4 8021A254 2631A7C4 */  addiu      $s1, $s1, %lo(D_8004A7C4)
/* 1C82A8 8021A258 2610DC50 */  addiu      $s0, $s0, %lo(gEntityVtableIndexArray)
/* 1C82AC 8021A25C 8E2E0000 */  lw         $t6, 0x0($s1)
.L8021A260_ovl9:
/* 1C82B0 8021A260 24050003 */  addiu      $a1, $zero, 0x3
/* 1C82B4 8021A264 02403025 */  or         $a2, $s2, $zero
/* 1C82B8 8021A268 8DCF0000 */  lw         $t7, 0x0($t6)
/* 1C82BC 8021A26C 000FC080 */  sll        $t8, $t7, 2
/* 1C82C0 8021A270 0218C821 */  addu       $t9, $s0, $t8
/* 1C82C4 8021A274 0C02911F */  jal        call_virtual_function
/* 1C82C8 8021A278 8F240000 */   lw        $a0, 0x0($t9)
/* 1C82CC 8021A27C 1000FFF8 */  b          .L8021A260_ovl9
/* 1C82D0 8021A280 8E2E0000 */   lw        $t6, 0x0($s1)
