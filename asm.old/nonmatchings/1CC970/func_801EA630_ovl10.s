...
/* 1DB3A0 801EA630 3C028005 */  lui        $v0, %hi(D_8004A7C4)
...
/* 1DB3B4 801EA644 8C4E0000 */  lw         $t6, 0x0($v0)
.L801EA648_ovl16:
/* 1DB3B8 801EA648 3C01800F */  lui        $at, %hi(D_800E9E20)
/* 1DB3BC 801EA64C 24180001 */  addiu      $t8, $zero, 0x1
...
/* 1DB3CC 801EA65C 8C590000 */  lw         $t9, 0x0($v0)
/* 1DB3D0 801EA660 3C01800F */  lui        $at, %hi(D_800E9C60)
/* 1DB3D4 801EA664 24090005 */  addiu      $t1, $zero, 0x5
...
/* 1DB3E4 801EA674 8C4A0000 */  lw         $t2, 0x0($v0)
.L801EA678_ovl16:
/* 1DB3E8 801EA678 3C01800E */  lui        $at, %hi(D_800DDFD0)
/* 1DB3EC 801EA67C 24040010 */  addiu      $a0, $zero, 0x10
...
/* 1DB400 801EA690 3C028005 */  lui        $v0, %hi(D_8004A7C4)
/* 1DB404 801EA694 8C42A7C4 */  lw         $v0, %lo(D_8004A7C4)($v0)
/* 1DB408 801EA698 44802000 */  mtc1       $zero, $f4
/* 1DB40C 801EA69C 3C04800E */  lui        $a0, %hi(D_800E3750)
/* 1DB410 801EA6A0 8C4C0000 */  lw         $t4, 0x0($v0)
/* 1DB414 801EA6A4 24843750 */  addiu      $a0, $a0, %lo(D_800E3750)
/* 1DB418 801EA6A8 3C01800E */  lui        $at, %hi(D_800E3210)
/* 1DB41C 801EA6AC 000C6880 */  sll        $t5, $t4, 2
/* 1DB420 801EA6B0 008D7021 */  addu       $t6, $a0, $t5
/* 1DB424 801EA6B4 E5C40000 */  swc1       $f4, 0x0($t6)
.L801EA6B8_ovl16:
/* 1DB428 801EA6B8 8C430000 */  lw         $v1, 0x0($v0)
/* 1DB42C 801EA6BC 24080001 */  addiu      $t0, $zero, 0x1
/* 1DB430 801EA6C0 00031880 */  sll        $v1, $v1, 2
/* 1DB434 801EA6C4 00837821 */  addu       $t7, $a0, $v1
/* 1DB438 801EA6C8 C5E60000 */  lwc1       $f6, 0x0($t7)
/* 1DB43C 801EA6CC 00230821 */  addu       $at, $at, $v1
/* 1DB440 801EA6D0 E4263210 */  swc1       $f6, %lo(D_800E3210)($at)
/* 1DB444 801EA6D4 8C590000 */  lw         $t9, 0x0($v0)
/* 1DB448 801EA6D8 3C01801F */  lui        $at, %hi(func_801F4B30_ovl10 + 0x3C)
/* 1DB44C 801EA6DC C4284B6C */  lwc1       $f8, %lo(func_801F4B30_ovl10 + 0x3C)($at)
...
/* 1DB460 801EA6F0 8C4A0000 */  lw         $t2, 0x0($v0)
