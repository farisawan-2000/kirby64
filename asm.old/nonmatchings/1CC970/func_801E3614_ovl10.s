...
/* 1D4384 801E3614 3C0E8005 */  lui        $t6, %hi(D_8004A7C4)
...
/* 1D4398 801E3628 8DC20000 */  lw         $v0, 0x0($t6)
/* 1D439C 801E362C 3C03800E */  lui        $v1, %hi(gEntitiesNextPosXArray)
/* 1D43A0 801E3630 246325D0 */  addiu      $v1, $v1, %lo(gEntitiesNextPosXArray)
/* 1D43A4 801E3634 3C04800E */  lui        $a0, %hi(gEntitiesNextPosYArray)
.L801E3638_ovl17:
/* 1D43A8 801E3638 00021080 */  sll        $v0, $v0, 2
/* 1D43AC 801E363C 24842790 */  addiu      $a0, $a0, %lo(gEntitiesNextPosYArray)
/* 1D43B0 801E3640 00627821 */  addu       $t7, $v1, $v0
/* 1D43B4 801E3644 3C0141A0 */  lui        $at, (0x41A00000 >> 16)
/* 1D43B8 801E3648 C5E60000 */  lwc1       $f6, 0x0($t7)
/* 1D43BC 801E364C C4640000 */  lwc1       $f4, 0x0($v1)
/* 1D43C0 801E3650 44818000 */  mtc1       $at, $f16
/* 1D43C4 801E3654 C48A0000 */  lwc1       $f10, 0x0($a0)
/* 1D43C8 801E3658 46062201 */  sub.s      $f8, $f4, $f6
/* 1D43CC 801E365C 0082C021 */  addu       $t8, $a0, $v0
.L801E3660_ovl16:
/* 1D43D0 801E3660 C7040000 */  lwc1       $f4, 0x0($t8)
.L801E3664_ovl17:
/* 1D43D4 801E3664 46105480 */  add.s      $f18, $f10, $f16
/* 1D43D8 801E3668 44805000 */  mtc1       $zero, $f10
/* 1D43DC 801E366C 3C05800E */  lui        $a1, %hi(gEntitiesNextPosZArray)
/* 1D43E0 801E3670 24A52950 */  addiu      $a1, $a1, %lo(gEntitiesNextPosZArray)
...
/* 1D43F0 801E3680 C7280000 */  lwc1       $f8, 0x0($t9)
.L801E3684_ovl16:
/* 1D43F4 801E3684 460A003C */  c.lt.s     $f0, $f10
/* 1D43F8 801E3688 C4A60000 */  lwc1       $f6, 0x0($a1)
...
/* 1D4440 801E36D0 3C01801F */  lui        $at, %hi(func_801F4A68_ovl10 + 0x8)
.L801E36D4_ovl16:
/* 1D4444 801E36D4 C42C4A70 */  lwc1       $f12, %lo(func_801F4A68_ovl10 + 0x8)($at)
glabel func_801E36D8_ovl16
/* 1D4448 801E36D8 46000086 */  mov.s      $f2, $f0
.L801E36DC_ovl16:
/* 1D444C 801E36DC 3C01801F */  lui        $at, %hi(func_801F4A68_ovl10 + 0xC)
...
/* 1D4460 801E36F0 C4204A74 */  lwc1       $f0, %lo(func_801F4A68_ovl10 + 0xC)($at)
...
.L801E3708_ovl10:
/* 1D4478 801E3708 3C01801F */  lui        $at, %hi(func_801F4A68_ovl10 + 0x10)
/* 1D447C 801E370C C4204A78 */  lwc1       $f0, %lo(func_801F4A68_ovl10 + 0x10)($at)
/* 1D4480 801E3710 3C01801F */  lui        $at, %hi(func_801F4A68_ovl10 + 0x14)
/* 1D4484 801E3714 C42C4A7C */  lwc1       $f12, %lo(func_801F4A68_ovl10 + 0x14)($at)
