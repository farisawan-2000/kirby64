...
/* 1DC9D8 801EBC68 3C108005 */  lui        $s0, %hi(D_8004A7C4)
/* 1DC9DC 801EBC6C 2610A7C4 */  addiu      $s0, $s0, %lo(D_8004A7C4)
/* 1DC9E0 801EBC70 8E0E0000 */  lw         $t6, 0x0($s0)
.L801EBC74_ovl16:
/* 1DC9E4 801EBC74 AFBF001C */  sw         $ra, 0x1C($sp)
/* 1DC9E8 801EBC78 AFB10018 */  sw         $s1, 0x18($sp)
/* 1DC9EC 801EBC7C AFA40020 */  sw         $a0, 0x20($sp)
/* 1DC9F0 801EBC80 8DC30000 */  lw         $v1, 0x0($t6)
/* 1DC9F4 801EBC84 3C07800E */  lui        $a3, %hi(D_800E1B50)
/* 1DC9F8 801EBC88 3C0F801F */  lui        $t7, %hi(func_801EBDE8_ovl10)
...
/* 1DCA10 801EBCA0 25EFBDE8 */  addiu      $t7, $t7, %lo(func_801EBDE8_ovl10)
/* 1DCA14 801EBCA4 3C18801F */  lui        $t8, %hi(D_801F41D8_ovl10)
/* 1DCA18 801EBCA8 AC2FF150 */  sw         $t7, %lo(D_800DF150)($at)
/* 1DCA1C 801EBCAC 271841D8 */  addiu      $t8, $t8, %lo(D_801F41D8_ovl10)
.L801EBCB0_ovl16:
/* 1DCA20 801EBCB0 ACF80098 */  sw         $t8, 0x98($a3)
/* 1DCA24 801EBCB4 8E020000 */  lw         $v0, 0x0($s0)
/* 1DCA28 801EBCB8 3C11800F */  lui        $s1, %hi(D_800E9E20)
/* 1DCA2C 801EBCBC 26319E20 */  addiu      $s1, $s1, %lo(D_800E9E20)
/* 1DCA30 801EBCC0 8C590000 */  lw         $t9, 0x0($v0)
/* 1DCA34 801EBCC4 3C01800F */  lui        $at, %hi(D_800E9720)
/* 1DCA38 801EBCC8 240A003C */  addiu      $t2, $zero, 0x3C
/* 1DCA3C 801EBCCC 00194080 */  sll        $t0, $t9, 2
/* 1DCA40 801EBCD0 02284821 */  addu       $t1, $s1, $t0
.L801EBCD4_ovl16:
/* 1DCA44 801EBCD4 AD200000 */  sw         $zero, 0x0($t1)
/* 1DCA48 801EBCD8 8C4B0000 */  lw         $t3, 0x0($v0)
/* 1DCA4C 801EBCDC 3C040001 */  lui        $a0, (0x10098 >> 16)
.L801EBCE0_ovl9:
/* 1DCA50 801EBCE0 34840098 */  ori        $a0, $a0, (0x10098 & 0xFFFF)
...
/* 1DCA60 801EBCF0 8C4D0000 */  lw         $t5, 0x0($v0)
/* 1DCA64 801EBCF4 3C01800F */  lui        $at, %hi(D_800E8920)
/* 1DCA68 801EBCF8 24050023 */  addiu      $a1, $zero, 0x23
...
/* 1DCA7C 801EBD0C 24060010 */   addiu     $a2, $zero, 0x10
/* 1DCA80 801EBD10 3C040001 */  lui        $a0, (0x10546 >> 16)
/* 1DCA84 801EBD14 0C02A7A9 */  jal        func_800A9EA4
/* 1DCA88 801EBD18 34840546 */   ori       $a0, $a0, (0x10546 & 0xFFFF)
/* 1DCA8C 801EBD1C 3C040001 */  lui        $a0, (0x10545 >> 16)
/* 1DCA90 801EBD20 0C02A7A9 */  jal        func_800A9EA4
/* 1DCA94 801EBD24 34840545 */   ori       $a0, $a0, (0x10545 & 0xFFFF)
/* 1DCA98 801EBD28 8E020000 */  lw         $v0, 0x0($s0)
/* 1DCA9C 801EBD2C 3C01C0C0 */  lui        $at, (0xC0C00000 >> 16)
/* 1DCAA0 801EBD30 44812000 */  mtc1       $at, $f4
/* 1DCAA4 801EBD34 8C4F0000 */  lw         $t7, 0x0($v0)
...
/* 1DCAB8 801EBD48 8C430000 */  lw         $v1, 0x0($v0)
/* 1DCABC 801EBD4C 00031880 */  sll        $v1, $v1, 2
/* 1DCAC0 801EBD50 0223C821 */  addu       $t9, $s1, $v1
/* 1DCAC4 801EBD54 8F280000 */  lw         $t0, 0x0($t9)
/* 1DCAC8 801EBD58 5500000B */  bnel       $t0, $zero, .L801EBD88_ovl10
/* 1DCACC 801EBD5C 3C01C000 */   lui       $at, (0xC0000000 >> 16)
.L801EBD60_ovl10:
/* 1DCAD0 801EBD60 0C002DAF */  jal        finish_current_thread
/* 1DCAD4 801EBD64 24040001 */   addiu     $a0, $zero, 0x1
/* 1DCAD8 801EBD68 8E020000 */  lw         $v0, 0x0($s0)
.L801EBD6C_ovl9:
/* 1DCADC 801EBD6C 8C430000 */  lw         $v1, 0x0($v0)
/* 1DCAE0 801EBD70 00031880 */  sll        $v1, $v1, 2
.L801EBD74_ovl16:
/* 1DCAE4 801EBD74 02234821 */  addu       $t1, $s1, $v1
/* 1DCAE8 801EBD78 8D2B0000 */  lw         $t3, 0x0($t1)
.L801EBD7C_ovl16:
/* 1DCAEC 801EBD7C 1160FFF8 */  beqz       $t3, .L801EBD60_ovl10
/* 1DCAF0 801EBD80 00000000 */   nop
/* 1DCAF4 801EBD84 3C01C000 */  lui        $at, (0xC0000000 >> 16)
.L801EBD88_ovl10:
...
/* 1DCB08 801EBD98 8C4A0000 */  lw         $t2, 0x0($v0)
/* 1DCB0C 801EBD9C 3C01801F */  lui        $at, %hi(D_801F4B80_ovl10)
...
/* 1DCB24 801EBDB4 8C4D0000 */  lw         $t5, 0x0($v0)
glabel func_801EBDB8_ovl9
/* 1DCB28 801EBDB8 3C014000 */  lui        $at, (0x40000000 >> 16)
