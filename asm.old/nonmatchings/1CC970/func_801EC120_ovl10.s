...
/* 1DCE98 801EC128 0C06835D */  jal        func_801A0D74_ovl7
/* 1DCE9C 801EC12C 00000000 */   nop
/* 1DCEA0 801EC130 3C0E8005 */  lui        $t6, %hi(D_8004A7C4)
/* 1DCEA4 801EC134 8DCEA7C4 */  lw         $t6, %lo(D_8004A7C4)($t6)
/* 1DCEA8 801EC138 3C0F800F */  lui        $t7, %hi(D_800E9E20)
/* 1DCEAC 801EC13C 8DC20000 */  lw         $v0, 0x0($t6)
...
/* 1DCEC8 801EC158 240401CC */   addiu     $a0, $zero, 0x1CC
/* 1DCECC 801EC15C 3C038005 */  lui        $v1, %hi(D_8004A7C4)
/* 1DCED0 801EC160 8C63A7C4 */  lw         $v1, %lo(D_8004A7C4)($v1)
/* 1DCED4 801EC164 3C01800E */  lui        $at, %hi(D_800E6A10)
.L801EC168_ovl16:
/* 1DCED8 801EC168 8C620000 */  lw         $v0, 0x0($v1)
...
/* 1DCEE8 801EC178 3C0140D0 */  lui        $at, (0x40D00000 >> 16)
...
/* 1DCF00 801EC190 8C780000 */  lw         $t8, 0x0($v1)
...
/* 1DCF14 801EC1A4 8C620000 */  lw         $v0, 0x0($v1)
...
/* 1DCF2C 801EC1BC 3C0140D0 */  lui        $at, (0x40D00000 >> 16)
/* 1DCF30 801EC1C0 3C08800F */  lui        $t0, %hi(D_800E9720)
/* 1DCF34 801EC1C4 460A003C */  c.lt.s     $f0, $f10
/* 1DCF38 801EC1C8 44818000 */  mtc1       $at, $f16
/* 1DCF3C 801EC1CC 25089720 */  addiu      $t0, $t0, %lo(D_800E9720)
...
/* 1DCF68 801EC1F8 8C850000 */  lw         $a1, 0x0($a0)
...
/* 1DCF78 801EC208 2406000B */   addiu     $a2, $zero, 0xB
...
/* 1DCF88 801EC218 3C014180 */  lui        $at, (0x41800000 >> 16)
...
/* 1DCFA0 801EC230 24040006 */  addiu      $a0, $zero, 0x6
/* 1DCFA4 801EC234 24050002 */  addiu      $a1, $zero, 0x2
...
/* 1DCFB8 801EC248 3C038005 */  lui        $v1, %hi(D_8004A7C4)
/* 1DCFBC 801EC24C 8C63A7C4 */  lw         $v1, %lo(D_8004A7C4)($v1)
/* 1DCFC0 801EC250 3C01800F */  lui        $at, %hi(D_800E9720)
/* 1DCFC4 801EC254 24090004 */  addiu      $t1, $zero, 0x4
/* 1DCFC8 801EC258 8C6A0000 */  lw         $t2, 0x0($v1)
/* 1DCFCC 801EC25C 3C0E800F */  lui        $t6, %hi(D_800E9720)
/* 1DCFD0 801EC260 25CE9720 */  addiu      $t6, $t6, %lo(D_800E9720)
...
/* 1DCFE0 801EC270 8C6C0000 */  lw         $t4, 0x0($v1)
/* 1DCFE4 801EC274 000C6880 */  sll        $t5, $t4, 2
/* 1DCFE8 801EC278 01AE2021 */  addu       $a0, $t5, $t6
/* 1DCFEC 801EC27C 8C850000 */  lw         $a1, 0x0($a0)
.L801EC280_ovl10:
/* 1DCFF0 801EC280 24AFFFFF */  addiu      $t7, $a1, -0x1
/* 1DCFF4 801EC284 AC8F0000 */  sw         $t7, 0x0($a0)
.L801EC288_ovl10:
/* 1DCFF8 801EC288 0C0680ED */  jal        func_801A03B4_ovl7
