...
/* 1DCD4C 801EBFDC 3C088005 */  lui        $t0, %hi(D_8004A7C4)
/* 1DCD50 801EBFE0 2508A7C4 */  addiu      $t0, $t0, %lo(D_8004A7C4)
/* 1DCD54 801EBFE4 8D020000 */  lw         $v0, 0x0($t0)
...
/* 1DCD64 801EBFF4 8C430000 */  lw         $v1, 0x0($v0)
/* 1DCD68 801EBFF8 3C0E801E */  lui        $t6, %hi(func_801DB1E0_ovl17)
/* 1DCD6C 801EBFFC 3C01800E */  lui        $at, %hi(D_800DEF90)
/* 1DCD70 801EC000 00031880 */  sll        $v1, $v1, 2
/* 1DCD74 801EC004 00230821 */  addu       $at, $at, $v1
/* 1DCD78 801EC008 25CEB1E0 */  addiu      $t6, $t6, %lo(func_801DB1E0_ovl17)
/* 1DCD7C 801EC00C AC2EEF90 */  sw         $t6, %lo(D_800DEF90)($at)
/* 1DCD80 801EC010 8C580000 */  lw         $t8, 0x0($v0)
/* 1DCD84 801EC014 3C01800E */  lui        $at, %hi(D_800DF150)
/* 1DCD88 801EC018 3C0F801F */  lui        $t7, %hi(func_801EC120_ovl10)
/* 1DCD8C 801EC01C 0018C880 */  sll        $t9, $t8, 2
/* 1DCD90 801EC020 00390821 */  addu       $at, $at, $t9
/* 1DCD94 801EC024 25EFC120 */  addiu      $t7, $t7, %lo(func_801EC120_ovl10)
/* 1DCD98 801EC028 AC2FF150 */  sw         $t7, %lo(D_800DF150)($at)
/* 1DCD9C 801EC02C 8C490000 */  lw         $t1, 0x0($v0)
...
/* 1DCDB4 801EC044 8C4B0000 */  lw         $t3, 0x0($v0)
...
/* 1DCDCC 801EC05C 3C0D801F */  lui        $t5, %hi(D_801F41FC_ovl10)
/* 1DCDD0 801EC060 AC209720 */  sw         $zero, %lo(D_800E9720)($at)
/* 1DCDD4 801EC064 25AD41FC */  addiu      $t5, $t5, %lo(D_801F41FC_ovl10)
/* 1DCDD8 801EC068 ACED0098 */  sw         $t5, 0x98($a3)
.L801EC06C_ovl9:
/* 1DCDDC 801EC06C 8D0E0000 */  lw         $t6, 0x0($t0)
/* 1DCDE0 801EC070 3C01800F */  lui        $at, %hi(D_800E8920)
/* 1DCDE4 801EC074 3C040001 */  lui        $a0, (0x10099 >> 16)
.L801EC078_ovl9:
/* 1DCDE8 801EC078 8DD80000 */  lw         $t8, 0x0($t6)
/* 1DCDEC 801EC07C 34840099 */  ori        $a0, $a0, (0x10099 & 0xFFFF)
/* 1DCDF0 801EC080 24050023 */  addiu      $a1, $zero, 0x23
...
/* 1DCE04 801EC094 24060010 */   addiu     $a2, $zero, 0x10
/* 1DCE08 801EC098 3C040001 */  lui        $a0, (0x10548 >> 16)
/* 1DCE0C 801EC09C 0C02A7A9 */  jal        func_800A9EA4
/* 1DCE10 801EC0A0 34840548 */   ori       $a0, $a0, (0x10548 & 0xFFFF)
/* 1DCE14 801EC0A4 3C028005 */  lui        $v0, %hi(D_8004A7C4)
...
/* 1DCE24 801EC0B4 8C590000 */  lw         $t9, 0x0($v0)
...
/* 1DCE34 801EC0C4 8C4A0000 */  lw         $t2, 0x0($v0)
/* 1DCE38 801EC0C8 3C01BF80 */  lui        $at, (0xBF800000 >> 16)
...
/* 1DCE50 801EC0E0 8C430000 */  lw         $v1, 0x0($v0)
...
/* 1DCE64 801EC0F4 3C014040 */  lui        $at, (0x40400000 >> 16)
