...
/* 1DDC00 801ECE90 3C0E8005 */  lui        $t6, %hi(D_8004A7C4)
...
/* 1DDC10 801ECEA0 8DCF0000 */  lw         $t7, 0x0($t6)
...
/* 1DDC24 801ECEB4 0C066D09 */  jal        func_8019B424_ovl7
/* 1DDC28 801ECEB8 AFB9001C */   sw        $t9, 0x1C($sp)
/* 1DDC2C 801ECEBC 3C014170 */  lui        $at, (0x41700000 >> 16)
/* 1DDC30 801ECEC0 44816000 */  mtc1       $at, $f12
/* 1DDC34 801ECEC4 0C067534 */  jal        func_8019D4D0_ovl7
/* 1DDC38 801ECEC8 24050008 */   addiu     $a1, $zero, 0x8
/* 1DDC3C 801ECECC 8FA8001C */  lw         $t0, 0x1C($sp)
/* 1DDC40 801ECED0 3C014370 */  lui        $at, (0x43700000 >> 16)
/* 1DDC44 801ECED4 9109003C */  lbu        $t1, 0x3C($t0)
/* 1DDC48 801ECED8 55200018 */  bnel       $t1, $zero, .L801ECF3C_ovl10
/* 1DDC4C 801ECEDC 8FBF0014 */   lw        $ra, 0x14($sp)
/* 1DDC50 801ECEE0 44806000 */  mtc1       $zero, $f12
/* 1DDC54 801ECEE4 44817000 */  mtc1       $at, $f14
/* 1DDC58 801ECEE8 0C066A6B */  jal        func_8019A9AC_ovl7
/* 1DDC5C 801ECEEC 00000000 */   nop
/* 1DDC60 801ECEF0 24010002 */  addiu      $at, $zero, 0x2
/* 1DDC64 801ECEF4 14410010 */  bne        $v0, $at, .L801ECF38_ovl10
/* 1DDC68 801ECEF8 3C028005 */   lui       $v0, %hi(D_8004A7C4)
/* 1DDC6C 801ECEFC 8C42A7C4 */  lw         $v0, %lo(D_8004A7C4)($v0)
/* 1DDC70 801ECF00 3C01800E */  lui        $at, %hi(gEntityVtableIndexArray)
/* 1DDC74 801ECF04 240A0004 */  addiu      $t2, $zero, 0x4
/* 1DDC78 801ECF08 8C4B0000 */  lw         $t3, 0x0($v0)
/* 1DDC7C 801ECF0C 3C04800E */  lui        $a0, %hi(gEntityGObjProcessArray)
/* 1DDC80 801ECF10 3C05801F */  lui        $a1, %hi(func_801EC3C8_ovl10)
...
/* 1DDC90 801ECF20 8C4D0000 */  lw         $t5, 0x0($v0)
.L801ECF24_ovl9:
/* 1DDC94 801ECF24 24A5C3C8 */  addiu      $a1, $a1, %lo(func_801EC3C8_ovl10)
