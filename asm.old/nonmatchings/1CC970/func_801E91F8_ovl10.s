...
/* 1D9F68 801E91F8 3C0E8005 */  lui        $t6, %hi(D_8004A7C4)
.L801E91FC_ovl16:
...
/* 1D9F7C 801E920C 8DC30000 */  lw         $v1, 0x0($t6)
/* 1D9F80 801E9210 3C0F800E */  lui        $t7, %hi(D_800E1B50)
/* 1D9F84 801E9214 3C18801F */  lui        $t8, %hi(func_801E932C_ovl10)
...
.L801E922C_ovl9:
/* 1D9F9C 801E922C 2718932C */  addiu      $t8, $t8, %lo(func_801E932C_ovl10)
.L801E9230_ovl9:
/* 1D9FA0 801E9230 3C04801F */  lui        $a0, %hi(D_801F35A8_ovl10)
/* 1D9FA4 801E9234 AC38F150 */  sw         $t8, %lo(D_800DF150)($at)
/* 1D9FA8 801E9238 248435A8 */  addiu      $a0, $a0, %lo(D_801F35A8_ovl10)
/* 1D9FAC 801E923C 0C066220 */  jal        func_80198880_ovl7
/* 1D9FB0 801E9240 AFAF001C */   sw        $t7, 0x1C($sp)
/* 1D9FB4 801E9244 3C028005 */  lui        $v0, %hi(D_8004A7C4)
/* 1D9FB8 801E9248 8C42A7C4 */  lw         $v0, %lo(D_8004A7C4)($v0)
/* 1D9FBC 801E924C 3C19800E */  lui        $t9, %hi(D_800E0D50)
/* 1D9FC0 801E9250 3C01800F */  lui        $at, %hi(D_800EA520)
/* 1D9FC4 801E9254 8C430000 */  lw         $v1, 0x0($v0)
/* 1D9FC8 801E9258 3C040001 */  lui        $a0, (0x10062 >> 16)
/* 1D9FCC 801E925C 34840062 */  ori        $a0, $a0, (0x10062 & 0xFFFF)
/* 1D9FD0 801E9260 00031880 */  sll        $v1, $v1, 2
/* 1D9FD4 801E9264 0323C821 */  addu       $t9, $t9, $v1
/* 1D9FD8 801E9268 8F390D50 */  lw         $t9, %lo(D_800E0D50)($t9)
/* 1D9FDC 801E926C 00230821 */  addu       $at, $at, $v1
/* 1D9FE0 801E9270 AC39A520 */  sw         $t9, %lo(D_800EA520)($at)
/* 1D9FE4 801E9274 8C480000 */  lw         $t0, 0x0($v0)
.L801E9278_ovl16:
...
/* 1D9FF8 801E9288 8C4A0000 */  lw         $t2, 0x0($v0)
...
/* 1DA00C 801E929C 8C430000 */  lw         $v1, 0x0($v0)
...
/* 1DA02C 801E92BC 8C4C0000 */  lw         $t4, 0x0($v0)
...
/* 1DA048 801E92D8 3C0E801F */  lui        $t6, %hi(func_801F40C8_ovl9 + 0x5C)
glabel func_801E92DC_ovl9
/* 1DA04C 801E92DC 25CE4124 */  addiu      $t6, $t6, %lo(func_801F40C8_ovl9 + 0x5C)
/* 1DA050 801E92E0 3C04801F */  lui        $a0, %hi(func_801E91B0_ovl10)
/* 1DA054 801E92E4 248491B0 */  addiu      $a0, $a0, %lo(func_801E91B0_ovl10)
/* 1DA058 801E92E8 0C068354 */  jal        func_801A0D50_ovl7
/* 1DA05C 801E92EC ADEE0098 */   sw        $t6, 0x98($t7)
/* 1DA060 801E92F0 3C188005 */  lui        $t8, %hi(D_8004A7C4)
/* 1DA064 801E92F4 8F18A7C4 */  lw         $t8, %lo(D_8004A7C4)($t8)
/* 1DA068 801E92F8 3C04800E */  lui        $a0, %hi(gEntityVtableIndexArray)
/* 1DA06C 801E92FC 3C06801F */  lui        $a2, %hi(func_801F4588_ovl10)
/* 1DA070 801E9300 8F190000 */  lw         $t9, 0x0($t8)
/* 1DA074 801E9304 24C64588 */  addiu      $a2, $a2, %lo(func_801F4588_ovl10)
/* 1DA078 801E9308 24050006 */  addiu      $a1, $zero, 0x6
