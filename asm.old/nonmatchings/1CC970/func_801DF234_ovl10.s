...
/* 1CFFA4 801DF234 3C0E8005 */  lui        $t6, %hi(D_8004A7C4)
...
/* 1CFFB4 801DF244 8DC20000 */  lw         $v0, 0x0($t6)
.L801DF248_ovl16:
/* 1CFFB8 801DF248 3C03800E */  lui        $v1, %hi(gEntitiesNextPosXArray)
.L801DF24C_ovl16:
/* 1CFFBC 801DF24C 246325D0 */  addiu      $v1, $v1, %lo(gEntitiesNextPosXArray)
/* 1CFFC0 801DF250 00021080 */  sll        $v0, $v0, 2
.L801DF254_ovl16:
/* 1CFFC4 801DF254 00627821 */  addu       $t7, $v1, $v0
/* 1CFFC8 801DF258 C5E60000 */  lwc1       $f6, 0x0($t7)
/* 1CFFCC 801DF25C C4640000 */  lwc1       $f4, 0x0($v1)
glabel func_801DF260_ovl15
/* 1CFFD0 801DF260 3C04800E */  lui        $a0, %hi(gEntitiesNextPosYArray)
/* 1CFFD4 801DF264 3C0141A0 */  lui        $at, (0x41A00000 >> 16)
/* 1CFFD8 801DF268 44815000 */  mtc1       $at, $f10
/* 1CFFDC 801DF26C 24842790 */  addiu      $a0, $a0, %lo(gEntitiesNextPosYArray)
/* 1CFFE0 801DF270 46062001 */  sub.s      $f0, $f4, $f6
/* 1CFFE4 801DF274 0082C021 */  addu       $t8, $a0, $v0
.L801DF278_ovl12:
/* 1CFFE8 801DF278 3C014220 */  lui        $at, (0x42200000 >> 16)
.L801DF27C_ovl14:
/* 1CFFEC 801DF27C 44812000 */  mtc1       $at, $f4
/* 1CFFF0 801DF280 C7120000 */  lwc1       $f18, 0x0($t8)
/* 1CFFF4 801DF284 C4880000 */  lwc1       $f8, 0x0($a0)
/* 1CFFF8 801DF288 3C05800E */  lui        $a1, %hi(gEntitiesNextPosZArray)
/* 1CFFFC 801DF28C 46049180 */  add.s      $f6, $f18, $f4
glabel func_801DF290_ovl14
/* 1D0000 801DF290 24A52950 */  addiu      $a1, $a1, %lo(gEntitiesNextPosZArray)
...
/* 1D0010 801DF2A0 C72A0000 */  lwc1       $f10, 0x0($t9)
/* 1D0014 801DF2A4 C4A80000 */  lwc1       $f8, 0x0($a1)
...
.L801DF2D8_ovl12:
/* 1D0048 801DF2D8 45000005 */  bc1f       .L801DF2F0_ovl17
