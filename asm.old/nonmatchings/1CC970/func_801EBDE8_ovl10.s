...
/* 1DCB60 801EBDF0 0C06835D */  jal        func_801A0D74_ovl7
/* 1DCB64 801EBDF4 00000000 */   nop
/* 1DCB68 801EBDF8 3C028005 */  lui        $v0, %hi(D_8004A7C4)
/* 1DCB6C 801EBDFC 8C42A7C4 */  lw         $v0, %lo(D_8004A7C4)($v0)
/* 1DCB70 801EBE00 3C0E800F */  lui        $t6, %hi(D_800E9E20)
/* 1DCB74 801EBE04 25CE9E20 */  addiu      $t6, $t6, %lo(D_800E9E20)
.L801EBE08_ovl9:
/* 1DCB78 801EBE08 8C430000 */  lw         $v1, 0x0($v0)
/* 1DCB7C 801EBE0C 3C18800F */  lui        $t8, %hi(D_800E9720)
/* 1DCB80 801EBE10 27189720 */  addiu      $t8, $t8, %lo(D_800E9720)
/* 1DCB84 801EBE14 00031880 */  sll        $v1, $v1, 2
/* 1DCB88 801EBE18 006E2021 */  addu       $a0, $v1, $t6
glabel func_801EBE1C_ovl9
/* 1DCB8C 801EBE1C 8C8F0000 */  lw         $t7, 0x0($a0)
/* 1DCB90 801EBE20 3C01BF00 */  lui        $at, (0xBF000000 >> 16)
...
/* 1DCBA0 801EBE30 8C850000 */  lw         $a1, 0x0($a0)
/* 1DCBA4 801EBE34 14A00009 */  bnez       $a1, .L801EBE5C_ovl10
/* 1DCBA8 801EBE38 24B9FFFF */   addiu     $t9, $a1, -0x1
/* 1DCBAC 801EBE3C 3C04800E */  lui        $a0, %hi(gEntityGObjProcessArray)
/* 1DCBB0 801EBE40 00832021 */  addu       $a0, $a0, $v1
/* 1DCBB4 801EBE44 3C05801B */  lui        $a1, %hi(func_801ACF84_ovl7)
/* 1DCBB8 801EBE48 24A5CF84 */  addiu      $a1, $a1, %lo(func_801ACF84_ovl7)
...
.L801EBE5C_ovl10:
/* 1DCBCC 801EBE5C AC990000 */  sw         $t9, 0x0($a0)
/* 1DCBD0 801EBE60 8C430000 */  lw         $v1, 0x0($v0)
...
/* 1DCBE8 801EBE78 3C08800E */  lui        $t0, %hi(D_800E3750)
/* 1DCBEC 801EBE7C 3C01800E */  lui        $at, %hi(D_800E3C90)
/* 1DCBF0 801EBE80 4604003C */  c.lt.s     $f0, $f4
/* 1DCBF4 801EBE84 25083750 */  addiu      $t0, $t0, %lo(D_800E3750)
...
.L801EBEA4_ovl10:
/* 1DCC14 801EBEA4 C4263C90 */  lwc1       $f6, %lo(D_800E3C90)($at)
...
/* 1DCC28 801EBEB8 C4480000 */  lwc1       $f8, 0x0($v0)
/* 1DCC2C 801EBEBC 46004287 */  neg.s      $f10, $f8
/* 1DCC30 801EBEC0 10000014 */  b          .L801EBF14_ovl10
/* 1DCC34 801EBEC4 E44A0000 */   swc1      $f10, 0x0($v0)
...
/* 1DCC64 801EBEF4 3C01C080 */  lui        $at, (0xC0800000 >> 16)
/* 1DCC68 801EBEF8 44813000 */  mtc1       $at, $f6
/* 1DCC6C 801EBEFC 24090001 */  addiu      $t1, $zero, 0x1
...
/* 1DCC80 801EBF10 AC890000 */  sw         $t1, 0x0($a0)
.L801EBF14_ovl10:
/* 1DCC84 801EBF14 0C0680ED */  jal        func_801A03B4_ovl7
