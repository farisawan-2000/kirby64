...
/* 1CE854 801DDAE4 24040006 */   addiu     $a0, $zero, 0x6
glabel func_801DDAE8_ovl12
/* 1CE858 801DDAE8 3C118005 */  lui        $s1, %hi(D_8004A7C4)
/* 1CE85C 801DDAEC 2631A7C4 */  addiu      $s1, $s1, %lo(D_8004A7C4)
.L801DDAF0_ovl15:
/* 1CE860 801DDAF0 8E230000 */  lw         $v1, 0x0($s1)
/* 1CE864 801DDAF4 3C10800F */  lui        $s0, %hi(D_800E9AA0)
/* 1CE868 801DDAF8 3C12801F */  lui        $s2, %hi(func_801F427C_ovl9 + 0x74)
/* 1CE86C 801DDAFC 8C6E0000 */  lw         $t6, 0x0($v1)
/* 1CE870 801DDB00 265242F0 */  addiu      $s2, $s2, %lo(func_801F427C_ovl9 + 0x74)
/* 1CE874 801DDB04 26109AA0 */  addiu      $s0, $s0, %lo(D_800E9AA0)
...
/* 1CE888 801DDB18 8F250000 */  lw         $a1, 0x0($t9)
/* 1CE88C 801DDB1C 8C880000 */  lw         $t0, 0x0($a0)
/* 1CE890 801DDB20 5505000E */  bnel       $t0, $a1, .L801DDB5C_ovl10
/* 1CE894 801DDB24 AC850000 */   sw        $a1, 0x0($a0)
.L801DDB28_ovl10:
/* 1CE898 801DDB28 0C006291 */  jal        random_soft_s32_range
/* 1CE89C 801DDB2C 24040006 */   addiu     $a0, $zero, 0x6
.L801DDB30_ovl12:
/* 1CE8A0 801DDB30 8E230000 */  lw         $v1, 0x0($s1)
/* 1CE8A4 801DDB34 00025880 */  sll        $t3, $v0, 2
/* 1CE8A8 801DDB38 024B6021 */  addu       $t4, $s2, $t3
/* 1CE8AC 801DDB3C 8C690000 */  lw         $t1, 0x0($v1)
/* 1CE8B0 801DDB40 8D850000 */  lw         $a1, 0x0($t4)
/* 1CE8B4 801DDB44 00095080 */  sll        $t2, $t1, 2
/* 1CE8B8 801DDB48 020A2021 */  addu       $a0, $s0, $t2
/* 1CE8BC 801DDB4C 8C8D0000 */  lw         $t5, 0x0($a0)
.L801DDB50_ovl9:
/* 1CE8C0 801DDB50 11A5FFF5 */  beq        $t5, $a1, .L801DDB28_ovl10
.L801DDB54_ovl13:
/* 1CE8C4 801DDB54 00000000 */   nop
/* 1CE8C8 801DDB58 AC850000 */  sw         $a1, 0x0($a0)
.L801DDB5C_ovl10:
/* 1CE8CC 801DDB5C 8C6E0000 */  lw         $t6, 0x0($v1)
