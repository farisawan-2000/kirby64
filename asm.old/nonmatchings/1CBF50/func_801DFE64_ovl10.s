...
/* 1D0BD4 801DFE64 3C038005 */  lui        $v1, %hi(D_8004A7C4)
.L801DFE68_ovl9:
/* 1D0BD8 801DFE68 8C63A7C4 */  lw         $v1, %lo(D_8004A7C4)($v1)
.L801DFE6C_ovl11:
/* 1D0BDC 801DFE6C 3C04800E */  lui        $a0, %hi(D_800E0D50)
/* 1D0BE0 801DFE70 24840D50 */  addiu      $a0, $a0, %lo(D_800E0D50)
glabel func_801DFE74_ovl9
/* 1D0BE4 801DFE74 8C6E0000 */  lw         $t6, 0x0($v1)
.L801DFE78_ovl12:
/* 1D0BE8 801DFE78 3C02800F */  lui        $v0, %hi(D_800EBDA0)
.L801DFE7C_ovl12:
/* 1D0BEC 801DFE7C 3C05801F */  lui        $a1, %hi(.L801F4D48_ovl10)
/* 1D0BF0 801DFE80 000E7880 */  sll        $t7, $t6, 2
/* 1D0BF4 801DFE84 008FC021 */  addu       $t8, $a0, $t7
/* 1D0BF8 801DFE88 8F190000 */  lw         $t9, 0x0($t8)
glabel func_801DFE8C_ovl12
/* 1D0BFC 801DFE8C 24A54D48 */  addiu      $a1, $a1, %lo(.L801F4D48_ovl10)
/* 1D0C00 801DFE90 3C06800E */  lui        $a2, %hi(gEntitiesNextPosYArray)
...
.L801DFEA0_ovl15:
/* 1D0C10 801DFEA0 24C62790 */  addiu      $a2, $a2, %lo(gEntitiesNextPosYArray)
glabel func_801DFEA4_ovl14
/* 1D0C14 801DFEA4 3C0141A0 */  lui        $at, (0x41A00000 >> 16)
glabel func_801DFEA8_ovl11
/* 1D0C18 801DFEA8 ACA2000C */  sw         $v0, 0xC($a1)
.L801DFEAC_ovl16:
/* 1D0C1C 801DFEAC ACA20000 */  sw         $v0, 0x0($a1)
/* 1D0C20 801DFEB0 8C690000 */  lw         $t1, 0x0($v1)
/* 1D0C24 801DFEB4 44813000 */  mtc1       $at, $f6
/* 1D0C28 801DFEB8 3C07801F */  lui        $a3, %hi(D_801F4D30_ovl10)
/* 1D0C2C 801DFEBC 00095080 */  sll        $t2, $t1, 2
/* 1D0C30 801DFEC0 008A5821 */  addu       $t3, $a0, $t2
/* 1D0C34 801DFEC4 8D620000 */  lw         $v0, 0x0($t3)
glabel func_801DFEC8_ovl16
/* 1D0C38 801DFEC8 24E74D30 */  addiu      $a3, $a3, %lo(D_801F4D30_ovl10)
/* 1D0C3C 801DFECC 3C014220 */  lui        $at, (0x42200000 >> 16)
.L801DFED0_ovl12:
/* 1D0C40 801DFED0 ACA20010 */  sw         $v0, 0x10($a1)
/* 1D0C44 801DFED4 ACA20004 */  sw         $v0, 0x4($a1)
glabel func_801DFED8_ovl12
/* 1D0C48 801DFED8 8C6C0000 */  lw         $t4, 0x0($v1)
...
/* 1D0C5C 801DFEEC 8DCF0000 */  lw         $t7, 0x0($t6)
/* 1D0C60 801DFEF0 3C014270 */  lui        $at, (0x42700000 >> 16)
