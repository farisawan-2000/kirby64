...
/* 1D61D8 801E5468 3C028005 */  lui        $v0, %hi(D_8004A7C4)
...
/* 1D61EC 801E547C 8C430000 */  lw         $v1, 0x0($v0)
/* 1D61F0 801E5480 3C0E800E */  lui        $t6, %hi(D_800E6310)
/* 1D61F4 801E5484 3C06800E */  lui        $a2, %hi(D_800E6690)
...
/* 1D6204 801E5494 51C00022 */  beql       $t6, $zero, .L801E5520_ovl17
/* 1D6208 801E5498 8FBF0014 */   lw        $ra, 0x14($sp)
/* 1D620C 801E549C 44802000 */  mtc1       $zero, $f4
/* 1D6210 801E54A0 24C66690 */  addiu      $a2, $a2, %lo(D_800E6690)
glabel func_801E54A4_ovl16
/* 1D6214 801E54A4 00C37821 */  addu       $t7, $a2, $v1
/* 1D6218 801E54A8 E5E40000 */  swc1       $f4, 0x0($t7)
/* 1D621C 801E54AC 8C430000 */  lw         $v1, 0x0($v0)
/* 1D6220 801E54B0 3C01800E */  lui        $at, %hi(D_800E64D0)
.L801E54B4_ovl15:
/* 1D6224 801E54B4 24090006 */  addiu      $t1, $zero, 0x6
/* 1D6228 801E54B8 00031880 */  sll        $v1, $v1, 2
/* 1D622C 801E54BC 00C3C021 */  addu       $t8, $a2, $v1
/* 1D6230 801E54C0 C7060000 */  lwc1       $f6, 0x0($t8)
...
/* 1D6240 801E54D0 8C590000 */  lw         $t9, 0x0($v0)
.L801E54D4_ovl17:
/* 1D6244 801E54D4 3C01801F */  lui        $at, %hi(D_801F4B2C_ovl10)
...
/* 1D625C 801E54EC 8C4A0000 */  lw         $t2, 0x0($v0)
.L801E54F0_ovl16:
/* 1D6260 801E54F0 3C01800E */  lui        $at, %hi(gEntityVtableIndexArray)
/* 1D6264 801E54F4 3C05801E */  lui        $a1, %hi(func_801E3BE4_ovl10)
...
/* 1D6274 801E5504 8C4C0000 */  lw         $t4, 0x0($v0)
.L801E5508_ovl15:
/* 1D6278 801E5508 24A53BE4 */  addiu      $a1, $a1, %lo(func_801E3BE4_ovl10)
