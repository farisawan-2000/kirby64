...
/* 1DD020 801EC2B0 24040002 */   addiu     $a0, $zero, 0x2
/* 1DD024 801EC2B4 1040000F */  beqz       $v0, .L801EC2F4_ovl10
/* 1DD028 801EC2B8 3C0E800D */   lui       $t6, %hi(D_800D6B6C + 0x4)
/* 1DD02C 801EC2BC 8DCE6B70 */  lw         $t6, %lo(D_800D6B6C + 0x4)($t6)
/* 1DD030 801EC2C0 15C0000C */  bnez       $t6, .L801EC2F4_ovl10
/* 1DD034 801EC2C4 00000000 */   nop
/* 1DD038 801EC2C8 0C066ED6 */  jal        func_8019BB58_ovl7
/* 1DD03C 801EC2CC 00000000 */   nop
/* 1DD040 801EC2D0 3C02800D */  lui        $v0, %hi(D_800D6E40)
/* 1DD044 801EC2D4 24426E40 */  addiu      $v0, $v0, %lo(D_800D6E40)
/* 1DD048 801EC2D8 8C4F0000 */  lw         $t7, 0x0($v0)
/* 1DD04C 801EC2DC 3C198005 */  lui        $t9, %hi(D_8004A7C4)
/* 1DD050 801EC2E0 25F80001 */  addiu      $t8, $t7, 0x1
/* 1DD054 801EC2E4 AC580000 */  sw         $t8, 0x0($v0)
/* 1DD058 801EC2E8 8F39A7C4 */  lw         $t9, %lo(D_8004A7C4)($t9)
/* 1DD05C 801EC2EC 0C067656 */  jal        func_8019D958_ovl7
/* 1DD060 801EC2F0 97240002 */   lhu       $a0, 0x2($t9)
.L801EC2F4_ovl10:
/* 1DD064 801EC2F4 3C028005 */  lui        $v0, %hi(D_8004A7C4)
...
/* 1DD074 801EC304 8C480000 */  lw         $t0, 0x0($v0)
/* 1DD078 801EC308 3C06801F */  lui        $a2, %hi(func_801F4588_ovl10 + 0x58)
.L801EC30C_ovl16:
/* 1DD07C 801EC30C 24C645E0 */  addiu      $a2, $a2, %lo(func_801F4588_ovl10 + 0x58)
.L801EC310_ovl16:
...
/* 1DD08C 801EC31C 8C4A0000 */  lw         $t2, 0x0($v0)
glabel func_801EC320_ovl16
/* 1DD090 801EC320 3C01800F */  lui        $at, %hi(D_800E9AA0)
/* 1DD094 801EC324 24050001 */  addiu      $a1, $zero, 0x1
...
/* 1DD0A4 801EC334 8C4C0000 */  lw         $t4, 0x0($v0)
...
/* 1DD0B8 801EC348 8C4E0000 */  lw         $t6, 0x0($v0)
...
/* 1DD0CC 801EC35C 8C580000 */  lw         $t8, 0x0($v0)
