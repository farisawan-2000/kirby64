...
/* 1CF818 801DEAA8 0C06835D */  jal        func_801A0D74_ovl7
/* 1CF81C 801DEAAC 8FA40040 */   lw        $a0, 0x40($sp)
/* 1CF820 801DEAB0 3C0F8005 */  lui        $t7, %hi(D_8004A7C4)
/* 1CF824 801DEAB4 8DEFA7C4 */  lw         $t7, %lo(D_8004A7C4)($t7)
/* 1CF828 801DEAB8 3C08800E */  lui        $t0, %hi(D_800E1B50)
/* 1CF82C 801DEABC 3C0E801F */  lui        $t6, %hi(func_801F39E4_ovl9 + 0x34)
/* 1CF830 801DEAC0 8DF80000 */  lw         $t8, 0x0($t7)
/* 1CF834 801DEAC4 25CE3A18 */  addiu      $t6, $t6, %lo(func_801F39E4_ovl9 + 0x34)
/* 1CF838 801DEAC8 00002025 */  or         $a0, $zero, $zero
...
/* 1CF848 801DEAD8 0C078A32 */  jal        func_801E28C8_ovl12
/* 1CF84C 801DEADC AD0E008C */   sw        $t6, 0x8C($t0)
glabel func_801DEAE0_ovl16
/* 1CF850 801DEAE0 3C038005 */  lui        $v1, %hi(D_8004A7C4)
/* 1CF854 801DEAE4 8C63A7C4 */  lw         $v1, %lo(D_8004A7C4)($v1)
glabel func_801DEAE8_ovl11
/* 1CF858 801DEAE8 3C09800F */  lui        $t1, %hi(D_800E83E0)
/* 1CF85C 801DEAEC 24010001 */  addiu      $at, $zero, 0x1
.L801DEAF0_ovl14:
/* 1CF860 801DEAF0 8C620000 */  lw         $v0, 0x0($v1)
glabel func_801DEAF4_ovl12
/* 1CF864 801DEAF4 240A0009 */  addiu      $t2, $zero, 0x9
...
/* 1CF888 801DEB18 8C6B0000 */  lw         $t3, 0x0($v1)
glabel func_801DEB1C_ovl12
/* 1CF88C 801DEB1C 3C05801E */  lui        $a1, %hi(func_801DBD38_ovl10)
/* 1CF890 801DEB20 24A5BD38 */  addiu      $a1, $a1, %lo(func_801DBD38_ovl10)
...
/* 1CF8A4 801DEB34 3C0D8005 */  lui        $t5, %hi(D_8004A7C4)
/* 1CF8A8 801DEB38 8DADA7C4 */  lw         $t5, %lo(D_8004A7C4)($t5)
/* 1CF8AC 801DEB3C 8DA20000 */  lw         $v0, 0x0($t5)
...
/* 1CF8C0 801DEB50 3C0F801F */  lui        $t7, %hi(D_801F3B38_ovl10)
/* 1CF8C4 801DEB54 25EF3B38 */  addiu      $t7, $t7, %lo(D_801F3B38_ovl10)
/* 1CF8C8 801DEB58 3C198005 */  lui        $t9, %hi(D_8004A7C4)
...
/* 1CF8DC 801DEB6C 8F2E0000 */  lw         $t6, 0x0($t9)
