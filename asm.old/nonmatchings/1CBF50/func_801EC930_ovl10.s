...
/* 1DD6A4 801EC934 3C028005 */  lui        $v0, %hi(D_8004A7C4)
...
/* 1DD6B8 801EC948 8C430000 */  lw         $v1, 0x0($v0)
/* 1DD6BC 801EC94C 3C0E800B */  lui        $t6, %hi(func_800B67A8)
/* 1DD6C0 801EC950 3C01800E */  lui        $at, %hi(D_800DEF90)
/* 1DD6C4 801EC954 00031880 */  sll        $v1, $v1, 2
/* 1DD6C8 801EC958 00230821 */  addu       $at, $at, $v1
/* 1DD6CC 801EC95C 25CE67A8 */  addiu      $t6, $t6, %lo(func_800B67A8)
/* 1DD6D0 801EC960 AC2EEF90 */  sw         $t6, %lo(D_800DEF90)($at)
/* 1DD6D4 801EC964 8C580000 */  lw         $t8, 0x0($v0)
...
/* 1DD6F0 801EC980 240F0001 */  addiu      $t7, $zero, 0x1
/* 1DD6F4 801EC984 3C08801F */  lui        $t0, %hi(func_801F40C8_ovl9 + 0x80)
/* 1DD6F8 801EC988 AC2FDFD0 */  sw         $t7, %lo(D_800DDFD0)($at)
.L801EC98C_ovl16:
/* 1DD6FC 801EC98C 25084148 */  addiu      $t0, $t0, %lo(func_801F40C8_ovl9 + 0x80)
/* 1DD700 801EC990 3C040001 */  lui        $a0, (0x102B4 >> 16)
/* 1DD704 801EC994 348402B4 */  ori        $a0, $a0, (0x102B4 & 0xFFFF)
/* 1DD708 801EC998 0C02A806 */  jal        func_800AA018
/* 1DD70C 801EC99C AE080098 */   sw        $t0, 0x98($s0)
/* 1DD710 801EC9A0 3C040001 */  lui        $a0, (0x102B5 >> 16)
/* 1DD714 801EC9A4 0C02A806 */  jal        func_800AA018
/* 1DD718 801EC9A8 348402B5 */   ori       $a0, $a0, (0x102B5 & 0xFFFF)
/* 1DD71C 801EC9AC 0C02CD48 */  jal        func_800B3520
/* 1DD720 801EC9B0 00000000 */   nop
/* 1DD724 801EC9B4 0C02BBFF */  jal        func_800AEFFC
/* 1DD728 801EC9B8 24040002 */   addiu     $a0, $zero, 0x2
...
/* 1DD73C 801EC9CC 24040001 */   addiu     $a0, $zero, 0x1
/* 1DD740 801EC9D0 920A003C */  lbu        $t2, 0x3C($s0)
/* 1DD744 801EC9D4 1540FFFC */  bnez       $t2, .L801EC9C8_ovl16
/* 1DD748 801EC9D8 00000000 */   nop
.L801EC9DC_ovl10:
/* 1DD74C 801EC9DC 3C0C8005 */  lui        $t4, %hi(D_8004A7C4)
...
/* 1DD75C 801EC9EC 8D8D0000 */  lw         $t5, 0x0($t4)
/* 1DD760 801EC9F0 240B0002 */  addiu      $t3, $zero, 0x2
