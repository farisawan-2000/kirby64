...
/* 1DB808 801EAA98 3C028005 */  lui        $v0, %hi(D_8004A7C4)
...
/* 1DB81C 801EAAAC 8C430000 */  lw         $v1, 0x0($v0)
/* 1DB820 801EAAB0 3C0E800F */  lui        $t6, %hi(D_800E9E20)
/* 1DB824 801EAAB4 3C06800F */  lui        $a2, %hi(D_800EA520)
...
.L801EAAC4_ovl9:
/* 1DB834 801EAAC4 24C6A520 */  addiu      $a2, $a2, %lo(D_800EA520)
...
.L801EAAD4_ovl16:
/* 1DB844 801EAAD4 8DE50000 */  lw         $a1, 0x0($t7)
/* 1DB848 801EAAD8 3C03800F */  lui        $v1, %hi(D_800EA6E0)
/* 1DB84C 801EAADC 3C0140A0 */  lui        $at, (0x40A00000 >> 16)
/* 1DB850 801EAAE0 00052880 */  sll        $a1, $a1, 2
/* 1DB854 801EAAE4 00C5C021 */  addu       $t8, $a2, $a1
/* 1DB858 801EAAE8 8F190000 */  lw         $t9, 0x0($t8)
...
/* 1DB868 801EAAF8 2463A6E0 */  addiu      $v1, $v1, %lo(D_800EA6E0)
/* 1DB86C 801EAAFC 00654021 */  addu       $t0, $v1, $a1
/* 1DB870 801EAB00 E5040000 */  swc1       $f4, 0x0($t0)
/* 1DB874 801EAB04 8C490000 */  lw         $t1, 0x0($v0)
.L801EAB08_ovl16:
/* 1DB878 801EAB08 00095080 */  sll        $t2, $t1, 2
/* 1DB87C 801EAB0C 00CA5821 */  addu       $t3, $a2, $t2
/* 1DB880 801EAB10 8D6C0000 */  lw         $t4, 0x0($t3)
/* 1DB884 801EAB14 000C6880 */  sll        $t5, $t4, 2
/* 1DB888 801EAB18 006D7021 */  addu       $t6, $v1, $t5
.L801EAB1C_ovl9:
/* 1DB88C 801EAB1C C5C60000 */  lwc1       $f6, 0x0($t6)
...
/* 1DB8C4 801EAB54 24180001 */  addiu      $t8, $zero, 0x1
/* 1DB8C8 801EAB58 8C590000 */  lw         $t9, 0x0($v0)
/* 1DB8CC 801EAB5C 3C04800E */  lui        $a0, %hi(gEntityGObjProcessArray)
/* 1DB8D0 801EAB60 3C05801F */  lui        $a1, %hi(func_801EA784_ovl10)
...
/* 1DB8E0 801EAB70 8C490000 */  lw         $t1, 0x0($v0)
/* 1DB8E4 801EAB74 24A5A784 */  addiu      $a1, $a1, %lo(func_801EA784_ovl10)
