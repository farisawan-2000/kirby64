...
/* 1DDA60 801ECCF0 3C038005 */  lui        $v1, %hi(D_8004A7C4)
...
/* 1DDA74 801ECD04 8C620000 */  lw         $v0, 0x0($v1)
/* 1DDA78 801ECD08 3C0E800B */  lui        $t6, %hi(func_800B79F4)
/* 1DDA7C 801ECD0C 3C01800E */  lui        $at, %hi(D_800DEF90)
/* 1DDA80 801ECD10 00021080 */  sll        $v0, $v0, 2
.L801ECD14_ovl16:
/* 1DDA84 801ECD14 00220821 */  addu       $at, $at, $v0
.L801ECD18_ovl16:
/* 1DDA88 801ECD18 25CE79F4 */  addiu      $t6, $t6, %lo(func_800B79F4)
/* 1DDA8C 801ECD1C AC2EEF90 */  sw         $t6, %lo(D_800DEF90)($at)
/* 1DDA90 801ECD20 8C780000 */  lw         $t8, 0x0($v1)
...
/* 1DDAAC 801ECD3C 240F0003 */  addiu      $t7, $zero, 0x3
/* 1DDAB0 801ECD40 3C08801F */  lui        $t0, %hi(func_801F40C8_ovl9 + 0x80)
/* 1DDAB4 801ECD44 AC2FDFD0 */  sw         $t7, %lo(D_800DDFD0)($at)
/* 1DDAB8 801ECD48 25084148 */  addiu      $t0, $t0, %lo(func_801F40C8_ovl9 + 0x80)
/* 1DDABC 801ECD4C 3C040001 */  lui        $a0, (0x102B8 >> 16)
/* 1DDAC0 801ECD50 348402B8 */  ori        $a0, $a0, (0x102B8 & 0xFFFF)
/* 1DDAC4 801ECD54 0C02A806 */  jal        func_800AA018
/* 1DDAC8 801ECD58 AE080098 */   sw        $t0, 0x98($s0)
/* 1DDACC 801ECD5C 3C040001 */  lui        $a0, (0x102B9 >> 16)
/* 1DDAD0 801ECD60 0C02A806 */  jal        func_800AA018
/* 1DDAD4 801ECD64 348402B9 */   ori       $a0, $a0, (0x102B9 & 0xFFFF)
.L801ECD68_ovl9:
/* 1DDAD8 801ECD68 3C038005 */  lui        $v1, %hi(D_8004A7C4)
/* 1DDADC 801ECD6C 8C63A7C4 */  lw         $v1, %lo(D_8004A7C4)($v1)
/* 1DDAE0 801ECD70 3C05800E */  lui        $a1, %hi(D_800E6A10)
/* 1DDAE4 801ECD74 24A56A10 */  addiu      $a1, $a1, %lo(D_800E6A10)
/* 1DDAE8 801ECD78 8C620000 */  lw         $v0, 0x0($v1)
/* 1DDAEC 801ECD7C 3C013FC0 */  lui        $at, (0x3FC00000 >> 16)
/* 1DDAF0 801ECD80 44813000 */  mtc1       $at, $f6
/* 1DDAF4 801ECD84 00021080 */  sll        $v0, $v0, 2
.L801ECD88_ovl9:
/* 1DDAF8 801ECD88 00A24821 */  addu       $t1, $a1, $v0
/* 1DDAFC 801ECD8C C5240000 */  lwc1       $f4, 0x0($t1)
...
/* 1DDB10 801ECDA0 3C06800E */  lui        $a2, %hi(D_800E3750)
.L801ECDA4_ovl16:
/* 1DDB14 801ECDA4 24C63750 */  addiu      $a2, $a2, %lo(D_800E3750)
/* 1DDB18 801ECDA8 240400B4 */  addiu      $a0, $zero, 0xB4
/* 1DDB1C 801ECDAC E42864D0 */  swc1       $f8, %lo(D_800E64D0)($at)
/* 1DDB20 801ECDB0 8C620000 */  lw         $v0, 0x0($v1)
/* 1DDB24 801ECDB4 3C01801F */  lui        $at, %hi(D_801F4BB0_ovl10)
...
/* 1DDB34 801ECDC4 C54A0000 */  lwc1       $f10, 0x0($t2)
...
/* 1DDB48 801ECDD8 8C6B0000 */  lw         $t3, 0x0($v1)
/* 1DDB4C 801ECDDC 3C014040 */  lui        $at, (0x40400000 >> 16)
...
/* 1DDB64 801ECDF4 8C6D0000 */  lw         $t5, 0x0($v1)
...
/* 1DDB74 801ECE04 E7060000 */  swc1       $f6, 0x0($t8)
/* 1DDB78 801ECE08 8C620000 */  lw         $v0, 0x0($v1)
/* 1DDB7C 801ECE0C 00021080 */  sll        $v0, $v0, 2
/* 1DDB80 801ECE10 00C27821 */  addu       $t7, $a2, $v0
/* 1DDB84 801ECE14 C5E80000 */  lwc1       $f8, 0x0($t7)
/* 1DDB88 801ECE18 00220821 */  addu       $at, $at, $v0
/* 1DDB8C 801ECE1C E4283210 */  swc1       $f8, %lo(D_800E3210)($at)
/* 1DDB90 801ECE20 8C790000 */  lw         $t9, 0x0($v1)
/* 1DDB94 801ECE24 3C01801F */  lui        $at, %hi(D_801F4BB4_ovl10)
...
/* 1DDBE0 801ECE70 8D8D0000 */  lw         $t5, 0x0($t4)
/* 1DDBE4 801ECE74 240B0001 */  addiu      $t3, $zero, 0x1
