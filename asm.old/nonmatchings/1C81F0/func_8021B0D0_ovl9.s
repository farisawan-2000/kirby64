...
/* 1C9120 8021B0D0 3C028005 */  lui        $v0, %hi(D_8004A7C4)
...
/* 1C9134 8021B0E4 8C470000 */  lw         $a3, 0x0($v0)
/* 1C9138 8021B0E8 3C0E800F */  lui        $t6, %hi(D_800E9E20)
/* 1C913C 8021B0EC 3C0F800F */  lui        $t7, %hi(D_800EA6E0)
...
/* 1C914C 8021B0FC 25EFA6E0 */  addiu      $t7, $t7, %lo(D_800EA6E0)
...
/* 1C915C 8021B10C C4640000 */  lwc1       $f4, 0x0($v1)
/* 1C9160 8021B110 3C08800F */  lui        $t0, %hi(D_800EA8A0)
/* 1C9164 8021B114 2508A8A0 */  addiu      $t0, $t0, %lo(D_800EA8A0)
/* 1C9168 8021B118 46002187 */  neg.s      $f6, $f4
/* 1C916C 8021B11C 3C0B800E */  lui        $t3, %hi(D_800E6A10)
/* 1C9170 8021B120 E4660000 */  swc1       $f6, 0x0($v1)
/* 1C9174 8021B124 8C580000 */  lw         $t8, 0x0($v0)
/* 1C9178 8021B128 256B6A10 */  addiu      $t3, $t3, %lo(D_800E6A10)
/* 1C917C 8021B12C 3C0E800E */  lui        $t6, %hi(gEntitiesAngleYArray)
/* 1C9180 8021B130 0018C880 */  sll        $t9, $t8, 2
/* 1C9184 8021B134 03282021 */  addu       $a0, $t9, $t0
/* 1C9188 8021B138 C4880000 */  lwc1       $f8, 0x0($a0)
/* 1C918C 8021B13C 25CE41D0 */  addiu      $t6, $t6, %lo(gEntitiesAngleYArray)
/* 1C9190 8021B140 3C018022 */  lui        $at, %hi(D_8021DEE8_ovl9)
/* 1C9194 8021B144 46004287 */  neg.s      $f10, $f8
/* 1C9198 8021B148 E48A0000 */  swc1       $f10, 0x0($a0)
/* 1C919C 8021B14C 8C490000 */  lw         $t1, 0x0($v0)
/* 1C91A0 8021B150 00095080 */  sll        $t2, $t1, 2
/* 1C91A4 8021B154 014B2821 */  addu       $a1, $t2, $t3
/* 1C91A8 8021B158 C4B00000 */  lwc1       $f16, 0x0($a1)
/* 1C91AC 8021B15C 46008487 */  neg.s      $f18, $f16
/* 1C91B0 8021B160 E4B20000 */  swc1       $f18, 0x0($a1)
/* 1C91B4 8021B164 8C4C0000 */  lw         $t4, 0x0($v0)
...
/* 1C91C4 8021B174 C4C40000 */  lwc1       $f4, 0x0($a2)
/* 1C91C8 8021B178 46062200 */  add.s      $f8, $f4, $f6
/* 1C91CC 8021B17C 0C06735A */  jal        func_8019CD68_ovl7
/* 1C91D0 8021B180 E4C80000 */   swc1      $f8, 0x0($a2)
/* 1C91D4 8021B184 3C028005 */  lui        $v0, %hi(D_8004A7C4)
...
/* 1C91E4 8021B194 8C4F0000 */  lw         $t7, 0x0($v0)
/* 1C91E8 8021B198 3C058022 */  lui        $a1, %hi(func_8021ABB4_ovl9)
/* 1C91EC 8021B19C 24A5ABB4 */  addiu      $a1, $a1, %lo(func_8021ABB4_ovl9)
...
/* 1C91FC 8021B1AC 8C590000 */  lw         $t9, 0x0($v0)
