...
/* 1C9624 8021B5D4 3C038005 */  lui        $v1, %hi(D_8004A7C4)
...
/* 1C9638 8021B5E8 8C650000 */  lw         $a1, 0x0($v1)
/* 1C963C 8021B5EC 3C0E8022 */  lui        $t6, %hi(func_8021B680_ovl9)
/* 1C9640 8021B5F0 3C01800E */  lui        $at, %hi(D_800DF150)
/* 1C9644 8021B5F4 00052880 */  sll        $a1, $a1, 2
/* 1C9648 8021B5F8 00250821 */  addu       $at, $at, $a1
/* 1C964C 8021B5FC 25CEB680 */  addiu      $t6, $t6, %lo(func_8021B680_ovl9)
/* 1C9650 8021B600 AC2EF150 */  sw         $t6, %lo(D_800DF150)($at)
/* 1C9654 8021B604 8C6F0000 */  lw         $t7, 0x0($v1)
...
/* 1C9670 8021B620 3C08801D */  lui        $t0, %hi(D_801CD21C)
/* 1C9674 8021B624 AC20DC50 */  sw         $zero, %lo(gEntityVtableIndexArray)($at)
/* 1C9678 8021B628 24190002 */  addiu      $t9, $zero, 0x2
/* 1C967C 8021B62C 2508D21C */  addiu      $t0, $t0, %lo(D_801CD21C)
/* 1C9680 8021B630 3C048022 */  lui        $a0, %hi(func_8021B58C_ovl9)
/* 1C9684 8021B634 2484B58C */  addiu      $a0, $a0, %lo(func_8021B58C_ovl9)
/* 1C9688 8021B638 A0590042 */  sb         $t9, 0x42($v0)
/* 1C968C 8021B63C 0C068354 */  jal        func_801A0D50_ovl7
/* 1C9690 8021B640 AC480098 */   sw        $t0, 0x98($v0)
/* 1C9694 8021B644 3C098005 */  lui        $t1, %hi(D_8004A7C4)
/* 1C9698 8021B648 8D29A7C4 */  lw         $t1, %lo(D_8004A7C4)($t1)
/* 1C969C 8021B64C 3C04800E */  lui        $a0, %hi(gEntityVtableIndexArray)
/* 1C96A0 8021B650 3C068022 */  lui        $a2, %hi(D_8021CE44_ovl9)
/* 1C96A4 8021B654 8D2A0000 */  lw         $t2, 0x0($t1)
/* 1C96A8 8021B658 24C6CE44 */  addiu      $a2, $a2, %lo(D_8021CE44_ovl9)
/* 1C96AC 8021B65C 24050002 */  addiu      $a1, $zero, 0x2
