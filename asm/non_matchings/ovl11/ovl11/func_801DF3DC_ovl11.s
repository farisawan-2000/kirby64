...
/* 1E9CF8 801DF438 8C84E510 */ lw $a0, %lo(gEntitiesGObjThreadStackArray)($a0)
/* 1E9CFC 801DF43C 0C02C7B2 */  jal   restart_thread_with_new_function
...
/* 1E9D30 801DF470 3C01800E */ lui $at, %hi(D_800DDC50)
/* 1E9D34 801DF474 3C04800E */ lui $a0, %hi(gEntitiesGObjThreadStackArray)
/* 1E9D38 801DF478 000A5880 */  sll   $t3, $t2, 2
/* 1E9D3C 801DF47C 002B0821 */  addu  $at, $at, $t3
/* 1E9D40 801DF480 AC29DC50 */ sw $t1, %lo(D_800DDC50)($at)
...
/* 1E9D58 801DF498 0C02C7B2 */  jal   restart_thread_with_new_function
/* 1E9D5C 801DF49C 8C84E510 */ lw $a0, %lo(gEntitiesGObjThreadStackArray)($a0)
