...
/* 04F1D0 800A6F80 3C02800D */ lui $v0, %hi(D_800D79D8)
/* 04F1D4 800A6F84 00431021 */  addu  $v0, $v0, $v1
/* 04F1D8 800A6F88 8C4279D8 */ lw $v0, %lo(D_800D79D8)($v0)
...
/* 04F1F4 800A6FA4 3C01800D */ lui $at, %hi(D_800D7A28)
...
/* 04F210 800A6FC0 E42C7A28 */ swc1 $f12, %lo(D_800D7A28)($at)
/* 04F214 800A6FC4 46027032 */  c.eq.s $f14, $f2
.L800A6FC8_ovl1:
/* 04F218 800A6FC8 3C01800D */ lui $at, %hi(D_800D7A50)
...
/* 04F22C 800A6FDC E42E7A50 */ swc1 $f14, %lo(D_800D7A50)($at)
...
/* 04F24C 800A6FFC 3C01800D */ lui $at, %hi(D_800D7A78)
/* 04F250 800A7000 00230821 */  addu  $at, $at, $v1
/* 04F254 800A7004 E4267A78 */ swc1 $f6, %lo(D_800D7A78)($at)
/* 04F258 800A7008 C7A00010 */  lwc1  $f0, 0x10($sp)
.L800A700C_ovl1:
/* 04F25C 800A700C 3C01800D */ lui $at, %hi(D_800D7AA0)
...
/* 04F278 800A7028 E4207AA0 */ swc1 $f0, %lo(D_800D7AA0)($at)
/* 04F27C 800A702C C7A00014 */  lwc1  $f0, 0x14($sp)
.L800A7030_ovl1:
/* 04F280 800A7030 3C01800D */ lui $at, %hi(D_800D7AC8)
...
/* 04F29C 800A704C E4207AC8 */ swc1 $f0, %lo(D_800D7AC8)($at)
/* 04F2A0 800A7050 C7A00018 */  lwc1  $f0, 0x18($sp)
.L800A7054_ovl1:
/* 04F2A4 800A7054 3C01800D */ lui $at, %hi(D_800D7AF0)
...
/* 04F2C0 800A7070 E4207AF0 */ swc1 $f0, %lo(D_800D7AF0)($at)
