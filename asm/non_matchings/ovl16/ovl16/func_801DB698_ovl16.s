...
/* 2119FC 801DB74C 0C029D9E */  jal   func_800A7678
...
/* 211A18 801DB768 3C05800E */ lui $a1, %hi(gEntitiesPosXArray)
/* 211A1C 801DB76C 3C06800E */ lui $a2, %hi(gEntitiesPosYArray)
/* 211A20 801DB770 8F030000 */  lw    $v1, ($t8)
/* 211A24 801DB774 3C07800E */ lui $a3, %hi(gEntitiesPosZArray)
...
/* 211A3C 801DB78C 8CE72950 */ lw $a3, %lo(gEntitiesPosZArray)($a3)
/* 211A40 801DB790 8CC62790 */ lw $a2, %lo(gEntitiesPosYArray)($a2)
/* 211A44 801DB794 0C03F5D5 */  jal   func_800FD754
/* 211A48 801DB798 8CA525D0 */ lw $a1, %lo(gEntitiesPosXArray)($a1)
...
/* 211AD0 801DB820 3C01800E */ lui $at, %hi(D_800DDC50)
/* 211AD4 801DB824 000FC080 */  sll   $t8, $t7, 2
/* 211AD8 801DB828 00380821 */  addu  $at, $at, $t8
/* 211ADC 801DB82C AC2EDC50 */ sw $t6, %lo(D_800DDC50)($at)
/* 211AE0 801DB830 8CD90000 */  lw    $t9, ($a2)
/* 211AE4 801DB834 3C04800E */ lui $a0, %hi(gEntitiesGObjThreadStackArray)
...
/* 211AF4 801DB844 8C84E510 */ lw $a0, %lo(gEntitiesGObjThreadStackArray)($a0)
/* 211AF8 801DB848 0C02C7B2 */  jal   restart_thread_with_new_function
...
.L801DB960_ovl16:
/* 211C10 801DB960 0C029D9E */  jal   func_800A7678
...
/* 211C2C 801DB97C 3C05800E */ lui $a1, %hi(gEntitiesPosXArray)
/* 211C30 801DB980 3C06800E */ lui $a2, %hi(gEntitiesPosYArray)
/* 211C34 801DB984 8D030000 */  lw    $v1, ($t0)
/* 211C38 801DB988 3C07800E */ lui $a3, %hi(gEntitiesPosZArray)
...
/* 211C50 801DB9A0 8CE72950 */ lw $a3, %lo(gEntitiesPosZArray)($a3)
/* 211C54 801DB9A4 8CC62790 */ lw $a2, %lo(gEntitiesPosYArray)($a2)
/* 211C58 801DB9A8 0C03F5D5 */  jal   func_800FD754
/* 211C5C 801DB9AC 8CA525D0 */ lw $a1, %lo(gEntitiesPosXArray)($a1)
...
/* 211CC0 801DBA10 3C01800E */ lui $at, %hi(D_800DDC50)
/* 211CC4 801DBA14 000EC080 */  sll   $t8, $t6, 2
/* 211CC8 801DBA18 00380821 */  addu  $at, $at, $t8
/* 211CCC 801DBA1C AC2FDC50 */ sw $t7, %lo(D_800DDC50)($at)
/* 211CD0 801DBA20 8CD90000 */  lw    $t9, ($a2)
/* 211CD4 801DBA24 3C04800E */ lui $a0, %hi(gEntitiesGObjThreadStackArray)
...
/* 211CE4 801DBA34 8C84E510 */ lw $a0, %lo(gEntitiesGObjThreadStackArray)($a0)
/* 211CE8 801DBA38 0C02C7B2 */  jal   restart_thread_with_new_function
