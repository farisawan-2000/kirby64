...
/* 0B694C 80155F0C 3C0E8013 */ lui $t6, %hi(D_8012E804)
...
/* 0B698C 80155F4C 0C029D9E */  jal   play_sound
...
/* 0B69F4 80155FB4 3C088005 */ lui $t0, %hi(D_8004A7C4)
/* 0B69F8 80155FB8 8D08A7C4 */ lw $t0, %lo(D_8004A7C4)($t0)
/* 0B69FC 80155FBC 3C01800F */ lui $at, %hi(D_800EA8A0)
/* 0B6A00 80155FC0 9606000C */  lhu   $a2, 0xc($s0)
/* 0B6A04 80155FC4 8D020000 */  lw    $v0, ($t0)
/* 0B6A08 80155FC8 3C07800F */ lui $a3, %hi(D_800EA6E0)
/* 0B6A0C 80155FCC 00063040 */  sll   $a2, $a2, 1
/* 0B6A10 80155FD0 00021080 */  sll   $v0, $v0, 2
/* 0B6A14 80155FD4 00220821 */  addu  $at, $at, $v0
/* 0B6A18 80155FD8 C424A8A0 */ lwc1 $f4, %lo(D_800EA8A0)($at)
/* 0B6A1C 80155FDC 3C01800F */ lui $at, %hi(D_800EAA60)
/* 0B6A20 80155FE0 00220821 */  addu  $at, $at, $v0
/* 0B6A24 80155FE4 C426AA60 */ lwc1 $f6, %lo(D_800EAA60)($at)
/* 0B6A28 80155FE8 00E23821 */  addu  $a3, $a3, $v0
/* 0B6A2C 80155FEC 8CE7A6E0 */ lw $a3, %lo(D_800EA6E0)($a3)
...
/* 0B6A48 80156008 3C0A8005 */ lui $t2, %hi(D_8004A7C4)
/* 0B6A4C 8015600C 8D4AA7C4 */ lw $t2, %lo(D_8004A7C4)($t2)
/* 0B6A50 80156010 3C01800F */ lui $at, %hi(D_800E8220)
...
/* 0B6A6C 8015602C AC298220 */ sw $t1, %lo(D_800E8220)($at)
.L80156030_ovl3:
