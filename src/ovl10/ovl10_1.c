...
struct UnkStruct8004A7C4 *func_801DCF48_ovl10(void) {
    ...
    if (*(&D_800E83E0 + (temp_v1 * 4)) == 1) {
        ...
        phi_return = restart_thread_with_new_function(gEntityGObjProcessArray[temp_v0->unk0], &D_801DBD38);
    }
    return phi_return;
}
#else
...
void func_801DD2CC_ovl10(s32 arg0) {
    ...
    if (*(&D_800E83E0 + temp_a2) == 1) {
        ...
        restart_thread_with_new_function(gEntityGObjProcessArray[temp_v1_2->unk0], &D_801DBD38, temp_a2);
    }
}
#else
...
void func_801DD674_ovl10(s32 arg0) {;
    ...
    if (D_800E83E0[D_8004A7C4->objId] == 1) {
        ...
        restart_thread_with_new_function(gEntityGObjProcessArray[D_8004A7C4->objId], &D_801DBD38, temp_a2);
    }
}
#else
...
void *func_801DDEB8_ovl10(s32 arg0) {
    ...
    if (temp_a0 == 0) {
        ...
        if (temp_v0_2 >= 0xB) {
            ...
            if (temp_v0_2 < 0xC8) {
                ...
                if (temp_ret_2 != 0) {
                    ...
                    temp_ret = restart_thread_with_new_function(gEntityGObjProcessArray[temp_v1_3->unk0], &D_801DBD38);
                    temp_v1_4 = D_8004A7C4;
        ...
        if (temp_a0 == 1) {
            ...
            phi_return = restart_thread_with_new_function(gEntityGObjProcessArray[temp_v1_2->unk0], &D_801DBD38, temp_a2_2);
        }
    }
    return phi_return;
}
...
void func_801DEA98_ovl10(s32 arg0) {
    ...
    if (*(&D_800E83E0 + temp_v0) == 1) {
        ...
        restart_thread_with_new_function(gEntityGObjProcessArray[temp_v1->unk0], &D_801DBD38);
...
void func_801E0B94_ovl10(s32 arg0) {
    ...
    *temp_v0_3 = temp_a0_3 + 1;
    ...
    if (*(&D_800E83E0 + (temp_v1_8 * 4)) == 1) {
        ...
        restart_thread_with_new_function(gEntityGObjProcessArray[temp_a2_3->unk0], &D_801DBD38, temp_a2_3);
    }
}
#else
...
void *func_801E1550_ovl10(s32 arg0) {
    ...
    if (temp_a0 == 0) {
        ...
        if (temp_a0 == 1) {
            ...
            phi_return = restart_thread_with_new_function(gEntityGObjProcessArray[temp_v1_2->unk0], &D_801DBD38, temp_a2_4, &D_8004A7C4);
        }
    }
    return phi_return;
}
...
void func_801E1D3C_ovl10(void) {
    ...
    if (D_800E83E0[D_8004A7C4->objId] == 1) {
        ...
        restart_thread_with_new_function(gEntityGObjProcessArray[D_8004A7C4->objId], &func_801DBD38_ovl10);
    }
}
#else
