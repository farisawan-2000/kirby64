...
void func_801EF3F0_ovl10(s32 arg0) {
    ...
    D_800E3750[D_8004A7C4->unk0] = -0.8f;
    D_800E3C90[D_8004A7C4->unk0] = 8.0f;
    if (D_800EC2E0[D_8004A7C4->unk0] == 1) {
        D_800E64D0[D_8004A7C4->unk0] *= 0.65f;
        D_800E3750[D_8004A7C4->unk0] *= 0.65f;
        D_800E3210[D_8004A7C4->unk0] *= 0.65f;
    }
    if (D_800EC2E0[D_8004A7C4->unk0] == 2) {
        D_800E64D0[D_8004A7C4->unk0] *= 0.8f;
        D_800E3750[D_8004A7C4->unk0] *= 0.8f;
        D_800E3210[D_8004A7C4->unk0] *= 0.8f;
    }
    if (D_800EC2E0[D_8004A7C4->unk0] == 3) {
        D_800E2790[D_8004A7C4->unk0] += 20.0f;
        D_800E64D0[D_8004A7C4->unk0] *= 1.2f;
    }
    D_800E8920[D_8004A7C4->unk0] = 0;
    while (D_800E8920[D_8004A7C4->unk0] == 0) {
        func_8000B6BC(1);
    }
    D_800E64D0[D_8004A7C4->unk0] *= 0.7f;
    D_800E3210[D_8004A7C4->unk0] = 5.6f;
    D_800E3750[D_8004A7C4->unk0] = -0.8f;
    D_800E3C90[D_8004A7C4->unk0] = 8.0f;
    D_800E8920[D_8004A7C4->unk0] = 0;
    while (D_800E8920[D_8004A7C4->unk0] == 0) {
