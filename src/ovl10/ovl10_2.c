...
#ifdef MIPS_TO_C
struct GObj *func_801E5B08_ovl10(void *arg0, s32 arg1, f32 arg2) {
    s32 sp54;
    f32 sp4C;
    f32 sp3C;
    f32 sp38;
...
#ifdef MIPS_TO_C
struct GObj *func_801E6298_ovl10(s32 arg0) {
    f32 *temp_v1_2;
    f32 *temp_v1_3;
    f32 *temp_v1_4;
    f32 temp_f0;
    ...
    if (*temp_a1 == 0) {
        ...
        *temp_a2 = *temp_a2 - 1;
        ...
        phi_f0 = temp_f0;
        phi_return = (bitwise struct GObj *) temp_f0;
        if (temp_f0 < 1.0f) {
...
void func_801E7990_ovl10(s32 arg0) {
    ...
    sp5C->unk54 = 0;
    finish_current_thread((temp_a3 - 4) & 0xFF);
    temp_v0_3 = D_8004A7C4;
...
#ifdef MIPS_TO_C
struct GObj *func_801E9128_ovl10(s32 arg0) {
    struct GObj *temp_v0;
    u32 temp_v1;
...
#ifdef MIPS_TO_C
struct GObj *func_801EBF2C_ovl10(s32 arg0) {
    f32 *temp_a0;
    f32 *temp_a0_2;
    struct GObj *temp_v0;
    u32 temp_v1;
