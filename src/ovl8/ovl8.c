...
loop_3:
    ...
    func_800B3234(*(gEntitiesNextPosXArray + phi_v1), *(gEntitiesNextPosYArray + phi_v1), (bitwise f32) *(gEntitiesNextPosZArray + phi_v1));
}
#else
...
s32 func_801D1334_ovl8(void) {
    ...
    *temp_a1_2 = *temp_a1_2 - (D_800E5510[temp_v0_3] + D_800E56D0[temp_v0_3]);
    ...
    temp_a0 = &gEntitiesNextPosXArray[temp_v0_5];
    ...
    *temp_a1_3 = temp_f0;
    ...
    temp_a2 = &gEntitiesNextPosYArray[temp_v0_7];
    *temp_a2 = *temp_a2 + (D_800E3210[temp_v0_7] + temp_f0);
    temp_v0 = temp_v1_3->objId;
    temp_a3 = &gEntitiesNextPosZArray[temp_v0];
...
block_7:
    ...
    *(gEntitiesNextPosXArray + phi_a1) = sp30;
    gEntitiesNextPosYArray[phi_v0->objId] = sp34;
    gEntitiesNextPosZArray[phi_v0->objId] = sp38;
...
void func_801D17F4_ovl8(void) {
    ...
    func_800B3234(gEntitiesNextPosXArray[temp_v0], gEntitiesNextPosYArray[temp_v0], (bitwise f32) (bitwise s32) gEntitiesNextPosZArray[temp_v0]);
}
#else
...
s32 func_801D184C_ovl8(s32 arg0) {
    ...
    if (D_800EA520[temp_v0] != 0) {
        gEntitiesNextPosXArray[temp_v0] = gEntitiesNextPosXArray[temp_a3];
        temp_v0_2 = temp_v1->objId;
        ...
        temp_v0_4 = temp_v1_2->objId;
        phi_return = func_800B3234(gEntitiesNextPosXArray[temp_v0_4], gEntitiesNextPosYArray[temp_v0_4], (bitwise f32) (bitwise s32) gEntitiesNextPosZArray[temp_v0_4]);
    }
    return phi_return;
}
#else
...
void func_801D19B8_ovl8(s32 arg0) {
    ...
    temp_v0_2 = temp_v1->objId;
    gEntitiesNextPosZArray[temp_v0_2] = gEntitiesNextPosZArray[D_800E0D50[temp_v0_2]];
    temp_v0_3 = temp_v1->objId;
    func_800B3234(gEntitiesNextPosXArray[temp_v0_3], gEntitiesNextPosYArray[temp_v0_3], (bitwise f32) (bitwise s32) gEntitiesNextPosZArray[temp_v0_3]);
}
#else
