...
s32 func_801DC38C_ovl14(u32 arg0) {
    ...
    if ((track >= 0x3C) || (track == -1)) {
        // print_error_stub("enemy req over 18. Track Num:%d", track);
        print_error_stub(D_801E2FA0_ovl14, track);
        func_800B1900(track);
        return -1;
    }
...
#ifdef MIPS_TO_C
//generated by m2c commit 08138748803d75e73e4a94bb0c619a273754ee9c
extern char D_801E2FC4_ovl14[];                          /* unable to generate initializer; const */
...
s32 func_801DC674_ovl14(GObj *arg0, u32 arg1) {
    ...
    temp_v0 = request_track_general(0x1A, 0x1E, 0x50, arg1);
    sp1C = temp_v0;
    if ((temp_v0 >= 0x3C) || (temp_v0 == -1)) {
        print_error_stub(D_801E2FC4_ovl14, sp1C);
        func_800B1900(sp1C);
        return -1;
    }
    D_800E76C0[temp_v0] = 0xFF;
    D_800E7730[temp_v0] = 4;
    D_800E77A0[temp_v0] = 0x2B;
    D_800E7880[temp_v0] = arg0;
    if (arg0 == 0) {
        switch (arg1) {
            case 0:
                var_f0 = -320.0f;
                gEntitiesPosXArray[temp_v0] = -320.0f;
                goto block_20;
            case 1:
                var_f0 = -160.0f;
                gEntitiesPosXArray[temp_v0] = -160.0f;
                goto block_20;
            case 2:
                var_f0 = 0.0f;
        ...
        switch (arg1) {                             /* switch 1; irregular */
            case 0:                                 /* switch 1 */
                var_f0 = -240.0f;
                gEntitiesPosXArray[temp_v0] = -240.0f;
block_20:
                gEntitiesNextPosXArray[temp_v0] = var_f0;
                break;
            case 1:                                 /* switch 1 */
                var_f0 = -80.0f;
                gEntitiesPosXArray[temp_v0] = -80.0f;
                goto block_20;
            case 2:                                 /* switch 1 */
                var_f0 = 80.0f;
                gEntitiesPosXArray[temp_v0] = 80.0f;
    ...
    temp_f0 = gEntitiesNextPosYArray[D_8004A7C4->objId];
    gEntitiesPosYArray[sp1C] = temp_f0;
    gEntitiesNextPosYArray[sp1C] = temp_f0;
    temp_f0_2 = gEntitiesNextPosZArray[D_8004A7C4->objId];
    gEntitiesPosZArray[sp1C] = temp_f0_2;
    gEntitiesNextPosZArray[sp1C] = temp_f0_2;
    D_800E8E60[sp1C] = 1;
    D_800EC2E0[sp1C] = arg1;
    return sp1C;
}
#else
...
#ifdef MIPS_TO_C
//generated by m2c commit 08138748803d75e73e4a94bb0c619a273754ee9c
static ? D_801E2FE8_ovl14;                          /* unable to generate initializer; const */
...
s32 func_801DC954_ovl14(void) {
    ...
    if ((temp_v0 >= 0x3C) || (temp_v0 == -1)) {
        sp1C = temp_v0;
        print_error_stub(&D_801E2FE8_ovl14, temp_v0, temp_v0);
        func_800B1900(temp_v0 & 0xFFFF);
        return -1;
    }
    D_800E76C0[temp_v0] = 0xFF;
    D_800E7730[temp_v0] = 2;
    D_800E77A0[temp_v0] = 3;
    ...
    temp_f0_2 = gEntitiesNextPosYArray[D_8004A7C4->objId] + 160.0f;
    ...
    temp_f0_4 = D_800E6BD0[D_8004A7C4->objId];
    D_800E6D90[temp_v0] = temp_f0_4;
    D_800E6BD0[temp_v0] = temp_f0_4;
    return temp_v0;
}
#else
GLOBAL_ASM("asm/non_matchings/ovl14/21.s")
#endif
...
void func_801DDE60_ovl14(GObj *arg0) {
    ...
    temp_f20 = 0xA;
    D_800E6690[temp_s0] = D_800E6A10[temp_s0] * (10.0f * 0.05f);
    D_800E6850[D_8004A7C4->objId] = temp_f20;
    D_800E9E20[D_8004A7C4->objId] = 1;
    play_sound(0x190);
    finish_current_thread(0x14);
    temp_s0_2 = D_8004A7C4->objId;
    D_800E64D0[temp_s0_2] = D_800E6A10[temp_s0_2] * temp_f20;
    finish_current_thread(0x1E);
    temp_s0_3 = D_8004A7C4->objId;
    D_800E6690[temp_s0_3] = D_800E6A10[temp_s0_3] * (-0xA * 0.05f);
    D_800E6850[D_8004A7C4->objId] = temp_f20;
    finish_current_thread(0x14);
    D_800E6690[D_8004A7C4->objId] = 0.0f;
    temp_s0_4 = D_8004A7C4->objId;
    D_800E64D0[temp_s0_4] = D_800E6690[temp_s0_4];
    ...
    func_800FB914(0);
    finish_current_thread(0x1E);
    temp_v0 = &D_800E6A10[D_8004A7C4->objId];
    *temp_v0 *= -1.0f;
...
void func_801DF580_ovl14(f32 arg0) {
    ...
    s32 temp_a0_5;
    s32 temp_a0_6;
    struct LayoutNode **var_v1;
    u32 temp_v0;
    void *temp_s0;

    D_8004A7C4->objId = D_8004A7C4->objId;
    // TODO: fill out D_800E9FE0
    temp_s0 = *D_800E9FE0[D_8004A7C4->objId];
    if (D_800DFBD0[D_8004A7C4->objId]->unk10->unk80 != 0) {
        func_8000C144(D_800DFBD0[D_8004A7C4->objId]->unk10->unk80, *temp_s0->unk10, arg0);
    }
    if (D_800DFBD0[D_8004A7C4->objId]->unk14->unk80 != 0) {
        func_8000C144(D_800DFBD0[D_8004A7C4->objId]->unk14->unk80, *temp_s0->unk14, arg0);
    }
    if (D_800DFBD0[D_8004A7C4->objId]->unk18->unk80 != 0) {
        func_8000C144(D_800DFBD0[D_8004A7C4->objId]->unk18->unk80, *temp_s0->unk18, arg0);
    }
    if (D_800DFBD0[D_8004A7C4->objId]->unk1C->unk80 != 0) {
        func_8000C144(D_800DFBD0[D_8004A7C4->objId]->unk1C->unk80, *temp_s0->unk1C, arg0);
    }
    if (D_800DFBD0[D_8004A7C4->objId]->unk20->unk80 != 0) {
        func_8000C144(D_800DFBD0[D_8004A7C4->objId]->unk20->unk80, *temp_s0->unk20, arg0);
    }
    if (D_800DFBD0[D_8004A7C4->objId]->unk24->unk80 != 0) {
        func_8000C144(D_800DFBD0[D_8004A7C4->objId]->unk24->unk80, *temp_s0->unk24, arg0);
    }
}
/* Warning: struct LayoutNode is not defined (only forward-declared) */
#else
GLOBAL_ASM("asm/non_matchings/ovl14/51.s")
#endif
...
void func_801DF75C_ovl14(f32 arg0) {
    ...
    temp_v0 = D_8004A7C4->objId;
    var_v1 = D_800DFBD0[temp_v0];
    temp_s0 = *D_800EC2E0[temp_v0];
    temp_a0 = var_v1->unk10->unk80;
    if (temp_a0 != 0) {
        func_8000C144(temp_a0, *temp_s0->unk10, arg0);
        var_v1 = D_800DFBD0[D_8004A7C4->objId];
    }
    temp_a0_2 = var_v1->unk14->unk80;
    if (temp_a0_2 != 0) {
        func_8000C144(temp_a0_2, *temp_s0->unk14, arg0);
        var_v1 = D_800DFBD0[D_8004A7C4->objId];
    }
    temp_a0_3 = var_v1->unk18->unk80;
    if (temp_a0_3 != 0) {
        func_8000C144(temp_a0_3, *temp_s0->unk18, arg0);
        var_v1 = D_800DFBD0[D_8004A7C4->objId];
    }
    temp_a0_4 = var_v1->unk1C->unk80;
    if (temp_a0_4 != 0) {
        func_8000C144(temp_a0_4, *temp_s0->unk1C, arg0);
        var_v1 = D_800DFBD0[D_8004A7C4->objId];
    }
    temp_a0_5 = var_v1->unk20->unk80;
    if (temp_a0_5 != 0) {
        func_8000C144(temp_a0_5, *temp_s0->unk20, arg0);
        var_v1 = D_800DFBD0[D_8004A7C4->objId];
    }
    temp_a0_6 = var_v1->unk24->unk80;
    if (temp_a0_6 != 0) {
        func_8000C144(temp_a0_6, *temp_s0->unk24, arg0);
    }
}
/* Warning: struct LayoutNode is not defined (only forward-declared) */
#else
GLOBAL_ASM("asm/non_matchings/ovl14/53.s")
#endif
...
#else
GLOBAL_ASM("asm/non_matchings/ovl14/55.s")
#endif

void (*D_801E2F14_ovl14[2])(GObj *) = { func_801DFB48_ovl14, func_801DFC30_ovl14 };
#ifdef MIPS_TO_C
//generated by m2c commit 08138748803d75e73e4a94bb0c619a273754ee9c
...
#else
GLOBAL_ASM("asm/non_matchings/ovl14/56.s")
#endif

void (*D_801E2F1C_ovl14[5])(GObj *) = { func_801DFC28_ovl14, func_801DFD7C_ovl14, NULL, NULL, NULL };
#ifdef MIPS_TO_C
//generated by m2c commit 08138748803d75e73e4a94bb0c619a273754ee9c
...
#else
GLOBAL_ASM("asm/non_matchings/ovl14/57.s")
#endif
...
void func_801DFB48_ovl14(GObj *arg0) {
    ...
    func_800FA414(2);
    temp_v0 = D_8004A7C4;
    D_80129138 = temp_v0->objId;
    D_800E6A10[temp_v0->objId] = 1.0f;
loop_1:
    temp_v1 = temp_v0->objId;
    if (D_800E9C60[D_800E0D50[temp_v1]] != 1) {
        finish_current_thread(1);
        goto loop_1;
    }
...
#else
GLOBAL_ASM("asm/non_matchings/ovl14/59.s")
#endif
...
void func_801DFC30_ovl14(GObj *arg0) {
    ...
    D_800DDFD0[D_8004A7C4->objId] = 1;
    temp_s0 = D_8004A7C4->objId;
    D_800E6690[temp_s0] = D_800E6A10[temp_s0] * 0.30967742f;
    finish_current_thread(0xA);
    D_800E6690[D_8004A7C4->objId] = 0.0f;
    temp_s0_2 = D_8004A7C4->objId;
    D_800E64D0[temp_s0_2] = D_800E6A10[temp_s0_2] * 3.096774f;
    finish_current_thread(0x122);
    temp_s0_3 = D_8004A7C4->objId;
    D_800E6690[temp_s0_3] = D_800E6A10[temp_s0_3] * -0.30967742f;
    finish_current_thread(0xA);
    D_800E6690[D_8004A7C4->objId] = 0.0f;
    temp_s0_4 = D_8004A7C4->objId;
    D_800E64D0[temp_s0_4] = D_800E6690[temp_s0_4];
...
#else
GLOBAL_ASM("asm/non_matchings/ovl14/61.s")
#endif
