...
void func_8016C510_ovl3(s32 arg0) {
    call_virtual_function(D_800DDC50[D_8004A7C4->objId], 0x56, &D_80196990);
}
#else
...
void func_8016CA8C_ovl3(s32 arg0) {
    ...
    func_8011CF58();
    temp_a1 = D_8004A7C4;
    D_800DDFD0[temp_a1->objId] = 0;
    temp_v1 = gKirbyState.unk4;
    if (temp_v1 == 1) {
        D_800E0490[temp_a1->objId] = &D_80192704;
    } else {
        D_800E0490[temp_a1->objId] = &D_801926E8;
    }
    if (temp_v1 == 1) {
    ...
    D_800E6850[temp_a1->objId] = D_8019734C;
    if ((temp_v1 == 2) && (func_800AA888(0x20007, temp_a1) == 0)) {
...
block_40:
    ...
    if ((D_800E8AE0[temp_a1_2->objId] & 6) != 0) {
        goto block_11;
    }
    gKirbyState.unk3C = 0;
    D_800E9AA0[temp_a1_2->objId] = gKirbyState.turnDirection;
        ...
        if (gKirbyState.unk30 == 0) {
            ...
            if (temp_a0 != 0) {
                if (temp_a0 != 1) {
                    ...
                    } else if (gKirbyState.previousAction != 0x11) {
...
block_65:
    ...
    D_800E9720[temp_a1_3->objId] = 0xF;
    temp_v0_3 = &D_800E9720[temp_a1_3->objId];
    temp_v1_2 = *temp_v0_3;
    *temp_v0_3 = temp_v1_2 - 1;
    if (temp_v1_2 != 0) {
loop_82:
        func_8000B6BC(1);
        temp_v0_4 = &D_800E9720[D_8004A7C4->objId];
        temp_v1_3 = *temp_v0_4;
...
void func_8016D3A8_ovl3(s32 arg0) {
    ...
    struct UnkStruct8004A7C4 *temp_a3_3;
    u32 temp_v0;
    u32 temp_v0_2;
    u32 temp_v0_3;
    u32 temp_v0_4;
...
block_8:
    ...
    if ((D_800D6FAC == 0) && (D_800E9720[temp_v0] == 0) && (func_80122460() != 0) && ((D_800D6FE8.buttonHeld & 0x400) != 0) && (gKirbyState.unk4 == 0)) {
        D_800D6F10 = 0;
        gKirbyState.unkA = 0;
        D_8012BCA0 = D_8012BCA0 & 7;
        set_kirby_action_1(0xA, 0xD);
    ...
    if (D_800E9AA0[temp_a0_2->objId] != 0) {
        if ((gKirbyState.unk17 == 0) && ((D_800D6FE8.buttonPressed & 0x4000) != 0)) {
            gKirbyState.unkA = 1;
        }
    } else if (((D_800D6FE8.buttonHeld & 0x400) != 0) && ((D_800D6FE8.buttonPressed & 0x8000) != 0)) {
        gKirbyState.unkA = 2;
    }
    phi_a0 = temp_a0_2;
    if ((gKirbyState.isTurning & 1) == 0) {
...
void func_801702F0_ovl3(s32 arg0) {
    ...
    if (gKirbyState.ceilingCollisionNext != 0) {
        play_sound(0xFF);
        temp_v1 = gKirbyState.unk4;
        if ((temp_v1 == 1) || (gKirbyState.previousAction == 9)) {
            temp_v0_2 = D_8004A7C4;
            D_800E3210[temp_v0_2->objId] = 5.0f;
            D_800E3750[temp_v0_2->objId] = 0.0f;
            phi_f0 = 5.0f;
            phi_at = &D_800E3C90[temp_v0_2->objId];
            phi_v0 = temp_v0_2;
        } else {
            temp_v0 = D_8004A7C4;
            temp_f0 = D_801973A4;
            ...
            D_800E3750[temp_v0->objId] = 0.0f;
            phi_f0 = temp_f0;
            phi_at = &D_800E3C90[temp_v0->objId];
            phi_v0 = temp_v0;
        }
        *phi_at = phi_f0;
        if (D_800E6A10[phi_v0->objId] == -1.0f) {
            if (temp_v1 == 1) {
        ...
        temp_v0_3 = D_8004A7C4;
        D_800E3210[temp_v0_3->objId] = 0.0f;
        D_800E3750[temp_v0_3->objId] = 0.0f;
        D_800E3C90[temp_v0_3->objId] = 0.0f;
    } else {
        play_sound(0x101);
        temp_v0_4 = D_8004A7C4;
        D_800E3210[temp_v0_4->objId] = -5.0f;
        D_800E3750[temp_v0_4->objId] = 0.0f;
        D_800E3C90[temp_v0_4->objId] = 5.0f;
        if (D_800E6A10[temp_v0_4->objId] == -1.0f) {
...
void func_80172234_ovl3(s32 arg0) {
    ...
    if (gKirbyState.unk17 == 0) {
        ...
        if (D_800E98E0[D_8004A7C4->objId] != 0) {
            if ((gKirbyState.unk3C == 0) && (func_80151E94_ovl3(&sp3C) != 0)) {
                func_8011CF58();
                func_8011E234();
                func_8011DC5C(ERROR(Read from unset register $f12));
                func_8011E0E8();
                if ((D_800D6FEA & 0x4000) != 0) {
                    ...
                    D_800E3C90[temp_v1_2->objId] = D_80197410;
                }
                if (gKirbyState.action == 5) {
                    if (func_80121194() != 0) {
                        ...
                        if ((D_800E8AE0[temp_v0_3] & 6) != 0) {
                            D_800E64D0[temp_v0_3] = D_800E6A10[temp_v0_3] * -2.0f;
                            temp_v0_4 = temp_v1_3->objId;
                            D_800E6690[temp_v0_4] = D_800E6A10[temp_v0_4] * D_80197414;
                            ((temp_v1_3->objId * 4) + 0x800E0000)->unk6850 = 2.0f;
                        } else {
                            D_800E64D0[temp_v0_3] = D_800E6A10[temp_v0_3] * -6.0f;
                            temp_v0_5 = temp_v1_3->objId;
                            D_800E6690[temp_v0_5] = D_800E6A10[temp_v0_5] * 0.125f;
                            D_800E6850[temp_v1_3->objId] = 6.0f;
                        }
                    } else {
                        temp_v1_4 = D_8004A7C4;
                        D_800E6690[temp_v1_4->objId] = 0.0f;
                        temp_v0_6 = temp_v1_4->objId;
                        D_800E64D0[temp_v0_6] = D_800E6690[temp_v0_6];
                        D_800E6850[temp_v1_4->objId] = D_80197418;
                        gKirbyState.isTurning = gKirbyState.isTurning | 4;
                    }
                } else {
                    gKirbyState.isTurning = gKirbyState.isTurning & ~4;
...
loop_27:
        ...
        temp_v1_5 = D_8004A7C4;
        temp_f0 = phi_f0;
        D_800E3210[temp_v1_5->objId] = temp_f0;
        if (temp_f0 < 0.0f) {
            phi_f2 = -temp_f0;
        } else {
            phi_f2 = temp_f0;
        ...
        if (phi_f2 < 0.0f) {
            ...
            D_800E3C90[temp_v1_5->objId] = -phi_f2_2;
        } else {
            if (temp_f0 < 0.0f) {
                phi_f2_3 = -temp_f0;
            } else {
            ...
            D_800E3C90[temp_v1_5->objId] = phi_f2_3;
        }
        temp_v0_10 = gKirbyState.unk2C;
        gKirbyState.unk2C = temp_v0_10 - 1;
        if (temp_v0_10 == 0) {
            D_800BE4F8 = 2;
            func_8011DC5C(0.0f);
            func_8011E0E8();
...
void func_80172A3C_ovl3(s32 arg0) {
    ...
    sp1C = D_80196C98;
    func_80153984_ovl3();
    if ((func_80151E94_ovl3(&sp1C) == 0) && ((D_8012E7F4 & 1) == 0) && (func_80121194() != 0)) {
        temp_v0 = D_8004A7C4->objId;
        ...
        *0x801A0000 = 3;
        ...
        if (gKirbyState.unk4 == 1) {
            ...
            if (gKirbyState.unk8 == 0) {
                ...
                if ((temp_a0 != 0) && ((D_800D6FE8.buttonHeld & 0x400) == 0) && ((D_800D6FEA & 0x8000) != 0)) {
                    set_kirby_action_1(3, 5);
block_19:
                    phi_v1 = &gKirbyState;
                } else if ((D_800D6FEA & 0x4000) != 0) {
        ...
        if (phi_v1_2->unk30 != 0) {
            ...
            if (phi_v1_2->isInhaling != 0) {
                ...
                if (phi_v1_2->unkB2 == 0) {
                    phi_v1_3 = phi_v1_2;
                    if ((D_800D6FE8.buttonHeld & 0x4000) == 0) {
                        if (phi_v1_2->unk8 != 0) {
                            phi_v1_2->unk8 = 0;
                        }
                        sp1C = 1;
...
void func_80175754_ovl3(s32 arg0) {
    ...
    if (gKirbyState.horizontalCollision != 0) {
        ...
        temp_v1 = temp_v0->objId;
        D_800E64D0[temp_v1] = D_800E6690[temp_v1];
        D_800E6850[temp_v0->objId] = D_8019747C;
    }
    if (gKirbyState.unk30 != 0) {
        if (gKirbyState.unk8 != 0) {
            set_kirby_action_1(0xB, 0x10);
        } else if (func_80179130_ovl3(0xB) == 0) {
            if (D_800E8920[D_8004A7C4->objId] == 0) {
                set_kirby_action_1(6, 6);
            } else {
                ...
                if (temp_v0_2 != 0) {
                    if (temp_v0_2 != 1) {
                        ...
                        } else if ((D_800D6FE8.buttonHeld & 0x400) != 0) {
        ...
        gKirbyState.unk24 = 0;
        temp_v0_3 = D_8004A7C4;
        D_800E7CE0[temp_v0_3->objId] = 0x2D;
        if ((gKirbyState.unk4 != 0) && (gKirbyState.damageType >= 2)) {
            temp_v1_2 = &D_800E7CE0[temp_v0_3->objId];
...
void func_801760FC_ovl3(s32 arg0) {
    ...
    if (gKirbyState.horizontalCollision != 0) {
        ...
        temp_v1 = temp_v0->objId;
        D_800E64D0[temp_v1] = D_800E6690[temp_v1];
        D_800E6850[temp_v0->objId] = D_801974B4;
    }
    if (gKirbyState.unk30 != 0) {
        if (gKirbyState.unk8 != 0) {
            set_kirby_action_1(0xB, 0x10);
...
void func_80176860_ovl3(s32 arg0) {
    ...
    struct UnkStruct8004A7C4 *temp_v0_7;
    struct UnkStruct8004A7C4 *temp_v0_8;
    u32 temp_v1;
    u32 temp_v1_2;
    u32 temp_v1_3;
    u8 temp_v0_2;
...
loop_20:
    ...
    if ((temp_v0_4 == 0) && ((D_800D6FE8.buttonPressed & 0x8000) != 0)) {
        ...
        if ((temp_v0_4 == 0) && ((D_800D6FE8.buttonHeld & 0x400) != 0)) {
            func_800AECC0(2.0f);
            func_800AED20(2.0f);
        ...
        } else if ((temp_v0_4 == 0) && ((D_800D6FE8.buttonHeld & 0x800) != 0)) {
            func_800AECC0(2.0f);
            func_800AED20(2.0f);
...
u32 func_80176DE0_ovl3(s32 arg0) {
    ...
    D_800E8920[D_8004A7C4->objId] = 0;
    func_80153984_ovl3();
    if ((D_8012E7D7 == 0) && ((D_800D6FE8.buttonHeld & 0xF00) != 0)) {
...
void func_8017883C_ovl3(s32 arg0) {
    ...
    func_80153984_ovl3();
    temp_v1 = gKirbyState.unkB;
    if ((temp_v1 != 1) && (temp_v1 != 2) && (func_80151E94_ovl3(&sp24) == 0)) {
        if ((gKirbyState.unkB9 == 0) && ((gKirbyState.isTurning & 1) == 0) && (func_80121194() != 0)) {
            gKirbyState.isTurning = gKirbyState.isTurning | 1;
        }
        if (gKirbyState.unk17 != 0) {
...
void func_801789D8_ovl3(s32 arg0) {
    ...
    func_8011CF58();
    temp_v0 = D_8004A7C4;
    D_800DDFD0[temp_v0->objId] = 0x20;
    D_800E0490[temp_v0->objId] = &D_801926E8;
    gKirbyState.unk15C = &D_80190358;
    D_800E3750[temp_v0->objId] = 0.0f;
    temp_v1 = temp_v0->objId;
    D_800E3210[temp_v1] = D_800E3750[temp_v1];
    D_800E3C90[temp_v0->objId] = D_80197528;
    gKirbyState.unk44 = 0;
    gKirbyState.unk3C = 2;
    D_800E9560[temp_v0->objId] = 8;
...
void func_80179C28_ovl3(void *arg0) {
    ...
    if (gKirbyState.abilityInUse == 0) {
        ...
        if (D_800E8920[temp_v0] == 0) {
            phi_v0 = temp_v0_2;
            if ((D_800D6FE8.buttonHeld & 0x4400) == 0x4400) {
                temp_f12 = D_8019758C;
...
loop_1:
    if (gKirbyState.unk17 == 0) {
        if (D_800E9720[D_8004A7C4->objId] >= 4) {
            if (((D_800D6FE8.buttonHeld & 0x4000) != 0) && (func_800AF230() == 0)) {
block_5:
                temp_v0_2 = &D_800E9720[D_8004A7C4->objId];
                *temp_v0_2 = *temp_v0_2 + 1;
                func_8000B6BC(1);
...
void func_8017C1FC_ovl3(s32 arg0) {
    ...
    if (temp_v0 == 3) {
        ...
        if (temp_v0 != 2) {
            ...
            } else if ((D_800D6FE8.buttonHeld & 0x4000) == 0) {
                gKirbyState.unkA = 4;
            }
            func_8011ED68();
        }
...
loop_1:
    if ((gKirbyState.unk17 == 0) && ((D_800D6FE8.buttonHeld & 0x4000) != 0)) {
        func_8000B6BC(1);
        goto loop_1;
    }
    func_8011E0E8();
...
block_35:
            ...
            if (temp_f0_2 > 0.0f) {
                ...
                phi_v1_3 = phi_v1_4;
                phi_a1_2 = phi_a1;
                phi_return = (bitwise struct UnkStruct8004A7C4 *) temp_f0_2;
                goto block_35;
            } else {
                phi_a0_2 = phi_a0;
                phi_v1_3 = phi_v1;
...
block_12:
    ...
    temp_v1_3 = D_800D6FE8.buttonHeld;
...
void func_80180818_ovl3(s32 arg0) {
    ...
    if ((D_800E8920[temp_v1->objId] == 0) && ((D_800D6FE8.buttonHeld & 0x400) != 0)) {
        gKirbyState.unk44 = 0;
    } else {
        gKirbyState.unk44 = 1;
    }
...
void func_80183FF4_ovl3(s32 arg0) {
    ...
    struct UnkStruct8004A7C4 *temp_a3_2;
    struct UnkStruct8004A7C4 *temp_a3_3;
    struct UnkStruct8004A7C4 *temp_a3_4;
    u32 temp_v1;
    u32 temp_v1_3;
    u32 temp_v1_4;
    u32 temp_v1_5;
...
extern void func_8011DC5C(f32 a);
...
void func_8018E164_ovl3(s32 arg0) {
    ...
    gKirbyState.abilityInUse = gKirbyState.ability;
    temp_v0 = D_8004A7C4;
    D_800DDFD0[temp_v0->objId] = 0x41;
    D_80198848.unk0 = D_800E64D0[temp_v0->objId];
    D_80198848.unk4 = D_800E6690[temp_v0->objId];
    D_80198848.unk8 = D_800E6850[temp_v0->objId];
    D_800E6690[temp_v0->objId] = 0.0f;
    temp_v1 = temp_v0->objId;
    D_800E64D0[temp_v1] = D_800E6690[temp_v1];
    D_800E6850[temp_v0->objId] = temp_f2;
    ...
    phi_v1 = temp_v1_2 * 4;
    if (D_800E8920[temp_v1_2] == 0) {
        D_80198858.unk0 = D_800E3210[temp_v1_2];
        D_80198858.unk4 = D_800E3750[temp_v0->objId];
        D_80198858.unk8 = D_800E3C90[temp_v0->objId];
        phi_v1 = temp_v0->objId * 4;
    }
    *(D_800E3750 + phi_v1) = 0.0f;
    ...
    D_800DF310[D_8004A7C4->objId] = &D_8018E36C;
    func_800AF27C();
    gKirbyState.abilityInUse = 0;
    gKirbyState.unk30 = gKirbyState.unk30 + 1;
    func_800AFA14();
...
void func_8018E3B0_ovl3(s32 arg0) {
    ...
    if (gKirbyState.unk30 != 0) {
        temp_v0 = D_8004A7C4;
        D_800E64D0[temp_v0->objId] = D_80198848.unk0;
        D_800E6690[temp_v0->objId] = D_80198848.unk4;
        D_800E6850[temp_v0->objId] = D_80198848.unk8;
        temp_v1 = temp_v0->objId;
        if (D_800E8920[temp_v1] != 0) {
            if ((D_800D6FE8.buttonHeld & 0x400) == 0) {
                if (gKirbyState.unk7 == 0) {
                    if (D_800E64D0[temp_v1] == 0.0f) {
                        set_kirby_action_1(0, 1);
                        return;
                    }
                    set_kirby_action_1(1, 3);
        ...
        D_800E3750[temp_v0->objId] = D_80198858.unk4;
        D_800E3C90[temp_v0->objId] = D_80198858.unk8;
        if (gKirbyState.previousAction == 5) {
            temp_v1_2 = temp_v0->objId;
            if (D_800E3210[temp_v1_2] > 0.0f) {
                D_800EC2E0[temp_v1_2] = 0x80000000;
                set_kirby_action_1(4, 5);
                return;
            }
        }
        temp_v1_3 = temp_v0->objId;
        if (D_800E3210[temp_v1_3] > 0.0f) {
            D_800E3750[temp_v1_3] = 0.0f;
            temp_v1_4 = temp_v0->objId;
            D_800E3210[temp_v1_4] = D_800E3750[temp_v1_4];
            D_800E3C90[temp_v0->objId] = D_80197B6C;
        }
        set_kirby_action_1(6, 6);
    }
}
