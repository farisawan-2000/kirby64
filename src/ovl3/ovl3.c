    ...
    if (((temp_v0 + 0x800F0000)->unk-7520 & 6) != 0) {
        if (D_800D6FAC == 0) {
            if (gKirbyState.unk4 == 2) {
                if (((D_800D6FE8.unk2 & 0x8000) != 0) || (phi_v1 = 0, phi_a3 = &D_800D6FE8, ((D_800D6FE8.unk0 & 0x300) != 0))) {
                    phi_a3 = &D_800D6FE8;
block_10:
                    phi_v1 = 1;
                } else {
                    ...
                    if (gKirbyState.unk1C != 0) {
                        if (gKirbyState.unk4 == 0) {
                            if ((temp_v0 + 0x800F0000)->unk-76E0 == 0) {
                                ...
                                gKirbyState.unk44 = 0;
                                func_80122F6C_ovl3(0xC, 9, &gKirbyState, &D_800D6FE8);
                                return 5;
                            }
                        }
                    }
...
? func_80151448_ovl3(void) {
    ...
    if (((gKirbyState.unk34 & 1) != 0) || (D_800D6FAC != 0)) {
        gKirbyState.unkA4 = 0;
...
block_19:
                ...
                if (((D_800D6FEA & 0x4000) != 0) || (1 == gKirbyState.unkA)) {
                    ...
                    if (gKirbyState.unk4 != 0) {
                        ...
                        if (gKirbyState.unkA0 == 0) {
                            if ((gKirbyState.unk90 != 0xC) || (D_80198838 != 0)) {
                                temp_v0 = func_801772CC_ovl3(gKirbyState.unk90, 0x18, gKirbyState.unkA0, 2);
                                temp_a0 = temp_v0;
                                if (temp_v0 != 0xFFFF) {
                                    gKirbyState.unk30 = 0;
                                    gKirbyState.unk16 = (u8)0;
                                    func_80122F6C_ovl3(temp_a0, 0x1A);
                                    return 9;
                                }
                            } else {
...
#else
GLOBAL_ASM("asm/non_matchings/ovl3/ovl3/func_801518E0_ovl3.s")
#endif

#ifdef MIPS_TO_C
//generated by mips_to_c commit 09d006c9da5d6bbcd31ac6ca5c9165c1a8533a83
? func_8015190C_ovl3(void) {
...
#else
GLOBAL_ASM("asm/non_matchings/ovl3/ovl3/func_8015190C_ovl3.s")
#endif

#ifdef MIPS_TO_C
//generated by mips_to_c commit 09d006c9da5d6bbcd31ac6ca5c9165c1a8533a83
? func_80151938_ovl3(void) {
...
#else
GLOBAL_ASM("asm/non_matchings/ovl3/ovl3/func_80151938_ovl3.s")
#endif

#ifdef MIPS_TO_C
//generated by mips_to_c commit 09d006c9da5d6bbcd31ac6ca5c9165c1a8533a83
? func_801519D4_ovl3(s32 arg0, ? arg1) {
    s32 phi_a0;
    ? phi_a1;
    ...
    if ((gKirbyState.unk34 & 1) == 0) {
        if (D_800D6FAC == 0) {
            if (func_80121194_ovl3(phi_a0, phi_a1) != 0) {
...
#else
GLOBAL_ASM("asm/non_matchings/ovl3/ovl3/func_801519D4_ovl3.s")
#endif

#ifdef MIPS_TO_C
//generated by mips_to_c commit 09d006c9da5d6bbcd31ac6ca5c9165c1a8533a83
? func_80151AF4_ovl3(void) {
    if ((D_8012E7F4 & 1) == 0) {
        if ((D_800D6FE8 & 0x300) == 0) {
...
#else
GLOBAL_ASM("asm/non_matchings/ovl3/ovl3/func_80151AF4_ovl3.s")
#endif

#ifdef MIPS_TO_C
//generated by mips_to_c commit 09d006c9da5d6bbcd31ac6ca5c9165c1a8533a83
? func_80151B78_ovl3(void) {
    if (gKirbyState.unk17 != 0) {
