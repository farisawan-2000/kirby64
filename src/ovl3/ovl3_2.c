...
block_35:
            ...
            if ((((temp_a2->objId * 4) + 0x800F0000)->unk-7520 & 6) != 0) {
                ...
                if (temp_v1_5 == 0) {
                    sp1C = 0;
                    func_80122F6C_ovl3(0x17, 0x1B, temp_a2, 0);
                    phi_a3 = 0;
                } else {
                    phi_a3 = 0;
                    if (D_8012E8A4 != 0) {
                ...
                if (func_80122460_ovl3() != 0) {
                    ...
                    func_80122F6C_ovl3(0xA, 0xD, temp_a2_2, D_800E6690);
                } else {
                ...
                phi_a3 = 0;
                if (*0x8012E7F0 != 0) {
                    func_80122F6C_ovl3(6, 6, temp_a2, 0);
                    goto block_35;
                }
            }
        }
        ...
        if (temp_v1_9 == 0) {
            ...
            if ((temp_v1_10 + 0x800F0000)->unk-76E0 != 0) {
                if (((temp_v1_10 + 0x800F0000)->unk-7520 & 6) != 0) {
                    ...
                    func_80122F6C_ovl3(7, 7, temp_a2_3);
                }
            } else {
                func_80122F6C_ovl3(6, 6);
            }
    ...
    if (phi_a3 != 0) {
        ...
        if (temp_a0_2 != 0) {
            gKirbyState.unk17 = 1;
            phi_return = func_80122F6C_ovl3(temp_a0_2, 0x1C);
        }
    }
    return phi_return;
}
...
#ifdef MIPS_TO_C
void func_801580C4_ovl3(void *arg0, f32 arg1) {
    u32 temp_t8;

    if ((arg1 != 0.0f) && (arg1 != ((*arg0 * 4) + 0x800E0000)->unk6A10)) {
...
loop_3:
    ...
    ((temp_v1 * 4) + 0x800E0000)->unk64D0 = D_800E6690[temp_v1];
    ((temp_v0->objId * 4) + 0x800E0000)->unk6850 = D_80196F58;
    if ((gKirbyState.isTurning & 1) != 0) {
loop_5:
        func_8000B6BC(1);
        if ((gKirbyState.isTurning & 1) != 0) {
        ...
        if ((temp_v0 != 3) && (temp_v0 != 4)) {
            if ((gKirbyState.abilityState != 0) && (0x1C != temp_v1)) {
                ...
                if ((temp_v0_2 != 0) && (temp_v0_2 != 0x12)) {
                    ...
                    if (phi_a0 != 0) {
                        func_80122F6C_ovl3(gKirbyState.abilityState, 0x1C);
                        return 1;
                    }
                }
            }
