...
void func_80158B10_ovl3(s32 arg0) {
    ...
    if (temp_a0_2 != 1) {
        ...
        D_800D6FB2 = 1;
        gKirbyState.unk44 = -1;
        assign_new_process_entry(((temp_v1->objId * 4) + 0x800E0000)->unk-1AF0, &D_8022785C);
    }
}
#else
...
void func_80158CA8_ovl3(s32 arg0) {
    ...
    assign_new_process_entry(((temp_v0->objId * 4) + 0x800E0000)->unk-1AF0, &D_8022785C);
}
#else
    ...
    if (temp_a0 != 0) {
        ...
        *temp_v1 = temp_a0_2 - 1;
        if (temp_a0_2 == 0) {
            ...
            assign_new_process_entry(((temp_v0_3->objId * 4) + 0x800E0000)->unk-1AF0, &D_8022785C);
        }
    } else {
