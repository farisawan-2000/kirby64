...
#else
GLOBAL_ASM("asm/non_matchings/ovl19_5/func_8022E630_ovl19.s")
#endif
...
void func_8022ED10_ovl19(s32 arg0) {
    ...
    sp20 = 50.0f;
    func_800A7678_ovl19(0x1F6);
    func_8019F000_ovl19(((((*D_8004A7C4 * 4) + 0x800E0000)->unkD50 * 4) + 0x800F0000)->unk-6560, &sp1C, 0x28, 0xBF59999A);
    ((*D_8004A7C4 * 4) + 0x800E0000)->unk6D90 = (f32) D_8022FAA0;
    *(&D_800E17D0 + (*D_8004A7C4 * 4)) = 0.0f;
    temp_v1 = *D_8004A7C4 * 4;
    (temp_v1 + 0x800E0000)->unk41D0 = (f32) *(&D_800E17D0 + temp_v1);
    ((*D_8004A7C4 * 4) + 0x800E0000)->unk-EB0 = &D_8022EE78;
