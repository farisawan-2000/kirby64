...
void func_800F88C8(s32, s32, s32, f32);
#ifdef MIPS_TO_C
...
void func_8021DFD0_ovl19(void) {
    ...
    func_800F88C8(D_800DE350[D_8004A7C4->objId], D_800E5F90[D_8004A7C4->objId], D_800E6BD0[D_8004A7C4->objId], temp_a3);
...
#ifdef MIPS_TO_C
//generated by mips_to_c commit 3ec45aadfc2cb619035fb802d88c52eacfab0326
void func_8021E5DC_ovl19(struct UnkStruct8004A7C4 *arg0) {
    f32 sp1C;
    f32 *temp_a1;
    f32 temp_f0;
    s32 temp_v0;
...
void func_8021EA40_ovl19(struct UnkStruct8004A7C4 *arg0) {
    ...
    func_800A447C(D_800DDC50[D_8004A7C4->objId], 2, &D_8022F070[0]);
}
