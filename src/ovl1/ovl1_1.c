...
OSThread *func_800A2904(void) {
    ...
    struct ObjThreadStack *temp_v0_4;
    struct UnkStruct8004A7C4 *temp_v0;
    struct UnkStruct8004A7C4 *temp_v0_2;
    struct unkAddr8004A7C8 *temp_v0_5;
    struct unkAddr8004A7C8 *temp_v0_6;
    u32 temp_t6;
    u8 temp_v1;
    void *temp_v0_7;
    ...
    switch (D_8003DE54) {
        case 0:
            func_80022B88_ovl1(&D_800D5A84);
            goto block_19;
        case 1:
            func_80022B88_ovl1(&D_800D5A8C);
            temp_v0 = D_8004A7C4;
            if (temp_v0 != 0) {
                func_80022B88_ovl1(&D_800D5A90, temp_v0->unk14);
                func_800A28C0_ovl1(D_8004A7C4);
                goto block_19;
            }
        case 2:
            func_80022B88_ovl1(&D_800D5A9C);
            temp_v0_2 = D_8004A7C4;
            if (temp_v0_2 != 0) {
                func_80022B88_ovl1(&D_800D5AA0, temp_v0_2);
                temp_v0_3 = D_8004A7D0;
                if (temp_v0_3 != 0) {
                    func_80022B88_ovl1(&D_800D5AAC, temp_v0_3);
                    temp_v0_4 = D_8004A7D0;
                    temp_v1 = temp_v0_4->unk14;
                    if (temp_v1 != 0) {
                        if (temp_v1 != 1) {

                        } else {
                            func_80022B88_ovl1(&D_800D5AF0, temp_v0_4->objThread);
                        }
                    } else {
                        func_80022B88_ovl1(&D_800D5AB4, temp_v0_4->objThread);
                        func_80022B88_ovl1(&D_800D5AC4, D_8004A7D0->objThread->objStack);
                        func_80022B88_ovl1(&D_800D5AD0, D_8004A7D0->objThread->unk8.context.pc);
                        func_80022B88_ovl1(&D_800D5AE0, D_8004A7D0->objThread->unk8.id);
                        func_80022B88_ovl1(&D_800D5AE8, D_8004A7D0->pad);
        ...
        case 3:
            func_80022B88_ovl1(&D_800D5AFC);
            temp_v0_5 = D_8004A7C8;
            if (temp_v0_5 != 0) {
                func_80022B88_ovl1(&D_800D5B04, temp_v0_5->unk2C);
                func_800A28C0_ovl1(D_8004A7C8);
                goto block_19;
            }
        case 4:
            func_80022B88_ovl1(&D_800D5B10);
            temp_v0_6 = D_8004A7C8;
            if (temp_v0_6 != 0) {
                func_80022B88_ovl1(&D_800D5B18, temp_v0_6->unk2C);
            }
            temp_v0_7 = D_8004A7CC;
            if (temp_v0_7 != 0) {
                func_80022B88_ovl1(&D_800D5B28, temp_v0_7->unk2C);
                func_800A28C0_ovl1(D_8004A7CC);
            }
    }
block_19:
    func_80022B88_ovl1(&D_800D5B38, D_80048D88);
    func_80022B88_ovl1(&D_800D5B40, D_80048D8C);
    func_80022B88_ovl1(&D_800D5B48, D_80048D90);
    return sp1C;
} 
#else
