...
#else
GLOBAL_ASM("asm/non_matchings/ovl1/ovl1_1/func_800A2CE4.s")
#endif
...
void *func_800A2E98(void) {
    ...
    D_800D6E88 = D_800D6E4C;
    D_800D6E8C = D_800D6E50;
...
void func_800A30E8(void) {
    func_800A6B20_ovl1(0x13);
    func_80300000_ovl20();
    func_800A6B20_ovl1(5);
    func_800A6B20_ovl1(6);
    func_800A6B20_ovl1(0x11);
}
#else
GLOBAL_ASM("asm/non_matchings/ovl1/ovl1_1/func_800A30E8.s")
#endif
...
void func_800A3128(void) {
    func_800A6B20_ovl1(2);
    func_800A6B20_ovl1(3);
}
#else
GLOBAL_ASM("asm/non_matchings/ovl1/ovl1_1/func_800A3128.s")
#endif
...
#ifdef MIPS_TO_C
//generated by mips_to_c commit e0e006e8858ba357d1dcb4dc64f038b7df278aa6
void func_800A4270(s32 arg0, ? arg1, ? arg2, ? arg3) {

}
#else
GLOBAL_ASM("asm/non_matchings/ovl1/ovl1_1/func_800A4270.s")
#endif
...
#ifdef MIPS_TO_C
//generated by mips_to_c commit e0e006e8858ba357d1dcb4dc64f038b7df278aa6
void *func_800A4414(s32 arg0) {
    void *temp_v0;
    void *temp_v0_2;

    temp_v0_2 = D_800BE5CC;
    if ((*temp_v0_2 & 3) != 0) {
loop_1:
        if ((*temp_v0_2 & 3) != 0) {
            goto loop_1;
...
void func_800A447C(u32 arg0, u32 arg1, void (*arg2[])(struct UnkStruct8004A7C4 *a1)) {
    if (arg0 < arg1) arg2[arg0](D_8004A7C4);
}

#ifdef MIPS_TO_C
//generated by mips_to_c commit e0e006e8858ba357d1dcb4dc64f038b7df278aa6
f32 func_800A44BC(void *arg0, void *arg1) {
    f32 temp_f2;
    f32 phi_f0;

    temp_f2 = ((arg0->unk0 * arg1->unk0) + (arg0->unk4 * arg1->unk4)) + (arg0->unk8 * arg1->unk8);
    if (temp_f2 < 0.0f) {
        phi_f0 = -temp_f2;
    } else {
        phi_f0 = temp_f2;
    }
    if (D_800D5C30 < phi_f0) {
        return temp_f2;
    }
    return 0.0f;
}
#else
GLOBAL_ASM("asm/non_matchings/ovl1/ovl1_1/func_800A44BC.s")
#endif

#ifdef MIPS_TO_C
//generated by mips_to_c commit e0e006e8858ba357d1dcb4dc64f038b7df278aa6
f32 func_800A4534(void *arg0) {
    f32 temp_f12;
    f32 temp_f14;
    f32 temp_f2;
...
#else
GLOBAL_ASM("asm/non_matchings/ovl1/ovl1_1/func_800A4534.s")
#endif

#ifdef MIPS_TO_C
//generated by mips_to_c commit e0e006e8858ba357d1dcb4dc64f038b7df278aa6
f32 func_800A455C(void *arg0, void *arg1) {
    f32 temp_f12;
    f32 temp_f14;
    f32 temp_f2;
...
#else
GLOBAL_ASM("asm/non_matchings/ovl1/ovl1_1/func_800A455C.s")
#endif
...
void func_800A6B20(u32 arg0) {
    while (arg0 >= 0x14) {
        // ...were they going to do anything to remedy this issue?
    }
    load_overlay(D_800BE8A0[arg0]);
}
