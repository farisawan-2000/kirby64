...
OSThread *crash_screen_print_page_3(void) {
    ...
    switch (D_8003DE54) {
        ...
        case 4:
            func_80022B88("DFO\n");
            if (D_8004A7C8 != 0) {
                func_80022B88("cam addr:%x\n", D_8004A7C8->unk2C);
            }
            if (D_8004A7CC != NULL) {
                func_80022B88("disp addr:%x\n", D_8004A7CC->unk2C);
...
void func_8001B4AC_ovl1(Mat4, f32, f32, f32);
void _guRotateRPYF(Mat4, f32, f32, f32);
void func_8001B6E4_ovl1(Mat4, f32, f32, f32);
...
void func_800A4794(Vector *arg0, struct UnkStruct8004A7C4_3C *arg1) {
    ...
    guMtxIdentF_ovl1(&finalMtx);
    do {
        if ((arg1->scaleVec.x != 1.0f) || (arg1->scaleVec.y != 1.0f) || (arg1->scaleVec.z != 1.0f)) {
            func_8001B4AC_ovl1(&intermediateMtx, arg1->scaleVec.x, arg1->scaleVec.y, arg1->scaleVec.z);
            guMtxCatF(&finalMtx, &intermediateMtx, &finalMtx);
        }
        if ((arg1->angleVec.x != 0.0f) || (arg1->angleVec.y != 0.0f) || (arg1->angleVec.z != 0.0f)) {
            _guRotateRPYF(&intermediateMtx, arg1->angleVec.x, arg1->angleVec.y, arg1->angleVec.z);
            guMtxCatF(&finalMtx, &intermediateMtx, &finalMtx);
        }
        if ((arg1->posVec.x != 0.0f) || (arg1->posVec.y != 0.0f) || (arg1->posVec.z != 0.0f)) {
            func_8001B6E4_ovl1(&intermediateMtx, arg1->posVec.x, arg1->posVec.y, arg1->posVec.z);
            guMtxCatF(&finalMtx, &intermediateMtx, &finalMtx);
        }
        arg1 = arg1->unk14;
...
void func_800A4958(Vector *dst, struct UnkStruct8004A7C4_3C *arg1, Vector *src) {
    ...
    do {
        if ((arg1->scaleVec.x != 1.0f) || (arg1->scaleVec.y != 1.0f) || (arg1->scaleVec.z != 1.0f)) {
            func_8001B4AC_ovl1(&sp50, arg1->scaleVec.x, arg1->scaleVec.y, arg1->scaleVec.z);
            guMtxCatF(&sp90, &sp50, &sp90);
        }
        if ((arg1->angleVec.x != 0.0f) || (arg1->angleVec.y != 0.0f) || (arg1->angleVec.z != 0.0f)) {
            _guRotateRPYF(&sp50, arg1->angleVec.x, arg1->angleVec.y, arg1->angleVec.z);
            guMtxCatF(&sp90, &sp50, &sp90);
        }
        if ((arg1->posVec.x != 0.0f) || (arg1->posVec.y != 0.0f) || (arg1->posVec.z != 0.0f)) {
            func_8001B6E4_ovl1(&sp50, arg1->posVec.x, arg1->posVec.y, arg1->posVec.z);
            guMtxCatF(&sp90, &sp50, &sp90);
        }
        arg1 = arg1->unk14;
    } while ((u32)arg1 != 1); // why
...
void func_800A4B34(Vector *dst, struct UnkStruct8004A7C4_3C *arg1) {
    ...
    do {
        if ((arg1->scaleVec.x != 1.0f) || (arg1->scaleVec.y != 1.0f) || (arg1->scaleVec.z != 1.0f)) {
            func_8001B4AC_ovl1(&sp3C, 1.0f / arg1->scaleVec.x, 1.0f / arg1->scaleVec.y, 1.0f / arg1->scaleVec.z);
        ...
        if ((arg1->posVec.x != 0.0f) || (arg1->posVec.y != 0.0f) || (arg1->posVec.z != 0.0f)) {
            func_8001B6E4_ovl1(&sp3C, -arg1->posVec.x, -arg1->posVec.y, -arg1->posVec.z);
            guMtxCatF(&sp3C, &sp7C, &sp7C);
        }
        arg1 = arg1->unk14;
    } while ((u32) arg1 != 1);
...
void func_800A4DB8(Vector *arg0, struct UnkStruct8004A7C4_3C *arg1) {
    ...
    do {
        if ((arg1->angleVec.x != 0.0f) || (arg1->angleVec.y != 0.0f) || (arg1->angleVec.z != 0.0f)) {
            _guRotateRPYF(&sp40, arg1->angleVec.x, arg1->angleVec.y, arg1->angleVec.z);
...
loop_1:
    ...
    if (temp_v0 == 0) {
        ...
        return finish_current_thread(1);
    }
    if (temp_v0 == 1) {
        return finish_current_thread(1);
    }
    ...
    finish_current_thread(1);
    func_800067B8_ovl1();
    temp_ret = finish_current_thread(1);
    D_800D6B24 = 0;
    return temp_ret;
}
#else
