...
void crash_screen_print_gobj_info(struct UnkStruct8004A7C4 *ob) {
...
block_10:
                _guRotateRPYF(&sp40, temp_f0_2, (bitwise s32) phi_s0->unk34, (bitwise s32) phi_s0->unk38);
                guMtxCatF(&sp80, &sp40, &sp80);
            }
        } else {
            goto block_10;
...
loop_3:
    ...
    if (0.0f == temp_f0_2) {
        if (0.0f == phi_s0->unk34) {
            if (0.0f != phi_s0->unk38) {
block_10:
                _guRotateRPYF(&sp50, temp_f0_2, (bitwise s32) phi_s0->unk34, (bitwise s32) phi_s0->unk38);
                guMtxCatF(&sp90, &sp50, &sp90);
            }
        } else {
            goto block_10;
...
block_6:
    ...
    if (0.0f == temp_f0_3) {
        if (0.0f == phi_s0->unk34) {
            if (0.0f != phi_s0->unk38) {
block_10:
                func_800A465C(&sp3C, -temp_f0_3, -phi_s0->unk34, -phi_s0->unk38);
                guMtxCatF(&sp3C, &sp7C, &sp7C);
            }
        } else {
            goto block_10;
...
loop_3:
    ...
    if (0.0f == temp_f0) {
        if (0.0f == phi_s0->unk34) {
            if (0.0f != phi_s0->unk38) {
block_6:
                _guRotateRPYF(&sp40, temp_f0, (bitwise s32) phi_s0->unk34, (bitwise s32) phi_s0->unk38);
                guMtxCatF(&sp80, &sp40, &sp80);
            }
        } else {
            goto block_6;
...
void func_800A5268(void) {
    if (func_8012122C() == 0) {
        D_800D6FE8.buttonHeld = gPlayerControllers->buttonHeld;
        D_800D6FE8.buttonPressed = gPlayerControllers->buttonPressed;
        D_800D6FE8.buttonHeldLong = gPlayerControllers->buttonHeldLong;
        D_800D6FE8.buttonReleased = gPlayerControllers->buttonReleased;
        D_800D6FE8.stickX = gPlayerControllers->stickX;
        D_800D6FE8.stickY = gPlayerControllers->stickY;
    } else {
        D_800D6FE8.buttonHeld = 0;
        D_800D6FE8.buttonPressed = 0;
        D_800D6FE8.buttonHeldLong = 0;
        D_800D6FE8.buttonReleased = 0;
        D_800D6FE8.stickX = 0;
        D_800D6FE8.stickY = 0;
    }
}
