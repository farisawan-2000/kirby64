...
extern f32 D_800D6830;
extern f32 D_800D6834;
extern f32 D_800D6838;
extern f32 D_800D683C;
...
void func_800B531C(s32 arg0) {
    ...
    if (gKirbyState.unk18 == 0) {
        gKirbyState.vel[0] = D_800E64D0[D_8004A7C4->objId];
            ...
            if (gKirbyState.unk160 == 0) {
                if (gKirbyState.unk164 != 0.0f) {
                    if (D_800E8920[D_8004A7C4->objId] != 0) {
                        ...
                        phi_f2 = (gKirbyState.action == 9) ? 0.5f : D_800D6830;
                        if (gKirbyState.unk164 > 0.0f) {
    ...
    if (gEntitiesNextPosYArray[D_8004A7C4->objId] < D_800D683C) {
        D_800E3750[D_8004A7C4->objId] = 0.0f;
        D_800E3210[D_8004A7C4->objId] = D_800E3750[D_8004A7C4->objId];
        D_800E3C90[D_8004A7C4->objId] = D_800D6840;
        func_8011D40C();
        gEntitiesNextPosYArray[D_8004A7C4->objId] = D_800D6844;
    }
    if (gKirbyHp != 0.0f) {
        sp48 = 0x14;
