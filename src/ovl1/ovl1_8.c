...
extern const f32 D_800D6800;
#ifdef NEEDS_RODATA
void func_800B369C(void) {
    gEntitiesNextPosXArray[D_8004A7C4->objId] += D_800E3050[D_8004A7C4->objId];
    if (gEntitiesAngleXArray[D_8004A7C4->objId] >= D_800D6800) {
        gEntitiesAngleXArray[D_8004A7C4->objId] -= D_800D6800;
    }
    ...
    if (gEntitiesAngleYArray[D_8004A7C4->objId] >= D_800D6800) {
        gEntitiesAngleYArray[D_8004A7C4->objId] -= D_800D6800;
    }
    ...
    if (gEntitiesAngleZArray[D_8004A7C4->objId] >= D_800D6800) {
        gEntitiesAngleZArray[D_8004A7C4->objId] -= D_800D6800;
    }
...
extern const f32 D_800D6804;
#ifdef NEEDS_RODATA
void func_800B3838(void) {
    f32 tmp;
    
    tmp = D_800E2090[D_8004A7C4->objId];
    D_800E2090[D_8004A7C4->objId] = D_800E3050[D_8004A7C4->objId] + tmp;
    gEntitiesNextPosXArray[D_8004A7C4->objId] =
        gEntitiesNextPosXArray[D_800E0D50[D_8004A7C4->objId]] + tmp;
    if (gEntitiesAngleXArray[D_8004A7C4->objId] >= D_800D6804) {
        gEntitiesAngleXArray[D_8004A7C4->objId] -= D_800D6804;
    }
    else if (gEntitiesAngleXArray[D_8004A7C4->objId] < 0.0f) {
        gEntitiesAngleXArray[D_8004A7C4->objId] += D_800D6804;
    }

    tmp = D_800E2250[D_8004A7C4->objId];
    D_800E2250[D_8004A7C4->objId] = D_800E3210[D_8004A7C4->objId] + tmp;
    gEntitiesNextPosYArray[D_8004A7C4->objId] =
        gEntitiesNextPosYArray[D_800E0D50[D_8004A7C4->objId]] + tmp;
    if (gEntitiesAngleYArray[D_8004A7C4->objId] >= D_800D6804) {
        gEntitiesAngleYArray[D_8004A7C4->objId] -= D_800D6804;
    }
    else if (gEntitiesAngleYArray[D_8004A7C4->objId] < 0.0f) {
        gEntitiesAngleYArray[D_8004A7C4->objId] += D_800D6804;
    }

    tmp = D_800E2410[D_8004A7C4->objId];
    D_800E2410[D_8004A7C4->objId] = tmp + D_800E33D0[D_8004A7C4->objId];
    gEntitiesNextPosZArray[D_8004A7C4->objId]
        = gEntitiesNextPosZArray[D_800E0D50[D_8004A7C4->objId]] + tmp;
    if (gEntitiesAngleZArray[D_8004A7C4->objId] >= D_800D6804) {
        gEntitiesAngleZArray[D_8004A7C4->objId] -= D_800D6804;
    }
    else if (gEntitiesAngleZArray[D_8004A7C4->objId] < 0.0f) {
        gEntitiesAngleZArray[D_8004A7C4->objId] += D_800D6804;
    }
