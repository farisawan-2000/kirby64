...
void func_800AF9B8(u16 arg0, u8 arg1) {
    ...
    temp_a0 = D_8004A7C4;
    temp_a2 = arg1 & 0xFF;
    func_8000A5FC(D_8004A7C4, D_800D4F10[arg0], arg1, D_800E0810[D_8004A7C4->objId], temp_a2);
}
#else
...
#ifdef MIPS_TO_C
extern const f32 D_800D67D4, D_800D67D8;
void func_800B26D8(Vector *vec, struct UnkStruct8004A7C4_3C *userData, u32 track) {
    Mat4 finalMtx; // 0x90
    Mat4 tmpMtx;
    ...
    if (vec->y == D_800D67D4 || (vec->y == D_800D67D8)) {
        if (vec->y == D_800D67D4) {
