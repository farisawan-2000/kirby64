...
#ifdef MIPS_TO_C
void func_800B1FD0(s32 arg0, s32 arg1, s32 arg2, s32 arg3, f32 arg4) {
    void *temp_v0;
    s32 phi_s2;
    s32 phi_s1;
    s32 s3;
    ...
    if (s5 != 0) {
        do {
            func_8000EC98_ovl1(s0, phi_s2, arg2, phi_s1, 0, arg4, 0.0f, 0.0f, 0.0f);
            s0 = func_800B1F70(s0, s5);
            if (phi_s2 != 0) {
                phi_s2 += 4;
            }
            if (phi_s1 != 0) {
