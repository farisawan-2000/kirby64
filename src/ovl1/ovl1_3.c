...
void func_800A9864(u32 listIndex, u32 arg1, u32 arg2) {
    ...
    temp_a3 = *(D_800D00C4 + ((listIndex >> 0x10) * 4)) + ((listIndex & 0xFFFF) * 4);
    temp_t0 = *temp_a3;
    if (temp_t0 != 0) {
        sp1C = temp_t0;
        D_800DF4D0[D_8004A7C4->objId] = temp_t0;
        ...
        *temp_a3 = temp_v0;
        sp1C = temp_v0;
        D_800DF4D0[D_8004A7C4->objId] = temp_v0;
    }
    func_800A9D64_ovl1(D_8004A7C4->objId);
    temp_f0 = D_800D5DD8;
    phi_f6 = (f32) arg1;
    if (temp_f0 == phi_f6) {
        arg1 = sp1C->unk8;
    ...
    func_800A99E4_ovl1(D_8004A7C4->objId);
    func_800A9A2C_ovl1(D_8004A7C4->objId);
    func_800A9648_ovl1(sp1C);
}
#else
