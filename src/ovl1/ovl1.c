...
#ifdef MIPS_TO_C
s32 func_8009B550(s32 arg0, u32 size) {
    u32 *tmp;
    s32 i;
    ...
    D_800D6AEC = 0;
    for (i = 0; i < arg0; i++) {
        tmp = alloc_with_alignment(size, sizeof(u32));
        if (tmp) {
            tmp[0] = D_800D6AEC;
            D_800D6AEC = tmp;
        }
...
s32 func_8009BD3C(s32 arg0, ? arg1, u16 arg2, s32 arg3, s32 arg4, f32 arg5, f32 arg6, f32 arg7, f32 arg8, f32 arg9, f32 argA, f32 argB, f32 argC, f32 argD, s32 argE, s32 argF) {
    ...
    if (temp_v0 != 0) {
        sp54 = temp_v0;
        func_8009C4E0(temp_v0, 0, arg0 >> 3);
        phi_a0 = sp54;
    }
    return phi_a0;
}
...
s32 func_8009BE54(s32 arg0, s32 arg1, f32 arg2, f32 arg3, f32 arg4, f32 arg5, f32 arg6, f32 arg7) {
    ...
    if (temp_v0_3 != 0) {
        sp54 = temp_v0_3;
        func_8009C4E0(temp_v0_3, 0, arg0 >> 3);
        phi_a0 = sp54;
    }
    return phi_a0;
}
...
void func_8009E834(void *arg0) {
    ...
    for (phi_s2 = 0; phi_s2 < 16; phi_s2++) {
        if ((phi_s3 & 0x10000) == 0) {
            ...
            if (temp_s0 != 0) {
    loop_3:
                temp_v0 = func_8009C4E0(phi_s0, phi_s1, phi_s2);
                if (temp_v0 == *phi_s0) {
                    phi_s1 = phi_s0;
                }
                phi_s0 = temp_v0;
