...
loop_8:
    sp3C = phi_a3;
    temp_a3 = phi_a3;
    temp_v1 = func_800AEC70(0x27, 0x3C, 0x50, phi_a3) * 4;
    ...
    *(&D_800E9E20 + temp_v1) = (s32) (*(&D_800E9E20 + (D_8004A7C4->objId * 4)) * 3);
    ...
    func_800AF9B8(0x28, 0xE, temp_a3);
...
s32 draw_hp_segment(s32 arg0, s32 arg1) {
    ...
    phi_v1 = func_800A8BAC(*(&D_800D53DC + ((gHudDisplayMode * 8) + (arg1 * 4)))) + 0x10;
...
s32 func_800BD208(s32 arg0, s32 arg1) {
    ...
    temp_v1 = func_800A8BAC(*(&D_800D5408 + ((gHudDisplayMode * 8) + (arg1 * 4))));
...
s32 draw_star_segments(s32 arg0, s32 arg1) {
    ...
    temp_v1 = func_800A8BAC(*(&D_800D5434 + ((gHudDisplayMode * 8) + (arg1 * 4))));
    temp_a0 = ((arg0 * 8) + 0x4E34) + &D_800ED510;
    *temp_a0 = (s32) temp_v1->unk10;
    temp_t7 = temp_v1->unk14;
    temp_a0 = temp_a0 + 0x780;
...
s32 func_800BD460(s32 arg0, s32 arg1) {
    ...
    phi_v1 = func_800A8BAC(*(&D_800D5310 + ((gHudDisplayMode * 0x28) + (arg1 * 4)))) + 0x10;
...
loop_4:
            ...
            D_800D6F50 = 0;
            func_800A8934(*(&D_800D52FC + (gHudDisplayMode * 4)), 0x10, 0, &D_800ED510);
            func_800BDB18();
        }
        D_800F4D14 = 0;
    }
...
loop_1:
    ...
    func_800BDD98(temp_a0, temp_a1, 0x40);
    D_800F4D14 = 1;
}
#else
...
loop_2:
    ...
    if (func_800F8560() != 9) {
        ...
        D_800D6E54 = 0;
        D_800D6E90 = 0;
        func_800BDFB8(&D_800D5310 + 0x5310, ((gHudDisplayMode * 4) + gHudDisplayMode) * 2, 0xA);
    }
    func_800BDFB8(&D_800D53DC, gHudDisplayMode * 2, 2);
    func_800BDFB8(&D_800D5408, gHudDisplayMode * 2, 2);
    func_800BDFB8(&D_800D5434, gHudDisplayMode * 2, 2);
    func_800BDFB8(&D_800D5460, ((gHudDisplayMode * 4) + gHudDisplayMode) * 2, 0xA);
