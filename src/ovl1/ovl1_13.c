...
extern s32 D_800D5460[][0xa];

#ifdef MIPS_TO_C
//generated by mips_to_c commit e0e006e8858ba357d1dcb4dc64f038b7df278aa6
s32 draw_lives_digit(s32 arg0, s32 arg1) {
    s32 temp_a1;
    void *temp_a0;
    void *temp_v1;
    void *phi_v1;
    ...
    phi_v1 = func_800A8BAC_ovl1(D_800D5460[D_800D6BB0][arg1]) + 0x10;
...
void draw_kirby_stars(s32 arg0) {
    ...
    for (i = 0; i != 30; i++) {
        if (i < arg0) {
            func_800BD374_ovl1(i, 1);
        } else {
            func_800BD374_ovl1(i, 0);
        }
    }
}
...
void draw_kirby_lives(void) {
    ...
    if (D_800D6EA0 != D_800D6E88) {
        ...
        draw_lives_digit(0x22, temp_a2 / 10, temp_a2);
...
void func_800BDB18(void) {
    ...
    draw_kirby_stars(D_800D6E60);
    D_800D6E98 = D_800D6EB0 = D_800D6E60;
}
