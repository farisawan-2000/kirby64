...
loop_1:
        ...
        if (temp_a0->unk10 != 0) {
            ...
            if (temp_v0 != 0) {
                if ((temp_v0 < 0) && (func_800BAA64_ovl1(temp_a0) != 0)) {
block_5:
                    func_800BAA04_ovl1(arg0, phi_s0);
                    phi_s0_2 = arg0->unk4;
                } else {
...
loop_2:
        if (phi_s2->unk4->unk0->unk10 != 0) {
            func_800BAAE4_ovl1(phi_s2);
            temp_s1 = phi_s2->unk4;
            temp_s0 = temp_s1->unk0;
            if (func_800BAB68_ovl1(phi_s2, temp_s0, phi_s3) == 0) {
                func_800BA7A0_ovl1(phi_s2, temp_s0, phi_s3);
                ...
                phi_s1 = temp_s1_2;
                while (temp_s1_2 != 0) {
                    temp_s0_2 = temp_s1_2->unk0;
                    if (temp_s0_2->unk10 != 0) {
                        func_800BA90C_ovl1(phi_s2, temp_s0_2);
                        temp_v0_2 = temp_s0_2->unk8;
                        temp_s0_2->unk2 -= 1;
                        if (temp_s0_2->unk8 > 0) {
                            temp_s0_2->unk8 -= 1;
                        }
                        temp_s1_2 = temp_s1_2->unk4;
                    }
                }
            }
        }
...
loop_1:
        ...
        if ((temp_v1->unk10 != 0) && (arg1 == temp_v1->unk0)) {
            if (arg2 == 0) {
                temp_v1->unk4 = 0;
                temp_v1->unk2 = 0;
                temp_v1->unk10 = ((arg1 * 4) + 0x800D0000)->unk5238;
                return 1;
            }
...
void func_800BB08C(s32 arg0, s32 arg1, s32 arg2) {
    ...
    if (D_800ED4C0 != 0) {
        ...
        sp1C = temp_a0;
        if (func_800BAEB0_ovl1(temp_a0) == 0) {
            temp_v0 = func_800BAF50_ovl1(temp_a0, arg1);
            if (temp_v0 != 0) {
                if (arg2 == 0) {
                    temp_v0->unk8 = -1;
                } else {
                ...
                temp_v0->unkC = 0;
                temp_v0->unk0 = arg1;
                temp_v0->unk10 = ((arg1 * 4) + 0x800D0000)->unk5238;
            }
        }
    }
}
...
loop_2:
            ...
            if (temp_v0->unk10 != 0) {
                if (arg1 == temp_v0->unk0) {
                    func_800BAA04_ovl1(temp_s1, phi_s0);
        ...
        func_800BAB68_ovl1(temp_s1, *phi_v1, arg0);
    }
}
#else
...
void func_800BB468(s32 arg0, ? arg1) {
    func_800BB364_ovl1(D_800ED4C4, arg0, arg1);
}
#else
...
void func_800BB4BC(s32 arg0) {
    func_800BB3C0_ovl1(D_800ED4C4, arg0);
}
#else
...
#ifdef MIPS_TO_C
//generated by mips_to_c commit 3ec45aadfc2cb619035fb802d88c52eacfab0326
void func_800BB4E4(s32 arg0) {
    func_800BB364_ovl1((arg0 + 0x80050000)->unk-7164, arg0);
}
#else
GLOBAL_ASM("asm/non_matchings/ovl1/ovl1_10/func_800BB4E4.s")
#endif

#ifdef MIPS_TO_C
//generated by mips_to_c commit 3ec45aadfc2cb619035fb802d88c52eacfab0326
void func_800BB510(s32 arg0) {
    func_800BB394_ovl1((arg0 + 0x80050000)->unk-7164, arg0);
}
#else
GLOBAL_ASM("asm/non_matchings/ovl1/ovl1_10/func_800BB510.s")
#endif

#ifdef MIPS_TO_C
//generated by mips_to_c commit 3ec45aadfc2cb619035fb802d88c52eacfab0326
void func_800BB53C(s32 arg0) {
    func_800BB3C0_ovl1((arg0 + 0x80050000)->unk-7164, arg0);
}
#else
GLOBAL_ASM("asm/non_matchings/ovl1/ovl1_10/func_800BB53C.s")
#endif
