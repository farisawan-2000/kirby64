...
? func_80151138(s32 arg0) {
    ...
    if (temp_v1 == gFrameBuffers.unk0) {
        phi_v1 = 1;
    } else if (temp_v1 == gFrameBuffers.unk4) {
        phi_v1 = 2;
    } else {
        if (temp_v1 == gFrameBuffers.unk8) {
...
block_2:
        ...
        if (temp_a0 != 0) {
            arg0 = temp_a2;
            func_800ACB7C_ovl6(temp_a0, temp_a1, temp_a2);
            phi_a2 = arg0;
        }
    ...
    func_800B1900_ovl6(temp_a2 & 0xFFFF, temp_a1, temp_a2);
...
void func_8015370C(void) {
    D_800D799C->unk3C->unk84 = D_8015A560->unk4;
}
#else
...
void func_80153C28(void) {
    ...
    if ((D_8015A690 == 0) && (temp_a0 != 0)) {
        sp1C = temp_a0;
        func_80008A18_ovl6(temp_a0, &D_80153B34, 1, 3);
...
#ifdef MIPS_TO_C
struct UnkStruct8004A7C4 **func_80153D10(void) {
    struct UnkStruct8004A7C4 *sp1C;
...
void *func_80153F2C(void) {
    ...
    sp34 = D_8004A7C4;
    temp_a1 = D_8015A560->unk3;
    temp_v0_2 = func_800AEC70_ovl6(0x11, temp_a1, temp_a1 + 1);
    temp_v1 = temp_v0_2 * 4;
    ...
    sp24 = temp_v0_3;
    func_80008DA8_ovl6((temp_v0_3 + 0x800E0000)->unk-1930);
    func_80008DA8_ovl6((sp24 + 0x800E0000)->unk-13F0);
    temp_v0_4 = D_8015A560;
    (sp24 + 0x800E0000)->unk2D0 = temp_v0_4->unk4;
    temp_v0 = func_800AC954_ovl6(D_8004A7C4, 1, func_800A8C40_ovl6(temp_v0_4->unk4));
    sp30 = temp_v0;
...
void func_801546D8(void) {
    ...
    if (temp_v1 != 0) {
        ...
        temp_t5 = (temp_v0->unk58 << 0x18) | (temp_v0->unk59 << 0x10) | (temp_v0->unk5A << 8) | 0xFF;
...
void func_80154858(void) {
    ...
    if (temp_a0 != 0) {
        D_8015A684 = 4;
        D_8015A688 = func_80008A18_ovl6(temp_a0, &D_80154810, 1, 3);
    }
}
#else
