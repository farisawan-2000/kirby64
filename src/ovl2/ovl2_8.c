...
#ifdef MIPS_TO_C
void func_8011D0FC_ovl2(struct Animation *anim, s32 arg1, f32 arg2) {
    f32 sp44;
    void *sp3C;
    f32 sp38;
    f32 sp20;
    ...
    temp_a3 = anim;
    if (temp_t6 < 0x10U) {
        goto **(&jtbl_80128EB0 + (temp_t6 * 4));
    case 11:
        func_800BB468_ovl2(arg2, (u32) arg2, 0, temp_a3);
        return;
    case 14:
        sp44 = arg2;
        temp_a0 = (bitwise s32) sp44;
        if (temp_a0 >= 0) {
            if (temp_a0 != 5) {
                if (temp_a0 != 6) {
                    if (temp_a0 != 0x267) {
                    ...
                    case 15:
                        ...
                        temp_a1 = temp_v0_2 & 0xFFFF;
                        if (temp_a1 < 0) {
                            return;
                            return;
                        }
                        anim = temp_a3;
                        temp_v0_3 = func_800A19EC(arg2, temp_v0_2 >> 0x10, temp_a1, temp_a3);
                        if (temp_v0_3 == 0) {
                            return;
                            return;
                        }
                        if (temp_v0_3->unk4C == 0) {
                            temp_v0_3->unk48 = anim;
                            return;
                        case 1:
                            temp_v0_4 = (*D_8004A7C4 * 4) + &D_800DD8D0;
                            *temp_v0_4 = (s32) (*temp_v0_4 | 0x40000000);
                            return;
                        case 0:
                            temp_v0_5 = (*D_8004A7C4 * 4) + &D_800DD8D0;
                            *temp_v0_5 = (s32) (*temp_v0_5 | 0x80000000);
                            return;
                        }
                        sp3C = temp_v0_3;
                        func_800B2340_ovl2(&sp20, anim, 0xFFFF, anim);
                        temp_v0_3->unk4C->unk4 = sp20;
                        temp_v0_3->unk4C->unk8 = sp24;
                        temp_v0_3->unk4C->unkC = sp28;
                        return;
                        return;
                        return;
                    }
            ...
            temp_v0 = (*D_8004A7C4 * 4) + &D_800E8AE0;
            if ((temp_v0 & 7) == 0) {
                if (D_800D6FB2 != 2) {
                    if (gKirbyState.unk7 != 0) {
                        func_800A7678_ovl2(arg2, *(&D_80128446 + (gKirbyState.unk10A * 0x1C)), temp_a3);
                        return;
                        return;
                    }
                    func_800A7678_ovl2(arg2, ((gKirbyState.unk10A * 0x1C) + 0x80130000)->unk-7BBC, temp_a3);
                    return;
                }
                if (gKirbyState.unk7 == 0) {
                    func_800A7678_ovl2(arg2, 8, temp_a3);
                    return;
                }
                func_800A7678_ovl2(arg2, 7, temp_a3);
                return;
            }
            if ((temp_v0 & 2) == 0) {
                func_800A7678_ovl2(arg2, 9, temp_a3);
                return;
            }
            func_800A7678_ovl2(arg2, 0x10C, temp_a3);
            return;
        }
    } else {
    default:
        temp_v0_6 = &D_800DF310 + (*D_8004A7C4 * 4);
        if (*temp_v0_6 != 0) {
            *temp_v0_6(arg2, temp_a3, arg2, temp_a3);
        }
    }
}
#else
...
void func_80122F6C_ovl2(s32 arg0, s32 arg1) {
    if (arg0 != 0xFFFF) {
        gKirbyState.actionChange = arg0;
        gKirbyState.unk6 = gKirbyState.unk5;
        gKirbyState.unk5 = arg1;
    }
}

void func_80122F94_ovl2(s32 arg0, u32 arg1) {
    gKirbyState.actionChange = arg0;
    gKirbyState.unk6 = gKirbyState.unk5;
    gKirbyState.unk5 = arg1;
}
