...
void *func_8011C8F8(void) {
    ...
    gKirbyState.isTurning = (s32) (0 & 0xFF);
...
f32 func_8011E548_ovl2(void) {
    ...
    if ((gKirbyState.isTurning & 0x8000) == 0) {
        phi_return = (bitwise f32) gKirbyState.isTurning;
        if ((gKirbyState.isTurning & 1) != 0) {
            ...
            if (gKirbyState.turnDirection == 0) {
                ...
                *temp_v0 = (f32) -*temp_v0;
                gKirbyState.turnDirection = (s32) *(&D_800E6A10 + (*D_8004A7C4 * 4));
...
block_18:
            ...
            if (-1.0f == (f32) gKirbyState.turnDirection) {
...
block_35:
            ...
            *(&D_800E41D0 + temp_v1_2) = (f32) *(&D_800E17D0 + temp_v1_2);
            gKirbyState.isTurning = (s32) (gKirbyState.isTurning & -2);
        }
    }
    return phi_return;
}
