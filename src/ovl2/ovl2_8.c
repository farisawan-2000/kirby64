...
void *func_8011CFF4(s32 arg0) {
    ...
    if (gKirbyState != -1) {
        ...
        gKirbyState = -1;
        if (D_800D6FB2 == 2) {
            return func_800B1EC8(((*D_8004A7C4 * 4) + 0x800E0000)->unk-1AF0, &D_8022947C);
        }
        phi_return = func_800B1EC8(((*D_8004A7C4 * 4) + 0x800E0000)->unk-1AF0, &D_8016C510);
    }
    return phi_return;
}
#else
...
void func_80122FB0(s32 arg0) {
    ...
    func_800B1EC8(((*D_8004A7C4 * 4) + 0x800E0000)->unk-1770, &D_80177098);
}
#else
