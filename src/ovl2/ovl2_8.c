    ...
    case 14:
        ...
        if (temp_a0 >= 0) {
            if (temp_a0 != 5) {
                if (temp_a0 != 6) {
                    if (temp_a0 != 0x267) {
                        func_800A7678(arg2, temp_a0, temp_a3);
                         return;
                    case 15:
                        sp38 = arg2;
            ...
            if ((temp_v0 & 7) == 0) {
                if (D_800D6FB2 != 2) {
                    if (gKirbyState.unk7 != 0) {
                        func_800A7678(arg2, *(&D_80128446 + (gKirbyState.unk10A * 0x1C)), temp_a3);
                        return;
                        return;
                    }
                    func_800A7678(arg2, ((gKirbyState.unk10A * 0x1C) + 0x80130000)->unk-7BBC, temp_a3);
                    return;
                }
                if (gKirbyState.unk7 == 0) {
                    func_800A7678(arg2, 8, temp_a3);
                    return;
                }
                func_800A7678(arg2, 7, temp_a3);
                return;
            }
            if ((temp_v0 & 2) == 0) {
                func_800A7678(arg2, 9, temp_a3);
                return;
            }
            func_800A7678(arg2, 0x10C, temp_a3);
            return;
        }
    } else {
    default:
