...
// TOOD: fix loop
#ifdef MIPS_TO_C
void func_800F6AD4(u32 arg0, s32 arg1) {
    u32 i;

    D_800D6B70 = arg0;
    D_80123EC0.unkC = &D_8012EB00;
    func_80007BA4_ovl2(&D_80123EC0);
    // i = 0;
    for (i = &gFrameBuffer; i != 0x803FC100; i++) {
        gFrameBuffer[0x1F80 + i] = 0x0001;
        gFrameBuffer[i] = 0x0001;
        // gFrameBuffer[0x1F80 + i + 1] = 0x0001;
        // gFrameBuffer[i + 1] = 0x0001;
        // gFrameBuffer[0x1F80 + i + 2] = 0x0001;
        // gFrameBuffer[i + 2] = 0x0001;
        // gFrameBuffer[0x1F80 + i + 3] = 0x0001;
        // gFrameBuffer[i + 3] = 0x0001;
    }
    D_80123F68[16] = gFrameBuffer - D_8022FB50;
    D_80123EEC = gFrameBuffer - D_8022FB50;
    D_800D6FA8 = 0;
    D_8012D920 = 0;
    D_800D6FAC = 0;
    D_800D7B7C = 0;
    D_800D7B80 = 0;
    D_800D7B78 = 0;
    func_800A41B0_ovl2(2.0f, &D_800D7B7C);//, &D_803FC100);
    if (D_800BE500 == 6 && D_800BE504 == 0 && D_800BE534 == 2) {
        func_80007380_ovl2(&D_80123F68);
    } else {
        func_80007380_ovl2(&D_80123EDC);
    }
