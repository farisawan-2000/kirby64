...
u16 func_80101400_ovl2(u16 arg0) {
    ...
    struct CollisionStateUnk30 *phi_v1;
    s32 phi_a3;
    s32 phi_a1;
    u16 phi_s0;
    s32 phi_a1_2;
    ...
    s32 phi_t0;
    struct CollisionStateUnk30 *phi_t1;
    f32 phi_f2;
    f32 phi_f0;
    f32 phi_f2_2;
    u16 phi_a0;
    ...
    struct CollisionState *phi_t1_2;
    ? *phi_t3_3;
    struct CollisionState *phi_t4_3;

    spA0 = gCollisionState->unk8;
    spA4 = gCollisionState->unkC;
    spA8 = gCollisionState->unk10;
    sp94 = gCollisionState->unk14;
    sp98 = gCollisionState->unk18;
    sp9C = gCollisionState->unk1C;
    phi_v1 = gCollisionState->unk30->unk4;
    phi_a3 = gCollisionState->unk30->unk14;
    phi_a1 = gCollisionState->unk30->unk24;
    phi_s0 = arg0;
...
block_33:
                                                                            ...
                                                                            if (phi_a2->unk44(temp_a0->unk4, temp_a0->unk8, temp_a0, phi_a1_2, phi_a2, phi_a3_2) != 0) {
                                                                                ...
                                                                                temp_f0_2 = ((temp_a0->unk0 * gCollisionState->unk20) + (temp_a0->unk4 * gCollisionState->unk24)) + (temp_a0->unk8 * gCollisionState->unk28);
                                                                                if (temp_f0_2 < 0.0f) {
                                                                                    phi_f2 = -temp_f0_2;
                                                                                } else {
                                                                                    phi_f2 = temp_f0_2;
...
block_28:
        temp_s4 = *arg1 * 2;
        if (!(phi_f14 < phi_f12)) {
            phi_s2_3 = gCollisionState->unk30->unk1C + temp_s4;
            phi_s4_3 = temp_s4;
            phi_s7_3 = *arg1;
loop_57:
            temp_t5 = *phi_s2_3;
            temp_t6 = gCollisionState->unk30->unk4 + ((temp_t5 & 0x7FFF) * 0x14);
            sp64 = temp_t6;
            if (temp_t6 == arg3) {
block_70:
                if ((temp_t5 & 0x8000) != 0) {
            ...
            if (gCollisionState->unk30->unk0 != 0) {
                temp_a0 = gCollisionState->unk30->unkC + (temp_t6->unk0 * 0xC);
                temp_a1 = gCollisionState->unk30->unkC + (temp_t6->unk2 * 0xC);
                temp_a2 = gCollisionState->unk30->unkC + (temp_t6->unk4 * 0xC);
                ...
                temp_a2_2 = gCollisionState->unk30->unkC + (temp_t6->unk0 * 6);
                temp_a3 = gCollisionState->unk30->unkC + (temp_t6->unk2 * 6);
                temp_t0 = gCollisionState->unk30->unkC + (temp_t6->unk4 * 6);
...
block_47:
        ...
        temp_a0_2 = gCollisionState->unk30->unkC + (temp_s5->unk0 * 0xC);
