...
u32 func_80101920_ovl2(struct CollisionTriangle *arg0, struct Normal *arg1, Vector *arg2, struct Normal *arg3) {
    if (!(arg0->normalType & NON_SOLID)) {
        if ((arg0->normalType & NO_SHADOW) && (D_8012BD00 >> 0x1F) == 0) {
            return 0;
        }
        if (arg0->normalType & (FORWARD_NORMAL | BACKWARD_NORMAL)) {
            if (arg0->normalType == (FORWARD_NORMAL | BACKWARD_NORMAL) && arg3 && arg2) {
            ...
            else if (arg0->normalType & FORWARD_NORMAL) {
...
u32 func_80101D50_ovl2(struct CollisionTriangle *arg0, u32 arg1, u32 arg2, u32 arg3) {
    if (!(arg0->normalType & NON_SOLID)) {
        if ((arg0->normalType & (FORWARD_NORMAL | BACKWARD_NORMAL))) {
...
u8 func_80101E5C_ovl2(struct CollisionTriangle *arg0, struct Normal *arg1, struct Normal *arg2, u32 arg3) {
    if ((arg0->normalType & NON_SOLID)) {
...
u8 func_80101F4C_ovl2(struct CollisionTriangle *arg0, struct Normal *arg1, struct Normal *arg2, u32 arg3) {
    if (arg0->normalType & NON_SOLID) {
...
#ifdef MIPS_TO_C
u32 func_80102364_ovl2(struct Normal *arg0, s32 arg1) {
    if (!(ABSF(arg0->y) <= 0.5f)) {
        if (gCollisionState->someNormal) {
            return 1;
        }
        if (0.0f < (gCollisionState->someNormal->y * arg0->y)) {
            if (arg1 == 0) {
                return 1;
            }
        } else {
        ...
        if (temp_t1 == 0) {
            ...
            if (sp64 != arg1->unkC) {
                ...
                if (sp54 < temp_f10) {
                    ...
                    sp58 = temp_t1;
                    phi_t0 = 0;
                    if (func_80108858(&D_8012BD34, &sp74, arg1->unkC, 0x3F800000) != 0) {
                        phi_t0 = 1;
                    }
                }
            }
