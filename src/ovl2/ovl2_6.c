...
block_7:
                            if (-temp_a0->originOffset == phi_v1->originOffset) {
                                if (-1.0f == (((temp_f0 * temp_a0->x) + (phi_v1->y * temp_a0->y)) + (phi_v1->z * temp_a0->z))) {
block_9:
                                    if (temp_t2->unk2 != 0) {
                                        if (temp_t2->unk4 != 0) {
                                            *(phi_t3_2 + (phi_t0 * 2)) = (u16) temp_t2->unk4;
                                            // phi_v1 = phi_a2->unk30->header;
                                            // phi_a3 = phi_t1->unk14;
...
block_15:
                                    temp_f18 = (((temp_a0->x * spA0[0]) + (temp_a0->y * spA0[1])) + (temp_a0->z * spA0[2])) + temp_a0->originOffset;
                                    temp_f20 = (((temp_a0->x * sp94[0]) + (temp_a0->y * sp94[1])) + (temp_a0->z * sp94[2])) + temp_a0->originOffset;
                                    phi_a1_2 = 0;
                                    if (0.0f < temp_f18) {
                                        phi_a1_2 = 1;
                                    }
                                                    ...
                                                    if (temp_a0->x == temp_v0->x) {
                                                        if (temp_a0->y == temp_v0->y) {
                                                            if (temp_a0->z == temp_v0->z) {
                                                                phi_t3 = phi_t3_2;
                                                                phi_t4_2 = phi_t4_3;
                                                                if (temp_a0->originOffset != temp_v0->originOffset) {
block_31:
                                                                    if (-temp_a0->originOffset == temp_v0->originOffset) {
                                                                        phi_t3 = phi_t3_2;
                                                                        phi_t4_2 = phi_t4_3;
                                                                        if (-1.0f != (((temp_v0->x * temp_a0->x) + (temp_v0->y * temp_a0->y)) + (temp_v0->z * temp_a0->z))) {
block_33:
                                                                            sp88 = temp_a0;
                                                                            sp70 = phi_a1_2;
                                                                            sp6C = phi_a3_2;
                                                                            ...
                                                                            if (phi_a2->unk44(temp_a0, temp_a0->originOffset) != 0) {
                                                                                temp_v0_2 = gCollisionState->unk4 + (gCollisionState->unk0 * 8);
                                                                                temp_f0_2 = ((temp_a0->x * gCollisionState->unkPos[0]) + (temp_a0->y * gCollisionState->unkPos[1])) + (temp_a0->z * gCollisionState->unkPos[2]);
                                                                                if (temp_f0_2 < 0.0f) {
                                                                                    phi_f2 = -temp_f0_2;
                                                                                } else {
                                                                                    phi_f2 = temp_f0_2;
                                                                                ...
                                                                                gCollisionState->unk0 = (s32) (gCollisionState->unk0 + 1);
                                                                                phi_t3 = &spB0;
                                                                                phi_t4_2 = &gCollisionState;
                                                                            }
                                                                        }
...
? func_8010203C_ovl2(void *arg0, void *arg1, void *arg2, ? arg3) {
    ...
    if ((arg0->unk8 & 3) != 0) {
        if (gCollisionState->unk4A == arg0->unk12) {
            arg2 = temp_a3;
            sp24 = (s32) arg0->unk8;
            if (func_8011BED0_ovl2(gCollisionState->unk4A, arg0->unk10, gCollisionState->unk4C, temp_a3) != 0) {
                if ((arg0->unk8 & 1) != 0) {
                    if (arg2 == 0) {
block_10:
                        return 1;
...
? func_801023FC_ovl2(void *arg0, s32 arg1) {
    ...
    if (phi_f2 <= 0.5f) {
        ...
        temp_f0 = (gCollisionState->unk2C->unk0 * arg0->unk0) + (gCollisionState->unk2C->unk8 * arg0->unk8);
        if (temp_f0 < 0.0f) {
            phi_f2_2 = -temp_f0;
        } else {
            phi_f2_2 = temp_f0;
...
? func_801024E8_ovl2(void *arg0, s32 arg1) {
    ...
    if (0.0f < (((gCollisionState->unk2C->unk0 * arg0->unk0) + (gCollisionState->unk2C->unk4 * arg0->unk4)) + (gCollisionState->unk2C->unk8 * arg0->unk8))) {
        if (arg1 == 0) {
            return 1;
        }
    } else {
...
block_28:
        if (!(phi_f14 < phi_f12)) {
            ...
            phi_s7_3 = *arg1;
loop_57:
            temp_t6 = gCollisionState->unk30->Triangles[(gCollisionState->unk30->header.Triangle_Cells[*arg1 * 2] & 0x7FFF) * 0x14];
            sp64 = temp_t6;
            if (temp_t6 == arg3) {
block_70:
                if ((temp_t5 & 0x8000) != 0) {
            ...
            if (gCollisionState->unk30->using32BitVertices != 0) {
                ...
                phi_f20_2 = ((temp_a1[0] - temp_a0[0]) * (currPos[1] - temp_a0[1])) - ((currPos[0] - temp_a0->x) * (temp_a1->y - temp_a0->y));
                phi_f22_2 = ((temp_a2[0] - temp_a1[0]) * (currPos[1] - temp_a1[1])) - ((currPos[0] - temp_a1->x) * (temp_a2->y - temp_a1->y));
                ...
                phi_f20_2 = ((f32) (temp_a3[0] - vertex0[0]) * (currPos[1] - (f32) vertex0[1])) - ((currPos->[0] - (f32) vertex0[0]) * (f32) (temp_a3[1] - vertex0[1]));
                phi_f22_2 = ((f32) (temp_t0[0] - temp_a3[0]) * (currPos[1] - (f32) temp_a3[1])) - ((currPos->[0] - (f32) temp_a3[0]) * (f32) (temp_t0[1] - temp_a3[1]));
...
block_53:
        ...
        if (gCollisionState->unk30->using32BitVertices == 0) {
            ...
            temp_f20 = ((f32) (temp_a3_2->unk0 - temp_a2_3->unk0) * (currPos->unk8 - (f32) temp_a2_3->unk4)) - ((currPos->unk0 - (f32) temp_a2_3->unk0) * (f32) (temp_a3_2->unk4 - temp_a2_3->unk4));
            temp_f22 = ((f32) (temp_t0_2->unk0 - temp_a3_2->unk0) * (currPos->unk8 - (f32) temp_a3_2->unk4)) - ((currPos->unk0 - (f32) temp_a3_2->unk0) * (f32) (temp_t0_2->unk4 - temp_a3_2->unk4));
            if (temp_f20 <= 0.5f) {
                if (temp_f22 <= 0.5f) {
                    if ((((f32) (temp_a2_3->unk0 - temp_t0_2->unk0) * (currPos->unk8 - (f32) temp_t0_2->unk4)) - ((currPos->unk0 - (f32) temp_t0_2->unk0) * (f32) (temp_a2_3->unk4 - temp_t0_2->unk4))) <= 0.5f) {
                        *arg4 = temp_s5;
...
block_47:
                    if (-0.5f <= temp_f20) {
                        if (-0.5f <= temp_f22) {
                            if (-0.5f <= (((f32) (temp_a2_3->unk0 - temp_t0_2->unk0) * (currPos->unk8 - (f32) temp_t0_2->unk4)) - ((currPos->unk0 - (f32) temp_t0_2->unk0) * (f32) (temp_a2_3->unk4 - temp_t0_2->unk4)))) {
                                *arg4 = temp_s5;
                                if ((*(gCollisionState->unk30->unk1C + phi_s4_2) & 0x8000) == 0) {
                                    *arg1 = phi_s7_2;
                                    return 1;
        ...
        temp_f20_2 = ((temp_a1_2->unk0 - vertex0_2->unk0) * (currPos->unk8 - vertex0_2->unk8)) - ((currPos->unk0 - vertex0_2->unk0) * (temp_a1_2->unk8 - vertex0_2->unk8));
        temp_f22_2 = ((temp_a2_4->unk0 - temp_a1_2->unk0) * (currPos->unk8 - temp_a1_2->unk8)) - ((currPos->unk0 - temp_a1_2->unk0) * (temp_a2_4->unk8 - temp_a1_2->unk8));
        temp_f28_2 = ((vertex0_2->unk0 - temp_a2_4->unk0) * (currPos->unk8 - temp_a2_4->unk8)) - ((currPos->unk0 - temp_a2_4->unk0) * (vertex0_2->unk8 - temp_a2_4->unk8));
        if (temp_f20_2 <= 0.5f) {
            if (temp_f22_2 <= 0.5f) {
                if (!(temp_f28_2 <= 0.5f)) {
block_35:
...
block_25:
    ...
    if (gCollisionState->unk30->using32BitVertices != 0) {
        ...
        phi_f20 = ((temp_a1_3->unk4 - temp_a0_3->unk4) * (currPos->unk8 - temp_a0_3->unk8)) - ((currPos->unk4 - temp_a0_3->unk4) * (temp_a1_3->unk8 - temp_a0_3->unk8));
        phi_f22 = ((temp_a2_5->unk4 - temp_a1_3->unk4) * (currPos->unk8 - temp_a1_3->unk8)) - ((currPos->unk4 - temp_a1_3->unk4) * (temp_a2_5->unk8 - temp_a1_3->unk8));
        ...
        phi_f20 = ((f32) (temp_a3_3->unk2 - temp_a2_6->unk2) * (currPos->unk8 - (f32) temp_a2_6->unk4)) - ((currPos->unk4 - (f32) temp_a2_6->unk2) * (f32) (temp_a3_3->unk4 - temp_a2_6->unk4));
        phi_f22 = ((f32) (temp_t0_3->unk2 - temp_a3_3->unk2) * (currPos->unk8 - (f32) temp_a3_3->unk4)) - ((currPos->unk4 - (f32) temp_a3_3->unk2) * (f32) (temp_t0_3->unk4 - temp_a3_3->unk4));
...
? func_80103004(void *arg0, void *arg1, void *arg2, void *arg3) {
    ...
    if (0.0f == gCollisionState->unk20) {
        if (0.0f == gCollisionState->unk24) {
            if (0.0f == gCollisionState->unk28) {
...
loop_6:
            if ((phi_s0->unk2 & 1) == 0) {
                ...
                if (func_801033A8_ovl2(phi_f12, phi_s0, gCollisionState + 8, gCollisionState + 0x14) != 0) {
