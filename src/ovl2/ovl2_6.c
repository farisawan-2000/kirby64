...
u32 func_80101920_ovl2(struct CollisionTriangle *arg0, struct Normal *arg1, Vector *arg2, struct Normal *arg3) {
    ...
    if (!(temp_v0 & NON_SOLID)) {
        if ((temp_v0 & NO_SHADOW) && (D_8012BD00 >> 0x1F) == 0) {
            return 0;
        }
        // temp_v0 & (FORWARD_NORMAL | BACKWARD_NORMAL);
        if (temp_v0 & (FORWARD_NORMAL | BACKWARD_NORMAL)) {
            if (temp_v0 == (FORWARD_NORMAL | BACKWARD_NORMAL) && arg3 && arg2) {
            ...
            else if (temp_v0 & FORWARD_NORMAL) {
                if (arg2 && !(0.0f < VEC_DOT(arg1, arg2))) {
                    return 0;
                }
                else if (arg3 && 0.0f < VEC_DOT(arg1, arg3)) {
                    return 0;
                }
            } else {
                ...
                else if (arg3 && 0.0f < VEC_DOT_FIRST_ARG_NEGATE(arg1, arg3)) {
                    return 0;
                }
            }
            return 1;
...
#ifdef MIPS_TO_C
// generated by mips_to_c commit 09d006c9da5d6bbcd31ac6ca5c9165c1a8533a83
void func_80103528(void *arg0, void *arg1, ? arg2, ? arg3, void *arg4) {
    f32 spAC;
    f32 spA8;
    f32 sp9C;
    ? sp90;
...
extern u32 func_801024E8_ovl2(struct Normal *a0, s32 arg1);
...
void func_80103DE4_ovl2(Vector *arg0, Vector *arg1, struct Normal *arg2, struct Normal *arg3, s32 arg4,
...
#ifdef MIPS_TO_C
// generated by mips_to_c commit 09d006c9da5d6bbcd31ac6ca5c9165c1a8533a83
f32 func_8010F964(Vector *arg0, void *arg1) {
    arg0->x = (f32)((arg1->unkC + arg1->unk18) * 0.5f);
    arg0->y = (f32)((arg1->unk10 + arg1->unk1C) * 0.5f);
    arg0->z = (f32)((arg1->unk14 + arg1->unk20) * 0.5f);
    return 0.5f;
}
#else
