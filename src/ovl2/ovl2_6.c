        ...
        if (gCollisionState->numCells != 0) {
            ...
            for (i = 0; i < gCollisionState->numCells; i++) {
                ...
                if (temp_v1[3] != 0) {
                    ...
                    // phi_f22_3 = phi_f22;
                    if (temp_f20 < phi_f22) {
                        currentNormal = &gCollisionState->unk30->header.Triangle_Normals[temp_v1[0]];
                        temp_a2 = temp_s7;
                        ...
                        temp_s2 = func_80102570_ovl2(currentNormal, &sp88, temp_a2,
                                                     gCollisionState->unk3C, sp78);
                        phi_f22_3 = phi_f22;
                        if (sp78) {
                            if (gCollisionState->unk40(sp78, currentNormal, &gCollisionState->deltaPos,
                                ...
                                if (temp_s2 != 0) {
                                    sp88++;
                                    func_80102570_ovl2(currentNormal, &sp88, temp_s7,
                                                       gCollisionState->unk3C, sp78);
                                    phi_f22_3 = phi_f22;
                                    if (sp78 != NULL) {
                                        phi_f22_3 = phi_f22;
                                        if (gCollisionState->unk40(sp78, currentNormal,
            ...
            if (phi_f22_2 != *arg0) {
                if (arg2) {
                    struct Normal *x =
                        &gCollisionState->unk30->header.Triangle_Normals[normalCells[sp94 * 2]];
                ...
                *arg0 = phi_f22_2;
                if (arg1) {
                    arg1->x = ((gCollisionState->deltaPos.x * phi_f22_2) + gCollisionState->currPos.x);
                    arg1->y = ((gCollisionState->deltaPos.y * phi_f22_2) + gCollisionState->currPos.y);
                    arg1->z = ((gCollisionState->deltaPos.z * phi_f22_2) + gCollisionState->currPos.z);
                }
                return 1;
            }
        }
...
extern u32 func_80101920(Vector *a0, struct Normal *a1, Vector *a2, struct Normal *a3);
