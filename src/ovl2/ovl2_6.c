...
#ifdef MIPS_TO_C
// generated by mips_to_c commit 09d006c9da5d6bbcd31ac6ca5c9165c1a8533a83
void func_80101E14_ovl2(struct CollisionTriangle *arg0, Vector *arg1, struct Normal *a2, u32 arg3) {
    Vector sp18;

    sp18.x = -arg1->x;
    sp18.y = -arg1->y;
    sp18.z = -arg1->z;
    func_80101920(arg0, &sp18, a2, arg3);
}
#else
...
u8 func_801024E8_ovl2(Vector *arg0, s32 arg1) {
    if (gCollisionState->someNormal == 0) {
        return 1;
    }
...
block_28:
        if (!(phi_f14 < phi_f12)) {
            phi_s2_3 = &gCollisionState->unk30->header.Triangle_Cells[*arg1];
            phi_s4_3 = *arg1 * 2;
            phi_s7_3 = *arg1;
loop_57:
            temp_t5 = *phi_s2_3;
...
block_70:
            ...
            if (gCollisionState->unk30->using32BitVertices != 0) {
                temp_a0 = gCollisionState->unk30->header.Vertices[gCollisionState->unk30->header.Triangles[temp_v0].vertex[0]*6];
                temp_a1 = gCollisionState->unk30->header.Vertices[gCollisionState->unk30->header.Triangles[temp_v0].vertex[1]*6];
                temp_a2 = gCollisionState->unk30->header.Vertices[gCollisionState->unk30->header.Triangles[temp_v0].vertex[2]*6];
                phi_f20_2 = ((temp_a1[0] - temp_a0[0]) * (currPos->y - temp_a0[1])) - ((currPos->x - temp_a0[0]) * (temp_a1[1] - temp_a0[1]));
                phi_f22_2 = ((temp_a2[0] - temp_a1[0]) * (currPos->y - temp_a1[1])) - ((currPos->x - temp_a1[0]) * (temp_a2[1] - temp_a1[1]));
                phi_f8_2 = (temp_a0[0] - temp_a2[0]) * (currPos->y - temp_a2[1]);
                phi_f10_2 = (currPos->x - temp_a2[0]) * (temp_a0[1] - temp_a2[1]);
            } else {
                ...
                phi_f20_2 = ((temp_a3[0] - temp_a2_2[0]) * (currPos->y - temp_a2_2[1])) - ((currPos->x - temp_a2_2[0]) * (temp_a3[1] - temp_a2_2[1]));
                phi_f22_2 = ((temp_t0[0] - temp_a3[0]) * (currPos->y - temp_a3[1])) - ((currPos->x - temp_a3[0]) * (temp_t0[1] - temp_a3[1]));
                phi_f8_2 = (temp_a2_2[0] - temp_t0[0]) * (currPos->y - temp_t0[1]);
                phi_f10_2 = (currPos->x - temp_t0[0]) * (temp_a2_2[1] - temp_t0[1]);
            }
            temp_f28 = phi_f8_2 - phi_f10_2;
            if ((!(phi_f20_2 <= 0.5f) || !(phi_f22_2 <= 0.5f)) || !(temp_f28 <= 0.5f)) {
                if (((-0.5f <= phi_f20_2) && (-0.5f <= phi_f22_2)) && (-0.5f <= temp_f28)) {
            ...
            if ((*(gCollisionState->unk30->header.Triangle_Cells + phi_s4_3) & 0x8000) == 0) {
                *arg1 = phi_s7_3;
                return 1;
            }
            return 0;
        }
        phi_s2_2 = &gCollisionState->unk30->header.Triangle_Cells[*arg1];
        phi_s4_2 = *arg1 * 2;
        phi_s7_2 = *arg1;
loop_30:
        temp_t5_2 = *phi_s2_2;
        temp_v0_2 = temp_t5_2 & 0x7FFF;
        if (gCollisionState->unk30->header.Triangles[temp_v0_2].vertex[0] == arg3) {
block_53:
        ...
        if (gCollisionState->unk30->using32BitVertices == 0) {
            temp_a2_3 = gCollisionState->unk30->header.Vertices + (gCollisionState->unk30->header.Triangles[temp_v0_2].vertex[0] * 6);
            temp_a3_2 = gCollisionState->unk30->header.Vertices + (gCollisionState->unk30->header.Triangles[temp_v0_2].vertex[1] * 6);
            temp_t0_2 = gCollisionState->unk30->header.Vertices + (gCollisionState->unk30->header.Triangles[temp_v0_2].vertex[2] * 6);
            temp_f20 = ((temp_a3_2[0] - temp_a2_3[0]) * (currPos->z - temp_a2_3[2])) - ((currPos->x - temp_a2_3[0]) * (temp_a3_2[2] - temp_a2_3[2]));
            temp_f22 = ((temp_t0_2[0] - temp_a3_2[0]) * (currPos->z - temp_a3_2[2])) - ((currPos->x - temp_a3_2[0]) * (temp_t0_2[2] - temp_a3_2[2]));
            if ((temp_f20 <= 0.5f) && (temp_f22 <= 0.5f)) {
                if ((((temp_a2_3[0] - temp_t0_2[0]) * (currPos->z - temp_t0_2[2])) - ((currPos->x - temp_t0_2[0]) * (temp_a2_3[2] - temp_t0_2[2]))) <= 0.5f) {
                    arg4->vertex[0] = (u16 *) &gCollisionState->unk30->header.Triangles[temp_v0_2];
                    if ((*(gCollisionState->unk30->header.Triangle_Cells + phi_s4_2) & 0x8000) == 0) {
                        *arg1 = phi_s7_2;
                        return 1;
                    }
                    return 0;
                ...
                if (((-0.5f <= temp_f20) && (-0.5f <= temp_f22)) && (-0.5f <= (((temp_a2_3[0] - temp_t0_2[0]) * (currPos->z - temp_t0_2[2])) - ((currPos->x - temp_t0_2[0]) * (temp_a2_3[2] - temp_t0_2[2]))))) {
                    arg4->vertex[0] = (u16 *) &gCollisionState->unk30->header.Triangles[temp_v0_2];
                    if ((*(gCollisionState->unk30->header.Triangle_Cells + phi_s4_2) & 0x8000) == 0) {
                        *arg1 = phi_s7_2;
                        return 1;
        ...
        temp_a0_2 = gCollisionState->unk30->header.Vertices + (gCollisionState->unk30->header.Triangles[temp_v0_2].vertex[0] * 0xC);
        temp_a1_2 = gCollisionState->unk30->header.Vertices + (gCollisionState->unk30->header.Triangles[temp_v0_2].vertex[1] * 0xC);
        temp_a2_4 = gCollisionState->unk30->header.Vertices + (gCollisionState->unk30->header.Triangles[temp_v0_2].vertex[2] * 0xC);
        temp_f20_2 = ((temp_a1_2[0] - temp_a0_2[0]) * (currPos->z - temp_a0_2[2])) - ((currPos->x - temp_a0_2[0]) * (temp_a1_2[2] - temp_a0_2[2]));
        temp_f22_2 = ((temp_a2_4[0] - temp_a1_2[0]) * (currPos->z - temp_a1_2[2])) - ((currPos->x - temp_a1_2[0]) * (temp_a2_4[2] - temp_a1_2[2]));
        temp_f28_2 = ((temp_a0_2[0] - temp_a2_4[0]) * (currPos->z - temp_a2_4[2])) - ((currPos->x - temp_a2_4[0]) * (temp_a0_2[2] - temp_a2_4[2]));
        if ((!(temp_f20_2 <= 0.5f) || !(temp_f22_2 <= 0.5f)) || !(temp_f28_2 <= 0.5f)) {
            if (((-0.5f <= temp_f20_2) && (-0.5f <= temp_f22_2)) && (-0.5f <= temp_f28_2)) {
...
loop_12:
    temp_t5_3 = *phi_s2;
    temp_v0_3 = temp_t5_3 & 0x7FFF;
    sp64 = &gCollisionState->unk30->header.Triangles[temp_v0_3];
    if (gCollisionState->unk30->header.Triangles[temp_v0_3].vertex[0] == arg3) {
block_25:
    ...
    if (gCollisionState->unk30->using32BitVertices != 0) {
        temp_a0_3 = gCollisionState->unk30->header.Vertices + (gCollisionState->unk30->header.Triangles[temp_v0_3].vertex[0] * 0xC);
        temp_a1_3 = gCollisionState->unk30->header.Vertices + (gCollisionState->unk30->header.Triangles[temp_v0_3].vertex[1] * 0xC);
        temp_a2_5 = gCollisionState->unk30->header.Vertices + (gCollisionState->unk30->header.Triangles[temp_v0_3].vertex[2] * 0xC);
        phi_f20 = ((temp_a1_3[1] - temp_a0_3[1]) * (currPos->z - temp_a0_3[2])) - ((currPos->y - temp_a0_3[1]) * (temp_a1_3[2] - temp_a0_3[2]));
        phi_f22 = ((temp_a2_5[1] - temp_a1_3[1]) * (currPos->z - temp_a1_3[2])) - ((currPos->y - temp_a1_3[1]) * (temp_a2_5[2] - temp_a1_3[2]));
        phi_f8 = (temp_a0_3[1] - temp_a2_5[1]) * (currPos->z - temp_a2_5[2]);
        phi_f10 = (currPos->y - temp_a2_5[1]) * (temp_a0_3[2] - temp_a2_5[2]);
    } else {
        temp_a2_6 = gCollisionState->unk30->header.Vertices + (gCollisionState->unk30->header.Triangles[temp_v0_3].vertex[0] * 6);
        temp_a3_3 = gCollisionState->unk30->header.Vertices + (gCollisionState->unk30->header.Triangles[temp_v0_3].vertex[1] * 6);
        temp_t0_3 = gCollisionState->unk30->header.Vertices + (gCollisionState->unk30->header.Triangles[temp_v0_3].vertex[2] * 6);
        phi_f20 = ((temp_a3_3[1] - temp_a2_6[1]) * (currPos->z - temp_a2_6[2])) - ((currPos->y - temp_a2_6[1]) * (temp_a3_3[2] - temp_a2_6[2]));
        phi_f22 = ((temp_t0_3[1] - temp_a3_3[1]) * (currPos->z - temp_a3_3[2])) - ((currPos->y - temp_a3_3[1]) * (temp_t0_3[2] - temp_a3_3[2]));
        phi_f8 = (temp_a2_6[1] - temp_t0_3[1]) * (currPos->z - temp_t0_3[2]);
        phi_f10 = (currPos->y - temp_t0_3[1]) * (temp_a2_6[2] - temp_t0_3[2]);
    }
    temp_f28_3 = phi_f8 - phi_f10;
    if ((!(phi_f20 <= 0.5f) || !(phi_f22 <= 0.5f)) || !(temp_f28_3 <= 0.5f)) {
        if (((-0.5f <= phi_f20) && (-0.5f <= phi_f22)) && (-0.5f <= temp_f28_3)) {
    ...
    if (IS_ZERO_VECTOR(gCollisionState->deltaPos)) {
        ...
        if (gCollisionState->numCells != 0) {
            ...
            for(phi_s4 = 0; phi_s4 < gCollisionState->numCells; phi_s4++) {
                ...
                gCollisionState->numCells = sp8C[temp_s1 * 2];
                sp88 = temp_v1_2[3];
                if (sp88 != 0) {
