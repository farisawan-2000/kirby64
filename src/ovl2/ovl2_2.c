...
void func_800F716C(void *arg0) {
    ...
    if (D_800BE500 == 1 && D_800BE504 == 2) {
        gMoveWd(gDisplayListHeads++, G_MW_FOG, 0, 0x008E0071);
        temp_a1 = gDisplayListHeads.unk4;
        gDisplayListHeads.unk4 = (void *) (temp_a1 + 8);
        temp_a1->unk4 = 0x8E0071;
        phi_a1 = temp_a1;
    } else {
        gMoveWd(gDisplayListHeads++, G_MW_FOG, 0, 0x0640FAC0);
        temp_a1_2 = gDisplayListHeads.unk4;
        gDisplayListHeads.unk4 = (void *) (temp_a1_2 + 8);
