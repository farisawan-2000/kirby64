...
void func_800F716C(void *arg0) {
    ...
    if (D_800BE500 == 1) {
        if (D_800BE504 == 2) {
            ...
            temp_v1->unk0 = 0xDB080000;
            temp_v1->unk4 = 0x8E0071;
...
block_3:
            temp_v1_2 = gDisplayListHead.unk0;
            gDisplayListHead.unk0 = (void *) (temp_v1_2 + 8);
            temp_v1_2->unk0 = 0xDB080000;
            temp_v1_2->unk4 = 0x640FAC0;
