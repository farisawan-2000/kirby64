...
void func_802271A8_ovl18(void) {
    ...
    func_80007C00_ovl18(func_8000BDF0_ovl18(0x19, 0x80000000, 0x63, 3, 0xFF)->unk3C + 8, 0x41200000, 0x41200000, 0x439B0000, 230.0f);
