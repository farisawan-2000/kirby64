...
Gfx *func_8021DF20_ovl18(void *arg0) {
    u32 sp1C;
    Gfx *temp_v0_2;
    Gfx *temp_v0_3;
    Gfx *temp_v0_4;
    ...
    if ((D_800DD8D0[temp_v0] & 0x40) == 0) {
        if ((D_800E7880[temp_v0] == 0) || (phi_return = temp_v0, ((D_800BE4EC & 1) == 0))) {
            temp_v0_2 = gDisplayListHeads[2];
            gDisplayListHeads[2] = temp_v0_2 + 8;
            temp_v0_2->words.w1 = 0;
            temp_v0_2->words.w0 = 0xE7000000;
            temp_a0 = D_8004A3F8.unkC;
            D_8004A3F8.unkC = temp_a0 + 0x40;
            temp_v1 = *arg0;
            sp1C = temp_a0;
            func_8001B784_ovl18(temp_a0, (bitwise s32) D_800E25D0[temp_v1], (bitwise s32) D_800E2790[temp_v1], (bitwise s32) D_800E2950[temp_v1]);
            temp_v0_3 = gDisplayListHeads[2];
            gDisplayListHeads[2] = temp_v0_3 + 8;
            temp_v0_3->words.w0 = 0xDA380000;
            temp_v0_3->words.w1 = sp1C;
            temp_v0_4 = gDisplayListHeads[2];
            gDisplayListHeads[2] = temp_v0_4 + 8;
            temp_v0_4->words.w1 = &D_80227440;
            temp_v0_4->words.w0 = 0xDE000000;
            temp_v0_5 = gDisplayListHeads[2];
            gDisplayListHeads[2] = temp_v0_5 + 8;
            temp_v0_5->words.w1 = 0x40;
            temp_v0_5->words.w0 = 0xD8380002;
        ...
        if (temp_v0 != 0x10) {
            if (temp_v0 != 0x20) {
                if (temp_v0 != 0x30) {
                    ...
                    sp6C = random_soft_s32_range(temp_s0->unkC) + D_800E25D0[D_8004A7C4->unk0];
                    phi_f8 = random_soft_s32_range(temp_s0->unk10) + D_800E2790[D_8004A7C4->unk0];
block_13:
                    sp70 = phi_f8;
                }
            } else {
                temp_v0_2 = D_8004A7C4;
                sp6C = D_800E25D0[temp_v0_2->unk0] + temp_s0->unkC;
                phi_f8 = D_800E2790[temp_v0_2->unk0] + temp_s0->unk10;
                goto block_13;
            }
        } else {
            ...
            func_800F9974_ovl18(&sp80, &sp50, (random_soft_s32_range(temp_s0->unkC) / 5) * 5);
            func_800F9020_ovl18(&sp6C, sp80, (bitwise s32) sp50);
            sp70 = D_800E2790[D_8004A7C4->unk0] + ((random_soft_s32_range(temp_s0->unk10) / 5) * 5);
            if ((temp_s0->unk0 & 0xF) != 7) {
                func_800A7678(0x112);
                func_800A7F74_ovl18(3, 0, 0xCE, (bitwise s32) sp6C, sp70, sp74);
                func_8000B6BC(0x12);
            }
            sp7C = func_800FCD14_ovl18(0xFF, sp83, (bitwise s32) sp50, temp_s0->unk1, temp_s0->unk2, temp_s0->unk3, temp_s0->unk4, 0, temp_s0->unk6, &sp6C, &sp60, &sp54);
        }
    } else {
        ...
        func_800F9974_ovl18(temp_a0, temp_a1, (bitwise s32) temp_s0->unkC);
        func_800F9020_ovl18(&sp6C, sp80, (bitwise s32) sp50);
        sp70 = D_800E2790[D_8004A7C4->unk0] + temp_s0->unk10;
        if ((temp_s0->unk0 & 0xF) != 7) {
            func_800A7678(0x112);
            func_800A7F74_ovl18(3, 0, 0xCE, (bitwise s32) sp6C, sp70, sp74);
            func_8000B6BC(0x12);
...
u8 func_8021E858_ovl18(s32 arg0) {
    ...
    temp_s3 = D_800E98E0[D_8004A7C4->unk0];
    ...
    if (temp_v0 != 0) {
        ...
        if (*(&D_800E7650 + temp_v0) != *(&D_8022BCF8 + (temp_s3 * 4) + phi_s0)) {
            ...
            if ((*(&D_8022BD18 + (temp_s3 * 4) + phi_s0) & 0x80) != 0) {
                ...
                phi_return = func_800BC11C_ovl18(D_800D6E58);
            }
            *phi_s1 = 0;
        }
    }
...
void func_8021ED10_ovl18(s32 arg0) {
    func_800B1900_ovl18(D_8004A7C4->unk2);
}
#else
...
loop_1:
    ...
    D_800DEF90[D_8004A7C4->unk0] = &D_800B491C;
    func_800AF9B8_ovl18(0x24, 0x10);
    temp_a1 = &D_800DD8D0[D_8004A7C4->unk0];
...
loop_8:
        temp_v0_4 = func_800AEA64_ovl18(0x21, 0x3C, 0x49);
        ...
        *temp_a1_2 = D_800E6BD0[temp_s1_2->unk0];
        func_800F9974_ovl18(temp_a0_2, temp_a1_2, phi_s2->unk8);
        temp_s1_3 = D_8004A7C4;
        temp_s0 = phi_s0 + 1;
        temp_s2 = phi_s2 + 0x18;
        D_800E25D0[temp_v0_4] = D_800E25D0[temp_s1_3->unk0] + phi_s2->unkC;
        D_800E2790[temp_v0_4] = D_800E2790[temp_s1_3->unk0] + temp_s2->unk-8;
        D_800E2950[temp_v0_4] = D_800E2950[temp_s1_3->unk0] + temp_s2->unk-4;
        phi_s0 = temp_s0;
        phi_s2 = temp_s2;
    ...
    func_800BC1FC_ovl18(phi_v0_2->unk1);
loop_11:
...
loop_12:
    ...
    if ((temp_s0_3->unkC != 0) && (func_8021F304_ovl18(1) != 0) && (func_8021F35C_ovl18() != 0)) {
        ...
        func_800F9974_ovl18(temp_a0_3, temp_a1_3, temp_s0_3->unk10);
        func_800F9020_ovl18(&sp8C, spA8, (bitwise s32) spA0);
        temp_f6 = D_800E2790[D_8004A7C4->unk0] + temp_s0_3->unk14;
        sp90 = temp_f6;
        func_800FD754_ovl18(0, sp8C, temp_f6, sp94);
        func_8000B6BC(0xA);
        sp7C = 1.0f;
        sp78 = 1.0f;
        sp74 = 1.0f;
        ...
        sp84 = 0.0f;
        sp80 = 0.0f;
        func_800FCD14_ovl18(0xFF, spAB, (bitwise s32) spA0, 3, 7, 2, 0, 0, temp_s0_3->unkC, &sp8C, &sp80, &sp74);
        func_800A7678(0x226);
    }
    D_800D6E98 = 0;
    func_800AFA14_ovl18();
...
void func_8021F400_ovl18(void) {
    ...
    func_800B1900_ovl18(phi_v1 & 0xFFFF);
}
#else
GLOBAL_ASM("asm/non_matchings/ovl18/ovl18/func_8021F400_ovl18.s")
#endif

#ifdef MIPS_TO_C
//generated by mips_to_c commit 3ec45aadfc2cb619035fb802d88c52eacfab0326
struct UnkStruct8004A7C4 *func_8021F4A0_ovl18(void) {
    struct UnkStruct8004A7C4 *temp_v0;

    temp_v0 = D_8004A7C4;
    *(&D_800E7B20 + (temp_v0->unk0 * 4)) = D_800D6E58;
    *(&D_800E7CE0 + (temp_v0->unk0 * 4)) = 0x1E;
    D_800D7098 = 0;
    return temp_v0;
}
#else
GLOBAL_ASM("asm/non_matchings/ovl18/ovl18/func_8021F4A0_ovl18.s")
#endif
...
void func_8021F4E8_ovl18(void) {
    ...
    if ((2 == temp_v1) || (temp_v1 == 1)) {
        ...
        if (func_800BC11C_ovl18(D_800D6E58) == 0) {
            func_800BB468_ovl18(2, 0);
            func_800B1EC8(D_800DE510[D_8004A7C4->unk0], &D_801A3E80);
        }
    }
}
#else
...
? func_8021F5CC_ovl18(void) {
    ...
    func_80111ECC_ovl18(func_80111C88_ovl18(temp_v0->unk8C, D_8004A7C4->unk0));
...
? func_8021F70C_ovl18(void) {
    ...
    if (func_80110B00_ovl18(&sp2C) != 0) {
        *(&D_800E83E0 + (D_8004A7C4->unk0 * 4)) = sp2E;
...
block_7:
    ...
    if (temp_a0 == 1) {
        ...
        *(&D_800E83E0 + (D_8004A7C4->unk0 * 4)) = 0x12;
        sp48 = temp_v1_3;
        func_800A7678(0xF4);
        temp_v1_3->unk94 = 0;
        temp_v1_3->unk40 = 1;
...
void func_8021F970_ovl18(void) {
    ...
    sp18 = *(&D_800E77A0 + (temp_v0 * 2)) - 0x4E;
    sp1C = temp_a3;
    func_800A7678(0x28);
    temp_t3 = *(&D_802297E4 + (sp18 * 8));
    temp_a3->unk3D = temp_t3;
    temp_v0_2 = D_8004A7C4;
    D_800E7CE0[temp_v0_2->unk0] = temp_t3 & 0xFF;
    D_800D70D8.unk0 = D_800E25D0[temp_v0_2->unk0];
    D_800D70D8.unk4 = D_800E2790[temp_v0_2->unk0];
    D_800D70D8.unk8 = D_800E2950[temp_v0_2->unk0];
    D_800D70D8.unkC = D_800E4010[temp_v0_2->unk0];
    D_800D70D8.unk10 = D_800E41D0[temp_v0_2->unk0];
    D_800D70D8.unk14 = D_800E4390[temp_v0_2->unk0];
    D_800D70D8.unk18 = D_800E4550[temp_v0_2->unk0];
    D_800D70D8.unk1C = D_800E4710[temp_v0_2->unk0];
    D_800D7098.unk0 = 1;
    D_800D7098.unk4 = 0;
    D_800D7098.unk8 = 0;
    D_800D7098.unkC = 0;
    ...
    D_800D7098.unk14 = 0;
    D_800D7098.unk18 = 0;
    D_800D70D8.unk20 = D_800E48D0[temp_v0_2->unk0];
    func_800B19F4_ovl18(6, temp_v0_2->unk0, &D_800D70D8, temp_a3);
}
#else
...
void func_8021FB18_ovl18(void) {
    ...
    temp_v0 = D_8004A7C4;
    *(&D_800E7CE0 + (temp_v0->unk0 * 4)) = 0;
    D_800E25D0[temp_v0->unk0] = D_800D70D8.unk0;
    D_800E2790[temp_v0->unk0] = D_800D70D8.unk4;
    D_800E2950[temp_v0->unk0] = D_800D70D8.unk8;
    *(&D_800E4010 + (temp_v0->unk0 * 4)) = D_800D70D8.unkC;
    D_800E41D0[temp_v0->unk0] = D_800D70D8.unk10;
    *(&D_800E4390 + (temp_v0->unk0 * 4)) = D_800D70D8.unk14;
    D_800E4550[temp_v0->unk0] = D_800D70D8.unk18;
    D_800E4710[temp_v0->unk0] = D_800D70D8.unk1C;
    D_800E48D0[temp_v0->unk0] = D_800D70D8.unk20;
    D_800D7098 = 0;
    func_800B1BF0_ovl18(0, temp_v0->unk0);
}
#else
GLOBAL_ASM("asm/non_matchings/ovl18/ovl18/func_8021FB18_ovl18.s")
#endif
...
s32 func_8021FD48_ovl18(void) {
    ...
    if (*(&D_800E77A0 + (temp_v0 * 2)) == 0x56) {
        *(&D_800E4010 + (temp_v0 * 4)) = D_800D70E4 - (temp_t7 * D_8022BB84);
        return temp_v0;
    }
    D_800E41D0[temp_v0] = (D_800D7098.unk4 * D_8022BB88) + D_800D70E8;
    return temp_v0;
}
#else
...
block_7:
    ...
    *(&D_800E4010 + (temp_v1->unk0 * 4)) = D_800D70E4 + (D_8022BB8C * temp_a1);
...
s32 func_8021FEBC_ovl18(void) {
    ...
    temp_a0 = D_800D7098.unk8 + D_800D7098.unk4;
    D_800E2790[temp_v1->unk0] = (D_800D70D8.unk1C * 3.0f * temp_a0) + D_800D70D8.unk4;
    D_800D7098.unk4 = temp_a0;
    return D_800D7098.unk4;
}
#else
...
s32 func_8021FF80_ovl18(void) {
    ...
    temp_a0 = D_800D7098.unk8 + D_800D7098.unk4;
    *(&D_800E4010 + (temp_v1->unk0 * 4)) = D_800D70E4 + (D_8022BB90 * temp_a0);
    D_800D7098.unk4 = temp_a0;
    return D_800D7098.unk4;
}
#else
...
block_7:
    ...
    D_800E2790[temp_v1->unk0] = (D_800D70D8.unk1C * 1.25f * temp_a1) + D_800D70D8.unk4;
    ...
    D_800E2950[temp_v1->unk0] = (D_800D70D8.unk20 * D_8022BB94 * temp_a1_2) + D_800D70D8.unk8;
