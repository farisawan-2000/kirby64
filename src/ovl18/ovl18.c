...
loop_1:
    ...
    func_800B1F68(gEntityGObjProcessArray5[temp_s1->unk0], &func_800B1434);
...
loop_12:
    ...
    if ((temp_s0_3->unkC != 0) && (ovl18_TamperCheck(1) != 0) && (func_8021F35C_ovl18() != 0)) {
...
? func_8021F35C_ovl18(void) {
    ...
    temp_v0 = ovl18_TamperCheck.unk0;
    temp_t7 = ovl18_TamperCheck.unk4;
    temp_v1 = ovl1_TamperCheck.unk0;
    temp_t6 = ovl1_TamperCheck.unk4;
    phi_t0 = 2;
    phi_v1 = temp_v1 + temp_t6;
    phi_a0 = &ovl1_TamperCheck + 8;
    phi_v0 = temp_v0 + temp_t7;
    phi_a2 = &ovl18_TamperCheck + 8;
loop_1:
    temp_t0 = phi_t0 + 4;
...
f32 func_8021FC40_ovl18(void) {
    ...
    temp_f2 = temp_a0;
    gEntitiesScaleXArray[D_8004A7C4->objID] = (temp_f0 * temp_f16 * temp_f2) + temp_f0;
    temp_f12 = D_800D70D8.unk1C;
    gEntitiesScaleYArray[D_8004A7C4->objID] = temp_f12 - (temp_f12 * temp_f16 * temp_f2);
    temp_f14 = D_800D70D8.unk20;
    gEntitiesScaleZArray[D_8004A7C4->objID] = (temp_f14 * temp_f16 * temp_f2) + temp_f14;
