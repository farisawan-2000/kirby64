...
void *func_8000783C(struct DynamicBuffer *arg0, u32 size, u32 flag) {
    void *ret;
    u32 temp_v0;

    if (flag != 0) {
        temp_v0 = flag - 1;
        ret = ((u32)arg0->top + temp_v0) & ~temp_v0;
    } else {
        ret = arg0->top;
    }
    temp_v0 = (u32) ret + size;
    arg0->top = temp_v0;
...
void func_800078A4(struct DynamicBuffer *tracker, u32 id, void *start, u32 size) {
    tracker->id = id;
    tracker->top = start;
