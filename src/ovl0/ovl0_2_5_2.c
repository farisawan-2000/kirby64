...
void func_80007FB8(u32 **arg0) {
    *arg0 = gObjectThreadMaybe;
    gObjectThreadMaybe = arg0;
    D_8004A544--;
}

// TODO: Determine types
extern void** gObjectThreadStackMaybe;
...
void *func_80007FE4(void) {
    ...
    gObjectThreadStackMaybe = *gObjectThreadStackMaybe;
    D_8004A548++;
    return temp_v0;
}

void func_8000803C(void **arg0) {
    *arg0 = gObjectThreadStackMaybe;
    gObjectThreadStackMaybe = arg0;
    D_8004A548--;
}

// TODO: Determine types
extern void** gObjectProcessMaybe;
...
struct unk8000835C {
    u8 filler[4];
    struct unk8000835C* unk4;
};

// TODO: Determine types
extern struct unk8000835C* D_8004A678;
...
void func_800083A0(struct unk8000835C *arg0) {
...
// Following code paths shows that this struct is likely the same one as unk801DB1E0Func
...
void* func_8000888C(void) {
    ...
    temp_v0 = D_8004A7A4;
    D_8004A7A4 = *D_8004A7A4; // TODO: This is probably the first member of a struct
    D_8004A7A8++;
    return temp_v0;
}
...
void *func_80008910(void) {
    ...
    temp_v0 = D_8004A7AC;
    D_8004A7AC = *D_8004A7AC; // TODO: This is probably the first member of a struct
    D_8004A7B0++;
    return temp_v0;
}
...
void *func_80008994(void) {
    ...
    temp_v0 = D_8004A7BC;
    D_8004A7BC = *D_8004A7BC; // TODO: This is probably the first member of a struct
    D_8004A7C0++;
    return temp_v0;
}
