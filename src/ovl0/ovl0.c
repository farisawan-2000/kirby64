...
#else
GLOBAL_ASM("asm/non_matchings/ovl0/ovl0/func_80000900.s")
#endif
...
#else
GLOBAL_ASM("asm/non_matchings/ovl0/ovl0/func_80000908.s")
#endif
...
#ifdef MIPS_TO_C
//generated by mips_to_c commit 3ec45aadfc2cb619035fb802d88c52eacfab0326
void func_800009E8(void *arg0, OSMesgQueue *mq, OSMesg *msg, s32 count) {
    void *sp3C;
    s32 sp1C;
    s32 sp18;
...
? func_80000A44(void *arg0) {
    ...
    if (D_80048C60 != 0) {
        ...
        sp1C = osViGetCurrentFramebuffer_0(&D_80048C5C);
        ...
        if (temp_v1 != -1) {
            ...
            if ((temp_a0 != 0) && (temp_v0 != temp_a0) && (sp1C != temp_a0)) {
                ...
                D_80048C60 = temp_a0;
                D_80048C88 = 0;
                D_80048C6C = osGetCount(temp_a0, sp1C, &D_80048C5C);
                return 1;
            }
        }
        phi_v1 = &D_80048C50;
loop_10:
        ...
        if ((temp_a0_2 != 0) && (temp_v0 != temp_a0_2) && (sp1C != temp_a0_2)) {
            ...
            D_80048C88 = 0;
            D_80048C6C = osGetCount(temp_a0_2, &D_80048C5C, sp1C, &D_80048C5C);
            return 1;
        }
        phi_v1 = temp_v1_2;
...
void func_80001774(s32 arg0) {
    ...
    if (D_80048CD0 != 0) {
        arg0 = arg0;
        osSendMesg(D_80048CD4, 1, 0, arg0);
        if (arg0 == -1) {
...
block_12:
        ...
        osViSwapBuffer(D_80048C5C, 1, arg0);
        temp_v0 = D_80048C5C;
...
void *func_8000206C(? arg1, ? arg2) {
    ...
    if (temp_v0_2 != 0) {
        ...
        phi_return = temp_v0_2;
        if (temp_v0_2->unk8 == 4) {
            if (osSpTaskYielded(temp_v0_2 + 0x28, phi_a1, phi_a2) == 1) {
                D_80048B8C->unk8 = 5;
                func_80000D34(D_80048B8C);
                D_80048B8C = 0;
            } else {
    ...
    if (temp_a3 != 0) {
        ...
        if (temp_a3->unk18 == 2) {
            if (temp_a3->unk0 == 1) {
                ...
                phi_a3_2 = phi_a3;
                if (temp_a0_6 != 0) {
                    osSendMesg(temp_a0_6, phi_a3->unk1C, 0, phi_a3);
                    phi_a3_2 = D_80048B94;
                }
...
loop_21:
                ...
                temp_t8_2->unk0 = temp_t6_2->unk0;
                temp_t8_2->unk4 = temp_t6_2->unk4;
                phi_t8_3 = &sp30;
                phi_t7 = &D_80048BF8;
loop_23:
...
loop_7:
            ...
            temp_t8_5->unk0 = temp_t5_2->unk0;
            temp_t8_5->unk4 = temp_t5_2->unk4;
            phi_t8_6 = &sp30;
            phi_t7_2 = &D_80048BF8;
loop_9:
...
loop_14:
        ...
        temp_t7_4->unk0 = temp_t9_2->unk0;
        temp_t7_4->unk4 = temp_t9_2->unk4;
        phi_t7_5 = &sp30;
        phi_t8_7 = &D_80048BF8;
loop_16:
    ...
    D_80048BA8.unk4 = 0x10016;
    D_80048BFC = 0x10016;
    osViSetMode(&D_80048BA8, &D_80048B90, &D_80048B8C, &D_80048B88);
    osViBlack(1);
    ...
    D_80048C7C.unk1 = D_80048C7C.unk1 | 0x80;
    osCreateMesgQueue(&D_80048CB8, &D_80048C98, 8);
    osViSetEvent(&D_80048CB8, 1, 1);
    osSetEventMesg(4, &D_80048CB8, 2);
    osSetEventMesg(9, &D_80048CB8, 3);
    osSetEventMesg(0xE, &D_80048CB8, 0x63);
    osSendMesg(&D_80048A08, 1, 0);
loop_26:
    osRecvMesg(&D_80048CB8, &sp84, 1);
    if (sp84 == 1) {
        func_80002014(sp84);
        goto loop_26;
    }
...
void func_80002AF8(void) {
    ...
    phi_s0 = 0;
loop_1:
    func_800047F0(phi_s0);
    func_800047D0(phi_s0);
    temp_s0 = phi_s0 + 1;
    phi_s0 = temp_s0;
    if (temp_s0 != 4) {
        goto loop_1;
...
#else
GLOBAL_ASM("asm/non_matchings/ovl0/ovl0/func_80002AF8.s")
#endif
...
#else
GLOBAL_ASM("asm/non_matchings/ovl0/ovl0/func_80002B70.s")
#endif
...
#else
GLOBAL_ASM("asm/non_matchings/ovl0/ovl0/func_80002B7C.s")
#endif
...
#else
GLOBAL_ASM("asm/non_matchings/ovl0/ovl0/func_80002B88.s")
#endif
