...
extern struct DynamicBuffer D_8004A408;

void func_800078A4(struct DynamicBuffer *arg0, s32 arg1, s32 arg2, s32 arg3);
u32 func_8000783C(struct DynamicBuffer *, u32, u32);
...
extern struct DynamicBuffer D_8004A3F8;
extern u32 D_8004A450;

void func_80005430(void) {
    D_8004A3F8.id        = D_8004A468[D_8004A450].id;
    D_8004A3F8.poolStart = D_8004A468[D_8004A450].poolStart;
    D_8004A3F8.poolEnd   = D_8004A468[D_8004A450].poolEnd;
    D_8004A3F8.top       = D_8004A468[D_8004A450].top;
...
void func_8000561C(void) {
    ...
    if ((u32) D_8004A3F8.poolEnd < (u32) D_8004A3F8.top) {
        fatal_printf("gtl : DynamicBuffer over flow !  %d byte\n", (u32) D_8004A3F8.top - (u32) D_8004A3F8.poolStart);
        while (TRUE);
    }
}
...
struct DObj *func_800057AC(void) {
    if (D_8004A368[D_8004A450] == 0) {
        fatal_printf(&D_80040040); // "gtl : not defined SCTaskGfx\n"
        while (1);
    }
    if (D_8004A370[D_8004A450] == D_8004A378[D_8004A450]) {
        fatal_printf(&D_80040060); // "gtl : couldn't get SCTaskGfx\n"
        while (1);
    }
    else return D_8004A370[D_8004A450]++;
}
#else
